...
var _typeStr : stdgo.Slice<stdgo.GoString> = (new stdgo.Slice<stdgo.GoString>(43, 43, ...[
...
("Empty" : stdgo.GoString),
("Alternate" : stdgo.GoString),
("Concatenate" : stdgo.GoString),
("Loop" : stdgo.GoString),
("Lazyloop" : stdgo.GoString),
("Capture" : stdgo.GoString),
("Group" : stdgo.GoString),
("Require" : stdgo.GoString),
("Prevent" : stdgo.GoString),
("Greedy" : stdgo.GoString),
("Testref" : stdgo.GoString),
("Testgroup" : stdgo.GoString),
("Unknown" : stdgo.GoString),
("Unknown" : stdgo.GoString),
("Unknown" : stdgo.GoString),
("Unknown" : stdgo.GoString),
("Unknown" : stdgo.GoString),
