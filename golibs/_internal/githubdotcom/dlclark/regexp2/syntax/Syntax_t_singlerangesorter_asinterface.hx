...
class T_singleRangeSorter_asInterface {
    @:keep
    ...
    var __self__ : _internal.githubdotcom.dlclark.regexp2.syntax.Syntax_t_singlerangesorterpointer.T_singleRangeSorterPointer;
