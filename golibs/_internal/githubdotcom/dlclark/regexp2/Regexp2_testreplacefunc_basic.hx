...
function testReplaceFunc_Basic(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var __tmp__ = _re.replaceFunc(("this is a test" : stdgo.GoString), function(_m:_internal.githubdotcom.dlclark.regexp2.Regexp2_match.Match):stdgo.GoString {
            //"file:///Users/o/go/pkg/mod/github.com/dlclark/regexp2@v1.11.5/replace_test.go#L109"
            return ("unit" : stdgo.GoString);
        }, (-1 : stdgo.GoInt), (-1 : stdgo.GoInt)), _str:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///Users/o/go/pkg/mod/github.com/dlclark/regexp2@v1.11.5/replace_test.go#L110"
        if (_err != null) {
            //"file:///Users/o/go/pkg/mod/github.com/dlclark/regexp2@v1.11.5/replace_test.go#L111"
        ...
        //"file:///Users/o/go/pkg/mod/github.com/dlclark/regexp2@v1.11.5/replace_test.go#L113"
        {
...
var _got = __1, _want = __0;
            if (_want != (_got)) {
                //"file:///Users/o/go/pkg/mod/github.com/dlclark/regexp2@v1.11.5/replace_test.go#L114"
