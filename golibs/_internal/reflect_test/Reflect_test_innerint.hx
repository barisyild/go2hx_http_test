...
@:structInit @:using(_internal.reflect_test.Reflect_test_innerint_static_extension.InnerInt_static_extension) @:using(_internal.reflect_test.Reflect_test_innerint_static_extension.InnerInt_static_extension) class InnerInt {
