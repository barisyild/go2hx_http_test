...
@:structInit @:using(_internal.reflect_test.Reflect_test_t_testmakefuncinvalidreturnassignments___localname___t_59310_static_extension.T_testMakeFuncInvalidReturnAssignments___localname___T_59310_static_extension) @:using(_internal.reflect_test.Reflect_test_t_testmakefuncinvalidreturnassignments___localname___t_59310_static_extension.T_testMakeFuncInvalidReturnAssignments___localname___T_59310_static_extension) class T_testMakeFuncInvalidReturnAssignments___localname___T_59310 {
    ...
    public function __copy__() {
        return new T_testMakeFuncInvalidReturnAssignments___localname___T_59310(_a, _b, _c);
    }
}
