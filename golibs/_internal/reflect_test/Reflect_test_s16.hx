...
@:structInit @:using(_internal.reflect_test.Reflect_test_s16_static_extension.S16_static_extension) @:using(_internal.reflect_test.Reflect_test_s16_static_extension.S16_static_extension) class S16 {
    @:embedded
