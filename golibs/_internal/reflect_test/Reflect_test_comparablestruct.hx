...
@:structInit @:using(_internal.reflect_test.Reflect_test_comparablestruct_static_extension.ComparableStruct_static_extension) @:using(_internal.reflect_test.Reflect_test_comparablestruct_static_extension.ComparableStruct_static_extension) class ComparableStruct {
