...
@:structInit @:using(_internal.reflect_test.Reflect_test_point_static_extension.Point_static_extension) @:using(_internal.reflect_test.Reflect_test_point_static_extension.Point_static_extension) class Point {
