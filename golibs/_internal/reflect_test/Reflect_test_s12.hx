...
@:structInit @:using(_internal.reflect_test.Reflect_test_s12_static_extension.S12_static_extension) @:using(_internal.reflect_test.Reflect_test_s12_static_extension.S12_static_extension) class S12 {
    @:embedded
