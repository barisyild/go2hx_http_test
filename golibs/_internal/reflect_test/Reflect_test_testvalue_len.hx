...
function testValue_Len(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7939"
        if (_v.len() != ((_a.length))) {
            //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7940"
            _t.errorf(("Len = %d want %d" : stdgo.GoString), new stdgo.AnyInterface(_v.len(), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(int_kind))), new stdgo.AnyInterface((_a.length), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(int_kind))));
        };
        ...
        //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7945"
        if (_v.len() != ((_a.length))) {
            //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7946"
            _t.errorf(("Len = %d want %d" : stdgo.GoString), new stdgo.AnyInterface(_v.len(), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(int_kind))), new stdgo.AnyInterface((_a.length), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(int_kind))));
        };
            ...
            try {
                {
                    __deferstack__.unshift({ ran : false, f : () -> ({
                        var a = function():Void {
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7952"
                            {
                ...
                //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7956"
                _f();
                //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7957"
                {
        ...
        var _e = @:assignType (_getError(function():Void {
            ...
            //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7961"
            stdgo._internal.reflect.Reflect_valueof.valueOf(new stdgo.AnyInterface(_ptr, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.pointerType({ get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) })))).len();
        })?.__copy__() : stdgo.GoString);
        var _wantStr = @:assignType (("reflect: call of reflect.Value.Len on ptr to non-array Value" : stdgo.GoString) : stdgo.GoString);
        //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7964"
        if (_e != (_wantStr)) {
            //"file:///Users/o/.go/go1.21.3/src/reflect/all_test.go#L7965"
