...
@:structInit @:using(_internal.reflect_test.Reflect_test_t_testcansetfield___localname___s2_10553_static_extension.T_testCanSetField___localname___S2_10553_static_extension) @:using(_internal.reflect_test.Reflect_test_t_testcansetfield___localname___s2_10553_static_extension.T_testCanSetField___localname___S2_10553_static_extension) class T_testCanSetField___localname___S2_10553 {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_embed", embedded : true, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type___internaldotreflect_testdotreflect_test_t_testcansetfield___localname___embed_10451dott_testcansetfield___localname___embed_10451.__type___internaldotreflect_testdotReflect_test_t_testcansetfield___localname___embed_10451dotT_testCanSetField___localname___embed_10451 }) }, optional : false }, { name : "_x", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }, { name : "x", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])));
