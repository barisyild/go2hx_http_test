...
@:structInit @:using(_internal.reflect_test.Reflect_test_t_sfg_static_extension.T_sFG_static_extension) @:using(_internal.reflect_test.Reflect_test_t_sfg_static_extension.T_sFG_static_extension) class T_sFG {
