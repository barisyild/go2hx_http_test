...
@:structInit @:using(_internal.reflect_test.Reflect_test_d1_static_extension.D1_static_extension) @:using(_internal.reflect_test.Reflect_test_d1_static_extension.D1_static_extension) class D1 {
