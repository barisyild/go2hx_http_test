...
@:structInit @:using(_internal.reflect_test.Reflect_test_s1x_static_extension.S1x_static_extension) @:using(_internal.reflect_test.Reflect_test_s1x_static_extension.S1x_static_extension) class S1x {
    @:embedded
