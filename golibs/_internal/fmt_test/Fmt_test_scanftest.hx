...
@:structInit @:using(_internal.fmt_test.Fmt_test_scanftest_static_extension.ScanfTest_static_extension) @:using(_internal.fmt_test.Fmt_test_scanftest_static_extension.ScanfTest_static_extension) class ScanfTest {
