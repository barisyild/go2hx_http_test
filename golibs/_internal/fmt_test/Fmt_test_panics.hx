...
@:structInit @:using(_internal.fmt_test.Fmt_test_panics_static_extension.PanicS_static_extension) @:using(_internal.fmt_test.Fmt_test_panics_static_extension.PanicS_static_extension) class PanicS {
