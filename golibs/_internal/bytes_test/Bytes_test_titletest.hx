...
@:structInit @:using(_internal.bytes_test.Bytes_test_titletest_static_extension.TitleTest_static_extension) @:using(_internal.bytes_test.Bytes_test_titletest_static_extension.TitleTest_static_extension) class TitleTest {
