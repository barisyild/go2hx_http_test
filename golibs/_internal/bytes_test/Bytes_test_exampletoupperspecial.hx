...
function exampleToUpperSpecial():Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/bytes/example_test.go#L617"
        ...
        //"file:///Users/o/.go/go1.21.3/src/bytes/example_test.go#L618"
        stdgo._internal.fmt.Fmt_println.println(new stdgo.AnyInterface((("ToUpper : " : stdgo.GoString) + (_totitle : stdgo.GoString)?.__copy__() : stdgo.GoString), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(string_kind))));
    }
