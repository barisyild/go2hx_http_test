...
function benchmarkCompareBytesEqual(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/bytes/compare_test.go#L159"
        {
            var _i = @:assignType (0 : stdgo.GoInt);
            while ((_i < (@:checkr _b ?? throw stdgo.Error._nullPointerDereference.__underlying__()).n : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/bytes/compare_test.go#L160"
                if (stdgo._internal.bytes.Bytes_compare.compare(_b1, _b2) != ((0 : stdgo.GoInt))) {
                    //"file:///Users/o/.go/go1.21.3/src/bytes/compare_test.go#L161"
