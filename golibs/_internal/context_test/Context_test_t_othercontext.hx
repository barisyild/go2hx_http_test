...
@:structInit @:using(_internal.context_test.Context_test_t_othercontext_static_extension.T_otherContext_static_extension) @:using(_internal.context_test.Context_test_t_othercontext_static_extension.T_otherContext_static_extension) class T_otherContext {
    @:embedded
