...
function testAfterFuncCalledAfterCancel(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var _stop = @:assignType (stdgo._internal.context.Context_afterfunc.afterFunc(_ctx, function():Void {
            //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L874"
            if (_donec != null) _donec.__close__();
        }) : () -> Bool);
        //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L876"
        {
            var __select__ = true;
            var __c__0 = null;
var __c__1 = null;
            while (__select__) {
                if ({
                    ...
                    __select__ = false;
                    {
                        __c__0.__get__();
                        {
                            //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L878"
...
__c__1.__reset__();
        ...
        //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L881"
        _cancel();
        //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L882"
        {
            var __select__ = true;
            var __c__0 = null;
var __c__1 = null;
            while (__select__) {
                if ({
                    ...
                    __select__ = false;
                    {
                        __c__1.__get__();
                        {
                            //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L885"
...
__c__1.__reset__();
        ...
        //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L887"
        if (_stop()) {
            //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L888"
