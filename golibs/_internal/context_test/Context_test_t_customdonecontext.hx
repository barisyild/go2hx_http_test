...
@:structInit @:using(_internal.context_test.Context_test_t_customdonecontext_static_extension.T_customDoneContext_static_extension) @:using(_internal.context_test.Context_test_t_customdonecontext_static_extension.T_customDoneContext_static_extension) class T_customDoneContext {
    @:embedded
