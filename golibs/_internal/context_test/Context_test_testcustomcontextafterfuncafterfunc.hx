...
function testCustomContextAfterFuncAfterFunc(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        try {
            ...
            var _stop = @:assignType (stdgo._internal.context.Context_afterfunc.afterFunc(stdgo.Go.asInterface(_ctx0, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type___internaldotcontext_testdotcontext_test_t_afterfunccontextdott_afterfunccontext.__type___internaldotcontext_testdotContext_test_t_afterfunccontextdotT_afterFuncContext })), function():Void {
                //"file:///Users/o/.go/go1.21.3/src/context/afterfunc_test.go#L100"
            ...
            //"file:///Users/o/.go/go1.21.3/src/context/afterfunc_test.go#L103"
            _ctx0._cancel(stdgo._internal.context.Context_canceled.canceled);
            //"file:///Users/o/.go/go1.21.3/src/context/afterfunc_test.go#L104"
            _donec.__get__();
            {
