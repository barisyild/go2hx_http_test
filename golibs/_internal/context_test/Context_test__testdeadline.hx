...
function _testDeadline(_c:stdgo._internal.context.Context_context.Context, _name:stdgo.GoString, _t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        try {
            //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L128"
            _t.helper();
            ...
            //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L132"
            {
                var __select__ = true;
                var __c__0 = null;
var __c__1 = null;
                while (__select__) {
                    if ({
                        ...
                        __select__ = false;
                        {
                            __c__0.__get__();
                            {
                                //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L134"
                                _t.fatalf(("%s: context not timed out after %v" : stdgo.GoString), new stdgo.AnyInterface(_name, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(string_kind))), new stdgo.AnyInterface(stdgo.Go.asInterface(_d, _internal.gotype.Gotype___type__stdgodot_internaldottimedottime_durationdotduration.__type__stdgodot_internaldottimedotTime_durationdotDuration), new stdgo._internal.internal.reflect.Reflect._Type(_internal.gotype.Gotype___type__stdgodot_internaldottimedottime_durationdotduration.__type__stdgodot_internaldottimedotTime_durationdotDuration)));
                            };
                        };
                    } else if ({
                        if (__c__1 == null) {
...
__c__1.__reset__();
            ...
            //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L137"
            {
                ...
                if (({
                    ...
                    //"file:///Users/o/.go/go1.21.3/src/context/x_test.go#L138"
                    _t.errorf(("%s: c.Err() == %v; want %v" : stdgo.GoString), new stdgo.AnyInterface(_name, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(string_kind))), ({
                        final __t__ = _e;
                        if (__t__ == null) {
                            new stdgo.AnyInterface(null, new stdgo._internal.internal.reflect.Reflect._Type(_internal.gotype.Gotype___type__stdgodoterror.__type__stdgodotError)).__setNil__();
                        } else {
