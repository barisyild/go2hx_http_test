...
@:structInit @:using(_internal.runtime.internal.atomic_.Atomic__int32_static_extension.Int32_static_extension) @:using(_internal.runtime.internal.atomic_.Atomic__int32_static_extension.Int32_static_extension) class Int32 {
    ...
    public var _value : stdgo.GoInt32 = 0;
    public function new(?_noCopy:_internal.runtime.internal.atomic_.Atomic__t_nocopy.T_noCopy, ?_value:stdgo.GoInt32) {
    ...
    public function __copy__() {
        return new Int32(_noCopy, _value);
    }
}
