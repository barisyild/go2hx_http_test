...
class Int64__asInterface {
    ...
    @:keep
    public dynamic function store(_value:stdgo.GoInt64):Void @:_0 __self__.value.store(_value);
    @:keep
    ...
    var __self__ : _internal.runtime.internal.atomic_.Atomic__int64_pointer.Int64_Pointer;
