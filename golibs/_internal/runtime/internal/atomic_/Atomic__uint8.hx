...
@:structInit @:using(_internal.runtime.internal.atomic_.Atomic__uint8_static_extension.Uint8_static_extension) @:using(_internal.runtime.internal.atomic_.Atomic__uint8_static_extension.Uint8_static_extension) class Uint8 {
    ...
    public var _value : stdgo.GoUInt8 = 0;
    public function new(?_noCopy:_internal.runtime.internal.atomic_.Atomic__t_nocopy.T_noCopy, ?_value:stdgo.GoUInt8) {
    ...
    public function __copy__() {
        return new Uint8(_noCopy, _value);
    }
}
