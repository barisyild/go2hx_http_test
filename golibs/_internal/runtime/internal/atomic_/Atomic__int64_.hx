...
@:structInit @:using(_internal.runtime.internal.atomic_.Atomic__int64__static_extension.Int64__static_extension) @:using(_internal.runtime.internal.atomic_.Atomic__int64__static_extension.Int64__static_extension) class Int64_ {
    ...
    public var _value : stdgo.GoInt64 = 0;
    public function new(?_noCopy:_internal.runtime.internal.atomic_.Atomic__t_nocopy.T_noCopy, ?__0:_internal.runtime.internal.atomic_.Atomic__t_align64.T_align64, ?_value:stdgo.GoInt64) {
    ...
    public function __copy__() {
        return new Int64_(_noCopy, __0, _value);
    }
}
