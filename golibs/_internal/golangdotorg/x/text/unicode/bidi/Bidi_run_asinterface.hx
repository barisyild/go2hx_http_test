...
class Run_asInterface {
    @:keep
    public dynamic function pos():{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; } return @:_0 __self__.value.pos();
    @:keep
    ...
    var __self__ : _internal.golangdotorg.x.text.unicode.bidi.Bidi_runpointer.RunPointer;
