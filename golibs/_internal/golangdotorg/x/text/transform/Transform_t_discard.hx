...
@:structInit @:using(_internal.golangdotorg.x.text.transform.Transform_t_discard_static_extension.T_discard_static_extension) @:using(_internal.golangdotorg.x.text.transform.Transform_t_discard_static_extension.T_discard_static_extension) class T_discard {
    @:embedded
