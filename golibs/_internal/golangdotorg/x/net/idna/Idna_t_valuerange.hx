...
@:structInit @:using(_internal.golangdotorg.x.net.idna.Idna_t_valuerange_static_extension.T_valueRange_static_extension) @:using(_internal.golangdotorg.x.net.idna.Idna_t_valuerange_static_extension.T_valueRange_static_extension) class T_valueRange {
