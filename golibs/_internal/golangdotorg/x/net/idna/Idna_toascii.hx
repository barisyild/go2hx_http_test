...
function toASCII(_s:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/vendor/golang.org/x/net/idna/idna10.0.0.go#L48"
        return _internal.golangdotorg.x.net.idna.Idna_punycode.punycode._process(_s?.__copy__(), true);
    }
