...
@:structInit @:using(_internal.golangdotorg.x.net.dns.dnsmessage.Dnsmessage_nsresource_static_extension.NSResource_static_extension) @:using(_internal.golangdotorg.x.net.dns.dnsmessage.Dnsmessage_nsresource_static_extension.NSResource_static_extension) class NSResource {
    ...
    public function new(?nS:_internal.golangdotorg.x.net.dns.dnsmessage.Dnsmessage_name.Name) {
