...
typedef InternalBenchmarkPointerPointer = stdgo._internal.testing.Testing_internalbenchmarkpointerpointer.InternalBenchmarkPointerPointer;
typedef BPointerPointer = stdgo._internal.testing.Testing_bpointerpointer.BPointerPointer;
typedef BenchmarkResultPointerPointer = stdgo._internal.testing.Testing_benchmarkresultpointerpointer.BenchmarkResultPointerPointer;
typedef PBPointerPointer = stdgo._internal.testing.Testing_pbpointerpointer.PBPointerPointer;
typedef CoverBlockPointerPointer = stdgo._internal.testing.Testing_coverblockpointerpointer.CoverBlockPointerPointer;
typedef CoverPointerPointer = stdgo._internal.testing.Testing_coverpointerpointer.CoverPointerPointer;
typedef InternalExamplePointerPointer = stdgo._internal.testing.Testing_internalexamplepointerpointer.InternalExamplePointerPointer;
typedef InternalFuzzTargetPointerPointer = stdgo._internal.testing.Testing_internalfuzztargetpointerpointer.InternalFuzzTargetPointerPointer;
typedef FPointerPointer = stdgo._internal.testing.Testing_fpointerpointer.FPointerPointer;
typedef InternalTestPointerPointer = stdgo._internal.testing.Testing_internaltestpointerpointer.InternalTestPointerPointer;
typedef MPointerPointer = stdgo._internal.testing.Testing_mpointerpointer.MPointerPointer;
/**
