...
typedef PipelinePointerPointer = stdgo._internal.net.textproto.Textproto_pipelinepointerpointer.PipelinePointerPointer;
typedef ReaderPointerPointer = stdgo._internal.net.textproto.Textproto_readerpointerpointer.ReaderPointerPointer;
typedef ErrorPointerPointer = stdgo._internal.net.textproto.Textproto_errorpointerpointer.ErrorPointerPointer;
typedef ConnPointerPointer = stdgo._internal.net.textproto.Textproto_connpointerpointer.ConnPointerPointer;
typedef WriterPointerPointer = stdgo._internal.net.textproto.Textproto_writerpointerpointer.WriterPointerPointer;
typedef MIMEHeaderPointerPointer = stdgo._internal.net.textproto.Textproto_mimeheaderpointerpointer.MIMEHeaderPointerPointer;
typedef ProtocolErrorPointerPointer = stdgo._internal.net.textproto.Textproto_protocolerrorpointerpointer.ProtocolErrorPointerPointer;
/**
