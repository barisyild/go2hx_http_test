...
typedef ErrorPointerPointer = stdgo._internal.net.url.Url_errorpointerpointer.ErrorPointerPointer;
typedef URLPointerPointer = stdgo._internal.net.url.Url_urlpointerpointer.URLPointerPointer;
typedef UserinfoPointerPointer = stdgo._internal.net.url.Url_userinfopointerpointer.UserinfoPointerPointer;
typedef EscapeErrorPointerPointer = stdgo._internal.net.url.Url_escapeerrorpointerpointer.EscapeErrorPointerPointer;
typedef InvalidHostErrorPointerPointer = stdgo._internal.net.url.Url_invalidhosterrorpointerpointer.InvalidHostErrorPointerPointer;
typedef ValuesPointerPointer = stdgo._internal.net.url.Url_valuespointerpointer.ValuesPointerPointer;
/**
