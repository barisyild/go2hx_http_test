...
typedef ClientTracePointerPointer = stdgo._internal.net.http.httptrace.Httptrace_clienttracepointerpointer.ClientTracePointerPointer;
typedef WroteRequestInfoPointerPointer = stdgo._internal.net.http.httptrace.Httptrace_wroterequestinfopointerpointer.WroteRequestInfoPointerPointer;
typedef DNSStartInfoPointerPointer = stdgo._internal.net.http.httptrace.Httptrace_dnsstartinfopointerpointer.DNSStartInfoPointerPointer;
typedef DNSDoneInfoPointerPointer = stdgo._internal.net.http.httptrace.Httptrace_dnsdoneinfopointerpointer.DNSDoneInfoPointerPointer;
typedef GotConnInfoPointerPointer = stdgo._internal.net.http.httptrace.Httptrace_gotconninfopointerpointer.GotConnInfoPointerPointer;
/**
