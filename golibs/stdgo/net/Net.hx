package stdgo.net;
var flagUp : Flags = 1i64;
var flagBroadcast : Flags = 2i64;
var flagLoopback : Flags = 4i64;
var flagPointToPoint : Flags = 8i64;
var flagMulticast : Flags = 16i64;
var flagRunning : Flags = 32i64;
var iPv4len : stdgo.GoUInt64 = 4i64;
var iPv6len : stdgo.GoUInt64 = 16i64;
...
typedef DialerPointerPointer = stdgo._internal.net.Net_dialerpointerpointer.DialerPointerPointer;
typedef ListenConfigPointerPointer = stdgo._internal.net.Net_listenconfigpointerpointer.ListenConfigPointerPointer;
typedef SRVPointerPointer = stdgo._internal.net.Net_srvpointerpointer.SRVPointerPointer;
typedef MXPointerPointer = stdgo._internal.net.Net_mxpointerpointer.MXPointerPointer;
typedef NSPointerPointer = stdgo._internal.net.Net_nspointerpointer.NSPointerPointer;
typedef InterfacePointerPointer = stdgo._internal.net.Net_interfacepointerpointer.InterfacePointerPointer;
typedef IPNetPointerPointer = stdgo._internal.net.Net_ipnetpointerpointer.IPNetPointerPointer;
typedef IPAddrPointerPointer = stdgo._internal.net.Net_ipaddrpointerpointer.IPAddrPointerPointer;
typedef IPConnPointerPointer = stdgo._internal.net.Net_ipconnpointerpointer.IPConnPointerPointer;
typedef ResolverPointerPointer = stdgo._internal.net.Net_resolverpointerpointer.ResolverPointerPointer;
typedef OpErrorPointerPointer = stdgo._internal.net.Net_operrorpointerpointer.OpErrorPointerPointer;
typedef ParseErrorPointerPointer = stdgo._internal.net.Net_parseerrorpointerpointer.ParseErrorPointerPointer;
typedef AddrErrorPointerPointer = stdgo._internal.net.Net_addrerrorpointerpointer.AddrErrorPointerPointer;
typedef DNSConfigErrorPointerPointer = stdgo._internal.net.Net_dnsconfigerrorpointerpointer.DNSConfigErrorPointerPointer;
typedef DNSErrorPointerPointer = stdgo._internal.net.Net_dnserrorpointerpointer.DNSErrorPointerPointer;
typedef TCPAddrPointerPointer = stdgo._internal.net.Net_tcpaddrpointerpointer.TCPAddrPointerPointer;
typedef TCPConnPointerPointer = stdgo._internal.net.Net_tcpconnpointerpointer.TCPConnPointerPointer;
typedef TCPListenerPointerPointer = stdgo._internal.net.Net_tcplistenerpointerpointer.TCPListenerPointerPointer;
typedef UDPAddrPointerPointer = stdgo._internal.net.Net_udpaddrpointerpointer.UDPAddrPointerPointer;
typedef UDPConnPointerPointer = stdgo._internal.net.Net_udpconnpointerpointer.UDPConnPointerPointer;
typedef UnixAddrPointerPointer = stdgo._internal.net.Net_unixaddrpointerpointer.UnixAddrPointerPointer;
typedef UnixConnPointerPointer = stdgo._internal.net.Net_unixconnpointerpointer.UnixConnPointerPointer;
typedef UnixListenerPointerPointer = stdgo._internal.net.Net_unixlistenerpointerpointer.UnixListenerPointerPointer;
typedef FlagsPointerPointer = stdgo._internal.net.Net_flagspointerpointer.FlagsPointerPointer;
typedef IPPointerPointer = stdgo._internal.net.Net_ippointerpointer.IPPointerPointer;
typedef IPMaskPointerPointer = stdgo._internal.net.Net_ipmaskpointerpointer.IPMaskPointerPointer;
typedef HardwareAddrPointerPointer = stdgo._internal.net.Net_hardwareaddrpointerpointer.HardwareAddrPointerPointer;
typedef UnknownNetworkErrorPointerPointer = stdgo._internal.net.Net_unknownnetworkerrorpointerpointer.UnknownNetworkErrorPointerPointer;
typedef InvalidAddrErrorPointerPointer = stdgo._internal.net.Net_invalidaddrerrorpointerpointer.InvalidAddrErrorPointerPointer;
typedef BuffersPointerPointer = stdgo._internal.net.Net_bufferspointerpointer.BuffersPointerPointer;
typedef HaxeAddrPointerPointer = stdgo._internal.net.Net_haxeaddrpointerpointer.HaxeAddrPointerPointer;
typedef HaxeConnPointerPointer = stdgo._internal.net.Net_haxeconnpointerpointer.HaxeConnPointerPointer;
typedef HaxeListenerPointerPointer = stdgo._internal.net.Net_haxelistenerpointerpointer.HaxeListenerPointerPointer;
/**
    * 
