...
typedef Pointer_<T_> = stdgo._internal.sync.atomic_.Atomic__pointer_.Pointer_<T_>;
...
typedef Pointer_Pointer<T_> = stdgo._internal.sync.atomic_.Atomic__pointer_pointer.Pointer_Pointer<T_>;
...
typedef Bool_PointerPointer = stdgo._internal.sync.atomic_.Atomic__bool_pointerpointer.Bool_PointerPointer;
typedef Pointer_PointerPointer<T_> = stdgo._internal.sync.atomic_.Atomic__pointer_pointerpointer.Pointer_PointerPointer<T_>;
typedef Int32PointerPointer = stdgo._internal.sync.atomic_.Atomic__int32pointerpointer.Int32PointerPointer;
typedef Int64_PointerPointer = stdgo._internal.sync.atomic_.Atomic__int64_pointerpointer.Int64_PointerPointer;
typedef Uint32PointerPointer = stdgo._internal.sync.atomic_.Atomic__uint32pointerpointer.Uint32PointerPointer;
typedef Uint64PointerPointer = stdgo._internal.sync.atomic_.Atomic__uint64pointerpointer.Uint64PointerPointer;
typedef UintptrPointerPointer = stdgo._internal.sync.atomic_.Atomic__uintptrpointerpointer.UintptrPointerPointer;
typedef ValuePointerPointer = stdgo._internal.sync.atomic_.Atomic__valuepointerpointer.ValuePointerPointer;
/**
