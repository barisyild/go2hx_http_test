...
typedef BuilderPointerPointer = stdgo._internal.strings.Strings_builderpointerpointer.BuilderPointerPointer;
typedef ReaderPointerPointer = stdgo._internal.strings.Strings_readerpointerpointer.ReaderPointerPointer;
typedef ReplacerPointerPointer = stdgo._internal.strings.Strings_replacerpointerpointer.ReplacerPointerPointer;
/**
