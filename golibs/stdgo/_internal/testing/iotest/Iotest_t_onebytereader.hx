...
@:structInit @:using(stdgo._internal.testing.iotest.Iotest_t_onebytereader_static_extension.T_oneByteReader_static_extension) @:using(stdgo._internal.testing.iotest.Iotest_t_onebytereader_static_extension.T_oneByteReader_static_extension) class T_oneByteReader {
