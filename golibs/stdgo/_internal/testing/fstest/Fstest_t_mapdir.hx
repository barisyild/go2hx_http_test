...
@:structInit @:using(stdgo._internal.testing.fstest.Fstest_t_mapdir_static_extension.T_mapDir_static_extension) @:using(stdgo._internal.testing.fstest.Fstest_t_mapdir_static_extension.T_mapDir_static_extension) class T_mapDir {
