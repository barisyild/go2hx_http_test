...
class T_matchStringOnly_asInterface {
    ...
    @:keep
    public dynamic function readCorpus(_0:stdgo.GoString, _1:stdgo.Slice<stdgo._internal.reflect.Reflect_type_.Type_>):{ var _0 : stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }>; var _1 : stdgo.Error; } return @:_0 __self__.value.readCorpus(_0, _1);
    @:keep
    public dynamic function runFuzzWorker(_0:({ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }) -> stdgo.Error):stdgo.Error return @:_0 __self__.value.runFuzzWorker(_0);
    @:keep
    public dynamic function coordinateFuzzing(_0:stdgo._internal.time.Time_duration.Duration, _1:stdgo.GoInt64, _2:stdgo._internal.time.Time_duration.Duration, _3:stdgo.GoInt64, _4:stdgo.GoInt, _5:stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }>, _6:stdgo.Slice<stdgo._internal.reflect.Reflect_type_.Type_>, _7:stdgo.GoString, _8:stdgo.GoString):stdgo.Error return @:_0 __self__.value.coordinateFuzzing(_0, _1, _2, _3, _4, _5, _6, _7, _8);
    @:keep
