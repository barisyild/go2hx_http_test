...
@:keep @:allow(stdgo._internal.testing.Testing.T_matchStringOnly_asInterface) class T_matchStringOnly_static_extension {
    ...
    @:keep
    @:tdfield
    static public function readCorpus( _f:stdgo._internal.testing.Testing_t_matchstringonly.T_matchStringOnly, _0:stdgo.GoString, _1:stdgo.Slice<stdgo._internal.reflect.Reflect_type_.Type_>):{ var _0 : stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }>; var _1 : stdgo.Error; } throw "T_matchStringOnly:testing.readCorpus is not yet implemented";
    @:keep
    @:tdfield
    static public function runFuzzWorker( _f:stdgo._internal.testing.Testing_t_matchstringonly.T_matchStringOnly, _0:({ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }) -> stdgo.Error):stdgo.Error throw "T_matchStringOnly:testing.runFuzzWorker is not yet implemented";
    @:keep
    @:tdfield
    static public function coordinateFuzzing( _f:stdgo._internal.testing.Testing_t_matchstringonly.T_matchStringOnly, _0:stdgo._internal.time.Time_duration.Duration, _1:stdgo.GoInt64, _2:stdgo._internal.time.Time_duration.Duration, _3:stdgo.GoInt64, _4:stdgo.GoInt, _5:stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }>, _6:stdgo.Slice<stdgo._internal.reflect.Reflect_type_.Type_>, _7:stdgo.GoString, _8:stdgo.GoString):stdgo.Error throw "T_matchStringOnly:testing.coordinateFuzzing is not yet implemented";
    @:keep
    @:tdfield
