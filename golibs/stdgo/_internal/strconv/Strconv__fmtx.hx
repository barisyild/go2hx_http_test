...
function _fmtX(_dst:stdgo.Slice<stdgo.GoUInt8>, _prec:stdgo.GoInt, _fmt:stdgo.GoUInt8, _neg:Bool, _mant:stdgo.GoUInt64, _exp:stdgo.GoInt, _flt:stdgo.Ref<stdgo._internal.strconv.Strconv_t_floatinfo.T_floatInfo>):stdgo.Slice<stdgo.GoUInt8> {
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L491"
        if (_mant == ((0i64 : stdgo.GoUInt64))) {
            _exp = (0 : stdgo.GoInt);
        };
        _mant = (_mant << (((60u32 : stdgo.GoUInt) - (@:checkr _flt ?? throw stdgo.Error._nullPointerDereference.__underlying__())._mantbits : stdgo.GoUInt)) : stdgo.GoUInt64);
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L497"
        while (((_mant != (0i64 : stdgo.GoUInt64)) && ((_mant & (1152921504606846976i64 : stdgo.GoUInt64) : stdgo.GoUInt64) == (0i64 : stdgo.GoUInt64)) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L499"
            _exp--;
        };
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L503"
        if (((_prec >= (0 : stdgo.GoInt) : Bool) && (_prec < (15 : stdgo.GoInt) : Bool) : Bool)) {
            var _shift = @:assignType ((_prec * (4 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt);
            var _extra = @:assignType (((_mant << _shift : stdgo.GoUInt64)) & (1152921504606846975i64 : stdgo.GoUInt64) : stdgo.GoUInt64);
            _mant = (_mant >> (((60u32 : stdgo.GoUInt) - _shift : stdgo.GoUInt)) : stdgo.GoUInt64);
            //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L507"
            if (((_extra | ((_mant & (1i64 : stdgo.GoUInt64) : stdgo.GoUInt64)) : stdgo.GoUInt64) > (576460752303423488i64 : stdgo.GoUInt64) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L508"
                _mant++;
            };
            _mant = (_mant << (((60u32 : stdgo.GoUInt) - _shift : stdgo.GoUInt)) : stdgo.GoUInt64);
            //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L511"
            if ((_mant & (2305843009213693952i64 : stdgo.GoUInt64) : stdgo.GoUInt64) != ((0i64 : stdgo.GoUInt64))) {
                _mant = (_mant >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt64);
                //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L514"
                _exp++;
            };
        };
        var _hex = @:assignType (("0123456789abcdef" : stdgo.GoString) : stdgo.GoString);
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L519"
        if (_fmt == ((88 : stdgo.GoUInt8))) {
            _hex = ("0123456789ABCDEF" : stdgo.GoString);
        };
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L524"
        if (_neg) {
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L531"
        if (((_prec < (0 : stdgo.GoInt) : Bool) && (_mant != (0i64 : stdgo.GoUInt64)) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L533"
            ...
            _dst = (_dst.__append__((46 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>);
            //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L539"
            {
...
_mant = (_mant << ((4i64 : stdgo.GoUInt64)) : stdgo.GoUInt64);
        ...
        var _ch = @:assignType ((80 : stdgo.GoUInt8) : stdgo.GoUInt8);
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L547"
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L551"
        ...
        _dst = (_dst.__append__(_ch) : stdgo.Slice<stdgo.GoUInt8>);
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L560"
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/ftoa.go#L569"
        return _dst;
    }
