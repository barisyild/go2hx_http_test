...
var _j = __1, _i = __0;
        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L520"
        while ((_i < _j : Bool)) {
            var _h = @:assignType (_i + (((_j - _i : stdgo.GoInt)) >> (1i64 : stdgo.GoUInt64) : stdgo.GoInt) : stdgo.GoInt);
            //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L522"
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L528"
        return _i;
    }
