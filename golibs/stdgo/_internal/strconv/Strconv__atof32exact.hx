...
function _atof32exact(_mantissa:stdgo.GoUInt64, _exp:stdgo.GoInt, _neg:Bool):{ var _0 : stdgo.GoFloat32; var _1 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L464"
        if ((_mantissa >> stdgo._internal.strconv.Strconv__float32info._float32info._mantbits : stdgo.GoUInt64) != ((0i64 : stdgo.GoUInt64))) {
            //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L465"
            return { _0 : _f, _1 : _ok };
        };
        _f = (_mantissa : stdgo.GoFloat32);
        //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L468"
        if (_neg) {
            _f = -_f;
        };
        //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L471"
        if (_exp == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L473"
            return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L479"
            ...
            //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L483"
            if (((_f > (1e+07 : stdgo.GoFloat64) : Bool) || (_f < (-1e+07 : stdgo.GoFloat64) : Bool) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L485"
                return { _0 : _f, _1 : _ok };
            };
            //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L487"
            return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L489"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoFloat32; var _1 : Bool; } = { _0 : (_f / stdgo._internal.strconv.Strconv__float32pow10._float32pow10[(-_exp : stdgo.GoInt)] : stdgo.GoFloat32), _1 : true };
                _f = __tmp__._0;
                _ok = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/atof.go#L491"
        return { _0 : _f, _1 : _ok };
    }
