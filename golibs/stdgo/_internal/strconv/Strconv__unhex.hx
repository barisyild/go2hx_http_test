...
function _unhex(_b:stdgo.GoUInt8):{ var _0 : stdgo.GoInt32; var _1 : Bool; } {
        ...
        var _c = @:assignType (_b : stdgo.GoInt32);
        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L237"
        if ((((48 : stdgo.GoInt32) <= _c : Bool) && (_c <= (57 : stdgo.GoInt32) : Bool) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L239"
            return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L241"
            return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L243"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L245"
        return { _0 : _v, _1 : _ok };
    }
