...
function _appendEscapedRune(_buf:stdgo.Slice<stdgo.GoUInt8>, _r:stdgo.GoInt32, _quote:stdgo.GoUInt8, aSCIIonly:Bool, _graphicOnly:Bool):stdgo.Slice<stdgo.GoUInt8> {
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L70"
        if (((_r == (_quote : stdgo.GoInt32)) || (_r == (92 : stdgo.GoInt32)) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L73"
            return _buf;
        };
        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L75"
        if (aSCIIonly) {
            //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L76"
            if (((_r < (128 : stdgo.GoInt32) : Bool) && stdgo._internal.strconv.Strconv_isprint.isPrint(_r) : Bool)) {
                _buf = (_buf.__append__((_r : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>);
                //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L78"
                return _buf;
            };
            ...
            var _n = @:assignType (stdgo._internal.unicode.utf8.Utf8_encoderune.encodeRune((_runeTmp.__slice__(0) : stdgo.Slice<stdgo.GoUInt8>), _r) : stdgo.GoInt);
            _buf = (_buf.__append__(...((_runeTmp.__slice__(0, _n) : stdgo.Slice<stdgo.GoUInt8>) : Array<stdgo.GoUInt8>)) : stdgo.Slice<stdgo.GoUInt8>);
            //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L83"
            return _buf;
        };
        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L85"
        {
            ...
            while (__run__) {
                __run__ = false;
                {
                    ...
                    if (__value__ == ((7 : stdgo.GoInt32))) {
                        ...
                        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L101"
                        {
                            var __switchIndex__ = -1;
                            var __run__ = true;
                            while (__run__) {
                                ...
                                if (__switchIndex__ == 0 || (__switchIndex__ == -1 && ((_r < (32 : stdgo.GoInt32) : Bool) || (_r == (127 : stdgo.GoInt32)) : Bool))) {
                                    ...
                                    //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L108"
                                    @:fallthrough {
                                        __switchIndex__ = 2;
                                        __run__ = true;
                                        continue;
                                    ...
                                    //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L111"
                                    {
                                        var _s = @:assignType (12 : stdgo.GoInt);
                                    ...
                                    _buf = (_buf.__append__(...((("\\U" : stdgo.GoString) : stdgo.GoString) : Array<stdgo.GoUInt8>)) : stdgo.Slice<stdgo.GoUInt8>);
                                    //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L116"
                                    {
                                        var _s = @:assignType (28 : stdgo.GoInt);
                                        while ((_s >= (0 : stdgo.GoInt) : Bool)) {
                                            _buf = (_buf.__append__(("0123456789abcdef" : stdgo.GoString)[(((_r >> (_s : stdgo.GoUInt) : stdgo.GoInt32) & (15 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)]) : stdgo.Slice<stdgo.GoUInt8>);
                                            _s = (_s - ((4 : stdgo.GoInt)) : stdgo.GoInt);
                                        };
        ...
        //"file:///Users/o/.go/go1.21.3/src/strconv/quote.go#L121"
        return _buf;
    }
