...
@:structInit @:using(stdgo._internal.compress.flate.Flate_readerror_static_extension.ReadError_static_extension) @:using(stdgo._internal.compress.flate.Flate_readerror_static_extension.ReadError_static_extension) class ReadError {
