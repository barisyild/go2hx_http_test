...
@:structInit @:using(stdgo._internal.runtime.Runtime_t_rtype_static_extension.T_rtype_static_extension) @:using(stdgo._internal.runtime.Runtime_t_rtype_static_extension.T_rtype_static_extension) class T_rtype {
    @:embedded
