...
@:structInit @:using(stdgo._internal.runtime.Runtime_t_pallocdata_static_extension.T_pallocData_static_extension) @:using(stdgo._internal.runtime.Runtime_t_pallocdata_static_extension.T_pallocData_static_extension) class T_pallocData {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_pallocBits", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotruntimedotruntime_t_pallocbitsdott_pallocbits.__type__stdgodot_internaldotruntimedotRuntime_t_pallocbitsdotT_pallocBits }, optional : false }])));
