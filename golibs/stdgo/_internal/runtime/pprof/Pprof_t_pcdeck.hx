...
@:structInit @:using(stdgo._internal.runtime.pprof.Pprof_t_pcdeck_static_extension.T_pcDeck_static_extension) @:using(stdgo._internal.runtime.pprof.Pprof_t_pcdeck_static_extension.T_pcDeck_static_extension) class T_pcDeck {
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_pcs", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.sliceType({ get : () -> stdgo._internal.internal.reflect.GoType.basic(uintptr_kind) }) }, optional : false }, { name : "_frames", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.sliceType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotruntimedotruntime_framedotframe.__type__stdgodot_internaldotruntimedotRuntime_framedotFrame }) }, optional : false }, { name : "_symbolizeResult", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotruntimedotpprofdotpprof_t_symbolizeflagdott_symbolizeflag.__type__stdgodot_internaldotruntimedotpprofdotPprof_t_symbolizeflagdotT_symbolizeFlag }, optional : false }, { name : "_firstPCFrames", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }, { name : "_firstPCSymbolizeResult", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotruntimedotpprofdotpprof_t_symbolizeflagdott_symbolizeflag.__type__stdgodot_internaldotruntimedotpprofdotPprof_t_symbolizeflagdotT_symbolizeFlag }, optional : false }])));
