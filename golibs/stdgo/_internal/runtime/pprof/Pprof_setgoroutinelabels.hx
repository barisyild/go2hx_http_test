...
function setGoroutineLabels(_ctx:stdgo._internal.context.Context_context.Context):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/runtime/pprof/runtime.go#L37"
        stdgo._internal.runtime.pprof.Pprof__runtime_setproflabel._runtime_setProfLabel((new stdgo.AnyInterface(_ctxLabels, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(unsafepointer_kind))) : stdgo._internal.unsafe.Unsafe.UnsafePointer));
    }
