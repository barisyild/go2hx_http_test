...
@:structInit @:using(stdgo._internal.runtime.Runtime_t__func_static_extension.T__func_static_extension) @:using(stdgo._internal.runtime.Runtime_t__func_static_extension.T__func_static_extension) class T__func {
    @:embedded
