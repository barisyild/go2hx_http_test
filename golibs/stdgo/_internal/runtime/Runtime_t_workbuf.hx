...
@:structInit @:using(stdgo._internal.runtime.Runtime_t_workbuf_static_extension.T_workbuf_static_extension) @:using(stdgo._internal.runtime.Runtime_t_workbuf_static_extension.T_workbuf_static_extension) class T_workbuf {
    @:embedded
