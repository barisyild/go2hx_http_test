...
@:structInit @:using(stdgo._internal.runtime.Runtime_t_sweeplocked_static_extension.T_sweepLocked_static_extension) @:using(stdgo._internal.runtime.Runtime_t_sweeplocked_static_extension.T_sweepLocked_static_extension) class T_sweepLocked {
    @:embedded
