...
@:structInit @:using(stdgo._internal.runtime.Runtime_t_hiter_static_extension.T_hiter_static_extension) @:using(stdgo._internal.runtime.Runtime_t_hiter_static_extension.T_hiter_static_extension) class T_hiter {
