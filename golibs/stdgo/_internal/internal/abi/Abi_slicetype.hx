...
@:structInit @:using(stdgo._internal.internal.abi.Abi_slicetype_static_extension.SliceType_static_extension) @:using(stdgo._internal.internal.abi.Abi_slicetype_static_extension.SliceType_static_extension) class SliceType {
    @:embedded
