...
@:structInit class T_uncommon___localname___T_uncommon___localname___u_8727_8727 {
    @:embedded
    ...
    public function __copy__() {
        return new T_uncommon___localname___T_uncommon___localname___u_8727_8727(chanType, _u);
    }
}
