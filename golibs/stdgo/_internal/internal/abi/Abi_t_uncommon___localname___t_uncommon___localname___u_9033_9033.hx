...
@:structInit class T_uncommon___localname___T_uncommon___localname___u_9033_9033 {
    @:embedded
    ...
    public function __copy__() {
        return new T_uncommon___localname___T_uncommon___localname___u_9033_9033(type, _u);
    }
}
