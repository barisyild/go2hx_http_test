...
@:structInit @:using(stdgo._internal.internal.abi.Abi_ptrtype_static_extension.PtrType_static_extension) @:using(stdgo._internal.internal.abi.Abi_ptrtype_static_extension.PtrType_static_extension) class PtrType {
    @:embedded
