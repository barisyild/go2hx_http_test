...
@:structInit @:using(stdgo._internal.internal.abi.Abi_arraytype_static_extension.ArrayType_static_extension) @:using(stdgo._internal.internal.abi.Abi_arraytype_static_extension.ArrayType_static_extension) class ArrayType {
    @:embedded
