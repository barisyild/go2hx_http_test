...
@:structInit class T_uncommon___localname___T_uncommon___localname___u_8626_8626 {
    @:embedded
    ...
    public function __copy__() {
        return new T_uncommon___localname___T_uncommon___localname___u_8626_8626(arrayType, _u);
    }
}
