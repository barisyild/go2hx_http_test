...
@:keep @:allow(stdgo._internal.internal.abi.Abi.MapType_asInterface) class MapType_static_extension {
    ...
    static public function hashMightPanic( _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType>):Bool {
        ...
        //"file:///Users/o/.go/go1.21.3/src/internal/abi/type.go#L468"
        return ((@:checkr _mt ?? throw stdgo.Error._nullPointerDereference.__underlying__()).flags & (16u32 : stdgo.GoUInt32) : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:keep
    @:tdfield
    static public function needKeyUpdate( _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType>):Bool {
        @:recv var _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType> = _mt;
        //"file:///Users/o/.go/go1.21.3/src/internal/abi/type.go#L465"
        return ((@:checkr _mt ?? throw stdgo.Error._nullPointerDereference.__underlying__()).flags & (8u32 : stdgo.GoUInt32) : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:keep
    @:tdfield
    static public function reflexiveKey( _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType>):Bool {
        @:recv var _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType> = _mt;
        //"file:///Users/o/.go/go1.21.3/src/internal/abi/type.go#L462"
        return ((@:checkr _mt ?? throw stdgo.Error._nullPointerDereference.__underlying__()).flags & (4u32 : stdgo.GoUInt32) : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:keep
    @:tdfield
    static public function indirectElem( _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType>):Bool {
        @:recv var _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType> = _mt;
        //"file:///Users/o/.go/go1.21.3/src/internal/abi/type.go#L459"
        return ((@:checkr _mt ?? throw stdgo.Error._nullPointerDereference.__underlying__()).flags & (2u32 : stdgo.GoUInt32) : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:keep
    @:tdfield
    static public function indirectKey( _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType>):Bool {
        @:recv var _mt:stdgo.Ref<stdgo._internal.internal.abi.Abi_maptype.MapType> = _mt;
        //"file:///Users/o/.go/go1.21.3/src/internal/abi/type.go#L456"
        return ((@:checkr _mt ?? throw stdgo.Error._nullPointerDereference.__underlying__()).flags & (1u32 : stdgo.GoUInt32) : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:embedded
