...
@:structInit class T_uncommon___localname___T_uncommon___localname___u_8423_8423 {
    @:embedded
    ...
    public function __copy__() {
        return new T_uncommon___localname___T_uncommon___localname___u_8423_8423(funcType, _u);
    }
}
