...
@:structInit @:using(stdgo._internal.internal.abi.Abi_t_uncommon___localname___u_8930_static_extension.T_uncommon___localname___u_8930_static_extension) class T_uncommon___localname___u_8930 {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "interfaceType", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotinternaldotabidotabi_interfacetypedotinterfacetype.__type__stdgodot_internaldotinternaldotabidotAbi_interfacetypedotInterfaceType }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotinternaldotabidotabi_uncommontypedotuncommontype.__type__stdgodot_internaldotinternaldotabidotAbi_uncommontypedotUncommonType }, optional : false }])));
