...
class T_uncommon___localname___u_9033_asInterface {
    @:embedded
    ...
    var __self__ : stdgo._internal.internal.abi.Abi_t_uncommon___localname___u_9033pointer.T_uncommon___localname___u_9033Pointer;
