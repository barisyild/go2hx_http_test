...
@:structInit @:using(stdgo._internal.internal.abi.Abi_interfacetype_static_extension.InterfaceType_static_extension) @:using(stdgo._internal.internal.abi.Abi_interfacetype_static_extension.InterfaceType_static_extension) class InterfaceType {
    @:embedded
