...
class T_uncommon___localname___u_8826_asInterface {
    @:embedded
    ...
    var __self__ : stdgo._internal.internal.abi.Abi_t_uncommon___localname___u_8826pointer.T_uncommon___localname___u_8826Pointer;
