...
@:structInit @:using(stdgo._internal.internal.abi.Abi_functype_static_extension.FuncType_static_extension) @:using(stdgo._internal.internal.abi.Abi_functype_static_extension.FuncType_static_extension) class FuncType {
    @:embedded
