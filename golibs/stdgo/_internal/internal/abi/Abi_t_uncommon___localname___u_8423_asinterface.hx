...
class T_uncommon___localname___u_8423_asInterface {
    @:embedded
    ...
    @:embedded
    @:embeddededffieldsffun
    public dynamic function out(_0:stdgo.GoInt):stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_> return @:_0 __self__.value.out(_0);
    @:embedded
    @:embeddededffieldsffun
    ...
    @:embedded
    @:embeddededffieldsffun
    public dynamic function in_(_0:stdgo.GoInt):stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_> return @:_0 __self__.value.in_(_0);
    @:embedded
    @:embeddededffieldsffun
    ...
    var __self__ : stdgo._internal.internal.abi.Abi_t_uncommon___localname___u_8423pointer.T_uncommon___localname___u_8423Pointer;
