...
@:structInit @:using(stdgo._internal.internal.abi.Abi_t_uncommon___localname___u_8423_static_extension.T_uncommon___localname___u_8423_static_extension) class T_uncommon___localname___u_8423 {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "funcType", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotinternaldotabidotabi_functypedotfunctype.__type__stdgodot_internaldotinternaldotabidotAbi_functypedotFuncType }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotinternaldotabidotabi_uncommontypedotuncommontype.__type__stdgodot_internaldotinternaldotabidotAbi_uncommontypedotUncommonType }, optional : false }])));
