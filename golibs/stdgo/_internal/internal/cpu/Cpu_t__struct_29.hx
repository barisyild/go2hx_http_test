...
@:local @:using(stdgo._internal.internal.cpu.Cpu_t__struct_29_static_extension.T__struct_29_static_extension) @:using(stdgo._internal.internal.cpu.Cpu_t__struct_29_static_extension.T__struct_29_static_extension) @:using(stdgo._internal.internal.cpu.Cpu_t__struct_29_static_extension.T__struct_29_static_extension) typedef T__struct_29 = {
    @:optional
