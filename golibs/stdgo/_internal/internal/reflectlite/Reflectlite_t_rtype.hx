...
@:structInit @:using(stdgo._internal.internal.reflectlite.Reflectlite_t_rtype_static_extension.T_rtype_static_extension) @:using(stdgo._internal.internal.reflectlite.Reflectlite_t_rtype_static_extension.T_rtype_static_extension) class T_rtype {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "type", embedded : true, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotinternaldotabidotabi_type_dottype_.__type__stdgodot_internaldotinternaldotabidotAbi_type_dotType_ }) }, optional : false }])));
