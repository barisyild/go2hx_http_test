...
@:structInit @:using(stdgo._internal.internal.fuzz.Fuzz_t_queue_static_extension.T_queue_static_extension) @:using(stdgo._internal.internal.fuzz.Fuzz_t_queue_static_extension.T_queue_static_extension) class T_queue {
