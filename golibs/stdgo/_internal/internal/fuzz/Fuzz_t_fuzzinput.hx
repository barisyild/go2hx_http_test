...
@:structInit @:using(stdgo._internal.internal.fuzz.Fuzz_t_fuzzinput_static_extension.T_fuzzInput_static_extension) @:using(stdgo._internal.internal.fuzz.Fuzz_t_fuzzinput_static_extension.T_fuzzInput_static_extension) class T_fuzzInput {
    ...
    public function new(?_entry:{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }, ?_timeout:stdgo._internal.time.Time_duration.Duration, ?_limit:stdgo.GoInt64, ?_warmup:Bool, ?_coverageData:stdgo.Slice<stdgo.GoUInt8>) {
