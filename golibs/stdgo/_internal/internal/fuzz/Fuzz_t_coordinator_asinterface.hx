...
class T_coordinator_asInterface {
    ...
    @:keep
    public dynamic function _addCorpusEntries(_addToCache:Bool, _entries:haxe.Rest<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }>):{ var _0 : Bool; var _1 : stdgo.Error; } return @:_0 __self__.value._addCorpusEntries(_addToCache, ..._entries);
