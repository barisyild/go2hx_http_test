...
@:structInit @:using(stdgo._internal.internal.fuzz.Fuzz_t_fuzzresult_static_extension.T_fuzzResult_static_extension) @:using(stdgo._internal.internal.fuzz.Fuzz_t_fuzzresult_static_extension.T_fuzzResult_static_extension) class T_fuzzResult {
    ...
    public function new(?_entry:{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }, ?_crasherMsg:stdgo.GoString, ?_canMinimize:Bool, ?_coverageData:stdgo.Slice<stdgo.GoUInt8>, ?_limit:stdgo.GoInt64, ?_count:stdgo.GoInt64, ?_totalDuration:stdgo._internal.time.Time_duration.Duration, ?_entryDuration:stdgo._internal.time.Time_duration.Duration) {
