...
function _byteSliceDuplicateBytes(_m:stdgo.Ref<stdgo._internal.internal.fuzz.Fuzz_t_mutator.T_mutator>, _b:stdgo.Slice<stdgo.GoUInt8>):stdgo.Slice<stdgo.GoUInt8> {
        //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L38"
        if (((_b.length) <= (1 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L39"
            return (null : stdgo.Slice<stdgo.GoUInt8>);
        };
        var _src = @:assignType (_m._rand((_b.length)) : stdgo.GoInt);
        var _dst = @:assignType (_m._rand((_b.length)) : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L43"
        while (_dst == (_src)) {
            _dst = _m._rand((_b.length));
        };
        var _n = @:assignType (_m._chooseLen(((_b.length) - _src : stdgo.GoInt)) : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L50"
        if ((((_b.length) + ((_n * (2 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoInt) >= _b.capacity : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L51"
            return (null : stdgo.Slice<stdgo.GoUInt8>);
        };
        ...
        //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L59"
        ...
        //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L62"
        ...
        //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L64"
        ...
        //"file:///Users/o/.go/go1.21.3/src/internal/fuzz/mutators_byteslice.go#L66"
        return _b;
    }
