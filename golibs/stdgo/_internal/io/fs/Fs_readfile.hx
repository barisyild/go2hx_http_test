...
function readFile(_fsys:stdgo._internal.io.fs.Fs_fs.FS, _name:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        ...
        try {
            //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L33"
            {
                ...
                if (_ok) {
                    //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L34"
            ...
            //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L38"
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L39"
            ...
            //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L44"
            {
                var __tmp__ = _file.stat(), _info:stdgo._internal.io.fs.Fs_fileinfo.FileInfo = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err == null) {
                    var _size64 = @:assignType (_info.size() : stdgo.GoInt64);
                    //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L46"
            ...
            //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L52"
            while (true) {
                //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L53"
                ...
                //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L59"
                if (_err != null) {
                    //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L60"
                    if (({
                        final __t__ = _err;
                        if (__t__ == null) {
                    ...
                    //"file:///Users/o/.go/go1.21.3/src/io/fs/readfile.go#L63"
                    {
