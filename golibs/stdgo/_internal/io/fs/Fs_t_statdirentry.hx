...
@:structInit @:using(stdgo._internal.io.fs.Fs_t_statdirentry_static_extension.T_statDirEntry_static_extension) @:using(stdgo._internal.io.fs.Fs_t_statdirentry_static_extension.T_statDirEntry_static_extension) class T_statDirEntry {
