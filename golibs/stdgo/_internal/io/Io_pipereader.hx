...
@:structInit @:using(stdgo._internal.io.Io_pipereader_static_extension.PipeReader_static_extension) @:using(stdgo._internal.io.Io_pipereader_static_extension.PipeReader_static_extension) class PipeReader {
