...
@:structInit @:using(stdgo._internal.io.Io_t_nopcloser_static_extension.T_nopCloser_static_extension) @:using(stdgo._internal.io.Io_t_nopcloser_static_extension.T_nopCloser_static_extension) class T_nopCloser {
    @:embedded
