...
function _extract(_str:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoInt; var _2 : stdgo.GoString; var _3 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L982"
        if (_str == ((stdgo.Go.str() : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L983"
            return { _0 : _name, _1 : _num, _2 : _rest, _3 : _ok };
        };
        var _brace = @:assignType (false : Bool);
        //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L986"
        if (_str[(0 : stdgo.GoInt)] == ((123 : stdgo.GoUInt8))) {
            _brace = true;
            _str = (_str.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
        };
        var _i = @:assignType (0 : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L991"
        while ((_i < (_str.length) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L993"
            if (((!stdgo._internal.unicode.Unicode_isletter.isLetter(_rune) && !stdgo._internal.unicode.Unicode_isdigit.isDigit(_rune) : Bool) && (_rune != (95 : stdgo.GoInt32)) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L994"
                break;
            };
            _i = (_i + (_size) : stdgo.GoInt);
        };
        //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L998"
        if (_i == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1000"
            return { _0 : _name, _1 : _num, _2 : _rest, _3 : _ok };
        };
        _name = (_str.__slice__(0, _i) : stdgo.GoString)?.__copy__();
        //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1003"
        if (_brace) {
            //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1004"
            if (((_i >= (_str.length) : Bool) || (_str[(_i : stdgo.GoInt)] != (125 : stdgo.GoUInt8)) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1006"
                return { _0 : _name, _1 : _num, _2 : _rest, _3 : _ok };
            };
            //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1008"
            _i++;
        };
        _num = (0 : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1013"
        {
            var _i = @:assignType (0 : stdgo.GoInt);
            while ((_i < (_name.length) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1014"
                if ((((_name[(_i : stdgo.GoInt)] < (48 : stdgo.GoUInt8) : Bool) || ((57 : stdgo.GoUInt8) < _name[(_i : stdgo.GoInt)] : Bool) : Bool) || (_num >= (100000000 : stdgo.GoInt) : Bool) : Bool)) {
                    _num = (-1 : stdgo.GoInt);
                    //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1016"
                    break;
                };
_num = (((_num * (10 : stdgo.GoInt) : stdgo.GoInt) + (_name[(_i : stdgo.GoInt)] : stdgo.GoInt) : stdgo.GoInt) - (48 : stdgo.GoInt) : stdgo.GoInt);
        ...
        //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1021"
        ...
        _ok = true;
        //"file:///Users/o/.go/go1.21.3/src/regexp/regexp.go#L1027"
        return { _0 : _name, _1 : _num, _2 : _rest, _3 : _ok };
    }
