...
@:structInit @:using(stdgo._internal.fmt.Fmt_t_wraperror_static_extension.T_wrapError_static_extension) @:using(stdgo._internal.fmt.Fmt_t_wraperror_static_extension.T_wrapError_static_extension) class T_wrapError {
