...
@:structInit @:using(stdgo._internal.crypto.cipher.Cipher_t_ofb_static_extension.T_ofb_static_extension) @:using(stdgo._internal.crypto.cipher.Cipher_t_ofb_static_extension.T_ofb_static_extension) class T_ofb {
