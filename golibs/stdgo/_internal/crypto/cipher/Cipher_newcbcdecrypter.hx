...
function newCBCDecrypter(_b:stdgo._internal.crypto.cipher.Cipher_block.Block, _iv:stdgo.Slice<stdgo.GoUInt8>):stdgo._internal.crypto.cipher.Cipher_blockmode.BlockMode {
        //"file:///Users/o/.go/go1.21.3/src/crypto/cipher/cbc.go#L121"
        if ((_iv.length) != (_b.blockSize())) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/cipher/cbc.go#L122"
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/cipher/cbc.go#L124"
        {
            var __tmp__ = @:castTranslate try {
                ...
                }), _internal.gotype.Gotype___type__stdgodot_internaldotcryptodotcipherdotcipher_t_cbcdecabledott_cbcdecable.__type__stdgodot_internaldotcryptodotcipherdotCipher_t_cbcdecabledotT_cbcDecAble) : stdgo._internal.crypto.cipher.Cipher_t_cbcdecable.T_cbcDecAble), _1 : true };
            } catch(__exception__) {
                { _0 : (null : stdgo._internal.crypto.cipher.Cipher_t_cbcdecable.T_cbcDecAble), _1 : false };
            }, _cbc = __tmp__._0, _ok = __tmp__._1;
            if (_ok) {
                //"file:///Users/o/.go/go1.21.3/src/crypto/cipher/cbc.go#L125"
                return _cbc.newCBCDecrypter(_iv);
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/crypto/cipher/cbc.go#L127"
