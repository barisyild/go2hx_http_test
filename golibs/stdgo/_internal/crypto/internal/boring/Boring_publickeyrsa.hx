...
@:structInit @:using(stdgo._internal.crypto.internal.boring.Boring_publickeyrsa_static_extension.PublicKeyRSA_static_extension) @:using(stdgo._internal.crypto.internal.boring.Boring_publickeyrsa_static_extension.PublicKeyRSA_static_extension) class PublicKeyRSA {
    @:optional
