...
@:structInit @:using(stdgo._internal.crypto.internal.boring.Boring_privatekeyecdsa_static_extension.PrivateKeyECDSA_static_extension) @:using(stdgo._internal.crypto.internal.boring.Boring_privatekeyecdsa_static_extension.PrivateKeyECDSA_static_extension) class PrivateKeyECDSA {
    @:optional
    ...
    public function __copy__() {
        return new PrivateKeyECDSA(__0);
    }
}
