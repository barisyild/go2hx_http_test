...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_clientkeyexchangemsg_static_extension.T_clientKeyExchangeMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_clientkeyexchangemsg_static_extension.T_clientKeyExchangeMsg_static_extension) class T_clientKeyExchangeMsg {
