...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_keyupdatemsg_static_extension.T_keyUpdateMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_keyupdatemsg_static_extension.T_keyUpdateMsg_static_extension) class T_keyUpdateMsg {
