...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_xornonceaead_static_extension.T_xorNonceAEAD_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_xornonceaead_static_extension.T_xorNonceAEAD_static_extension) class T_xorNonceAEAD {
