...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_certcache_static_extension.T_certCache_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_certcache_static_extension.T_certCache_static_extension) class T_certCache {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "map_", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotsyncdotsync_map_dotmap_.__type__stdgodot_internaldotsyncdotSync_map_dotMap_ }, optional : false }])));
