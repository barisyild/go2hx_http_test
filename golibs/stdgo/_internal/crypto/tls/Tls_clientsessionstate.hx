...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_clientsessionstate_static_extension.ClientSessionState_static_extension) @:using(stdgo._internal.crypto.tls.Tls_clientsessionstate_static_extension.ClientSessionState_static_extension) class ClientSessionState {
