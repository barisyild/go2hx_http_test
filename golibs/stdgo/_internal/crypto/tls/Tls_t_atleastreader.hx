...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_atleastreader_static_extension.T_atLeastReader_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_atleastreader_static_extension.T_atLeastReader_static_extension) class T_atLeastReader {
