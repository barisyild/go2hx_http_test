...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_serverkeyexchangemsg_static_extension.T_serverKeyExchangeMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_serverkeyexchangemsg_static_extension.T_serverKeyExchangeMsg_static_extension) class T_serverKeyExchangeMsg {
