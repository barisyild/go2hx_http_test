...
function _macSHA1(_key:stdgo.Slice<stdgo.GoUInt8>):stdgo._internal.hash.Hash_hash.Hash {
        var _h = @:assignType (stdgo._internal.crypto.sha1.Sha1_new_.new_ : () -> stdgo._internal.hash.Hash_hash.Hash);
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L420"
        if (true) {
            _h = stdgo._internal.crypto.tls.Tls__newconstanttimehash._newConstantTimeHash(_h);
        };
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L423"
