...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_certificatemsg_static_extension.T_certificateMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_certificatemsg_static_extension.T_certificateMsg_static_extension) class T_certificateMsg {
