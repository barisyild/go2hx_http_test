...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverKeyExchangeMsg_asInterface) class T_serverKeyExchangeMsg_static_extension {
    ...
    static public function _unmarshal( _m:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_serverkeyexchangemsg.T_serverKeyExchangeMsg>, _data:stdgo.Slice<stdgo.GoUInt8>):Bool {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/handshake_messages.go#L1525"
        if (((_data.length) < (4 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/handshake_messages.go#L1526"
            return false;
        };
        (@:checkr _m ?? throw stdgo.Error._nullPointerDereference.__underlying__())._key = (_data.__slice__((4 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/handshake_messages.go#L1529"
        return true;
    }
    @:keep
    @:tdfield
    static public function _marshal( _m:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_serverkeyexchangemsg.T_serverKeyExchangeMsg>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        @:recv var _m:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_serverkeyexchangemsg.T_serverKeyExchangeMsg> = _m;
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/handshake_messages.go#L1508"
        if ((@:checkr _m ?? throw stdgo.Error._nullPointerDereference.__underlying__())._raw != null) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/handshake_messages.go#L1509"
            return { _0 : (@:checkr _m ?? throw stdgo.Error._nullPointerDereference.__underlying__())._raw, _1 : (null : stdgo.Error) };
        };
        var _length = @:assignType ((@:checkr _m ?? throw stdgo.Error._nullPointerDereference.__underlying__())._key.length : stdgo.GoInt);
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/handshake_messages.go#L1517"
        (_x.__slice__((4 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>).__copyTo__((@:checkr _m ?? throw stdgo.Error._nullPointerDereference.__underlying__())._key);
        (@:checkr _m ?? throw stdgo.Error._nullPointerDereference.__underlying__())._raw = _x;
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/handshake_messages.go#L1520"
