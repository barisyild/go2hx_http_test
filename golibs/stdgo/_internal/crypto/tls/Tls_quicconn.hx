...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_quicconn_static_extension.QUICConn_static_extension) @:using(stdgo._internal.crypto.tls.Tls_quicconn_static_extension.QUICConn_static_extension) class QUICConn {
