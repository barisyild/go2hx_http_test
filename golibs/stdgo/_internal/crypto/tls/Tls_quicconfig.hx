...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_quicconfig_static_extension.QUICConfig_static_extension) @:using(stdgo._internal.crypto.tls.Tls_quicconfig_static_extension.QUICConfig_static_extension) class QUICConfig {
