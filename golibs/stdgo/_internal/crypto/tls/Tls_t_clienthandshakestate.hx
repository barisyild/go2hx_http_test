...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_clienthandshakestate_static_extension.T_clientHandshakeState_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_clienthandshakestate_static_extension.T_clientHandshakeState_static_extension) class T_clientHandshakeState {
