...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_finishedmsg_static_extension.T_finishedMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_finishedmsg_static_extension.T_finishedMsg_static_extension) class T_finishedMsg {
