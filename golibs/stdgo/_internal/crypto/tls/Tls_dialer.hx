...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_dialer_static_extension.Dialer_static_extension) @:using(stdgo._internal.crypto.tls.Tls_dialer_static_extension.Dialer_static_extension) class Dialer {
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "netDialer", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_dialerdotdialer.__type__stdgodot_internaldotnetdotNet_dialerdotDialer }) }, optional : false }, { name : "config", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotcryptodottlsdottls_configdotconfig.__type__stdgodot_internaldotcryptodottlsdotTls_configdotConfig }) }, optional : false }])));
