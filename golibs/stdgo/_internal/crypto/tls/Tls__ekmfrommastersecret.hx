...
function _ekmFromMasterSecret(_version:stdgo.GoUInt16, _suite:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_ciphersuite.T_cipherSuite>, _masterSecret:stdgo.Slice<stdgo.GoUInt8>, _clientRandom:stdgo.Slice<stdgo.GoUInt8>, _serverRandom:stdgo.Slice<stdgo.GoUInt8>):(stdgo.GoString, stdgo.Slice<stdgo.GoUInt8>, stdgo.GoInt) -> { var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L264"
        return function(_label:stdgo.GoString, _context:stdgo.Slice<stdgo.GoUInt8>, _length:stdgo.GoInt):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L265"
            {
                ...
                if (__value__ == (("client finished" : stdgo.GoString)) || __value__ == (("server finished" : stdgo.GoString)) || __value__ == (("master secret" : stdgo.GoString)) || __value__ == (("key expansion" : stdgo.GoString))) {
                    //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L268"
                    return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : stdgo._internal.fmt.Fmt_errorf.errorf(("crypto/tls: reserved ExportKeyingMaterial label: %s" : stdgo.GoString), new stdgo.AnyInterface(_label, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(string_kind)))) };
                };
            };
            var _seedLen = @:assignType ((_serverRandom.length) + (_clientRandom.length) : stdgo.GoInt);
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L272"
            if (_context != null) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L280"
            if (_context != null) {
                //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L281"
                if (((_context.length) >= (65536 : stdgo.GoInt) : Bool)) {
                    //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L282"
                ...
                _seed = (_seed.__append__((((_context.length) >> (8i64 : stdgo.GoUInt64) : stdgo.GoInt) : stdgo.GoUInt8), (_context.length : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>);
                _seed = (_seed.__append__(...(_context : Array<stdgo.GoUInt8>)) : stdgo.Slice<stdgo.GoUInt8>);
            };
            var _keyMaterial = (new stdgo.Slice<stdgo.GoUInt8>((_length : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L289"
            ...
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/prf.go#L290"
