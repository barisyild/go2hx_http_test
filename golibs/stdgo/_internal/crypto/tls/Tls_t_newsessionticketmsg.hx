...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_newsessionticketmsg_static_extension.T_newSessionTicketMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_newsessionticketmsg_static_extension.T_newSessionTicketMsg_static_extension) class T_newSessionTicketMsg {
