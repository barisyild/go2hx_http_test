...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_certificatestatusmsg_static_extension.T_certificateStatusMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_certificatestatusmsg_static_extension.T_certificateStatusMsg_static_extension) class T_certificateStatusMsg {
