...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_xorNonceAEAD_asInterface) class T_xorNonceAEAD_static_extension {
    ...
    static public function open( _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD>, _out:stdgo.Slice<stdgo.GoUInt8>, _nonce:stdgo.Slice<stdgo.GoUInt8>, _ciphertext:stdgo.Slice<stdgo.GoUInt8>, _additionalData:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L492"
        if (_nonce != null) for (_i => _b in _nonce) {
            (@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask[((4 : stdgo.GoInt) + _i : stdgo.GoInt)] = ((@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask[((4 : stdgo.GoInt) + _i : stdgo.GoInt)] ^ (_b) : stdgo.GoUInt8);
        };
        var __tmp__ = (@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._aead.open(_out, ((@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask.__slice__(0) : stdgo.Slice<stdgo.GoUInt8>), _ciphertext, _additionalData), _result:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L496"
        if (_nonce != null) for (_i => _b in _nonce) {
            (@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask[((4 : stdgo.GoInt) + _i : stdgo.GoInt)] = ((@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask[((4 : stdgo.GoInt) + _i : stdgo.GoInt)] ^ (_b) : stdgo.GoUInt8);
        };
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L500"
    ...
    static public function seal( _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD>, _out:stdgo.Slice<stdgo.GoUInt8>, _nonce:stdgo.Slice<stdgo.GoUInt8>, _plaintext:stdgo.Slice<stdgo.GoUInt8>, _additionalData:stdgo.Slice<stdgo.GoUInt8>):stdgo.Slice<stdgo.GoUInt8> {
        @:recv var _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD> = _f;
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L480"
        if (_nonce != null) for (_i => _b in _nonce) {
            (@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask[((4 : stdgo.GoInt) + _i : stdgo.GoInt)] = ((@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask[((4 : stdgo.GoInt) + _i : stdgo.GoInt)] ^ (_b) : stdgo.GoUInt8);
        };
        var _result = (@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._aead.seal(_out, ((@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask.__slice__(0) : stdgo.Slice<stdgo.GoUInt8>), _plaintext, _additionalData);
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L484"
        if (_nonce != null) for (_i => _b in _nonce) {
            (@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask[((4 : stdgo.GoInt) + _i : stdgo.GoInt)] = ((@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._nonceMask[((4 : stdgo.GoInt) + _i : stdgo.GoInt)] ^ (_b) : stdgo.GoUInt8);
        };
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L488"
        return _result;
    }
    @:keep
    @:tdfield
    static public function _explicitNonceLen( _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD>):stdgo.GoInt {
        @:recv var _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD> = _f;
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L477"
    ...
    static public function overhead( _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD>):stdgo.GoInt {
        @:recv var _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD> = _f;
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L476"
    ...
    static public function nonceSize( _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD>):stdgo.GoInt {
        @:recv var _f:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_xornonceaead.T_xorNonceAEAD> = _f;
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L475"
