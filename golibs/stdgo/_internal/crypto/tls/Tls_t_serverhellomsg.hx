...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_serverhellomsg_static_extension.T_serverHelloMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_serverhellomsg_static_extension.T_serverHelloMsg_static_extension) class T_serverHelloMsg {
...
{ name : "_compressionMethod", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(uint8_kind) }, optional : false },
...
{ name : "_supportedVersion", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(uint16_kind) }, optional : false },
{ name : "_serverShare", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotcryptodottlsdottls_t_keysharedott_keyshare.__type__stdgodot_internaldotcryptodottlsdotTls_t_keysharedotT_keyShare }, optional : false },
{ name : "_selectedIdentityPresent", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(bool_kind) }, optional : false },
{ name : "_selectedIdentity", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(uint16_kind) }, optional : false },
...
{ name : "_selectedGroup", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotcryptodottlsdottls_curveiddotcurveid.__type__stdgodot_internaldotcryptodottlsdotTls_curveiddotCurveID }, optional : false }])));
