...
function _aeadAESGCMTLS13(_key:stdgo.Slice<stdgo.GoUInt8>, _nonceMask:stdgo.Slice<stdgo.GoUInt8>):stdgo._internal.crypto.tls.Tls_t_aead.T_aead {
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L528"
        if ((_nonceMask.length) != ((12 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L529"
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L532"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L533"
            throw ({
                final __t__ = _err;
                if (__t__ == null) {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L536"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L537"
            throw ({
                final __t__ = _err;
                if (__t__ == null) {
                    new stdgo.AnyInterface(null, new stdgo._internal.internal.reflect.Reflect._Type(_internal.gotype.Gotype___type__stdgodoterror.__type__stdgodotError)).__setNil__();
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L541"
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/tls/cipher_suites.go#L542"
