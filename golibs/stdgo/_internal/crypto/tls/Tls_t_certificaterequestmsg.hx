...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_certificaterequestmsg_static_extension.T_certificateRequestMsg_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_certificaterequestmsg_static_extension.T_certificateRequestMsg_static_extension) class T_certificateRequestMsg {
