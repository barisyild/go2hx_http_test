...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_t_listener_static_extension.T_listener_static_extension) @:using(stdgo._internal.crypto.tls.Tls_t_listener_static_extension.T_listener_static_extension) class T_listener {
    @:embedded
    ...
    @:embeddededffieldsffun
    @:embeddededffieldsffun
    public function get_close():() -> stdgo.Error return @:check31 (this.listener ?? throw stdgo.Error._nullPointerDereference.__underlying__()).close;
