...
function _pkcs1v15HashInfo(_hash:stdgo._internal.crypto.Crypto_hash.Hash, _inLen:stdgo.GoInt):{ var _0 : stdgo.GoInt; var _1 : stdgo.Slice<stdgo.GoUInt8>; var _2 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L380"
        if (_hash == ((0u32 : stdgo._internal.crypto.Crypto_hash.Hash))) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L381"
            return {
        ...
        _hashLen = _hash.size();
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L385"
        if (_inLen != (_hashLen)) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L386"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L389"
        if (!_ok) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L390"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L392"
