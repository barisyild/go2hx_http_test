...
function _decryptOAEP(_hash:stdgo._internal.hash.Hash_hash.Hash, _mgfHash:stdgo._internal.hash.Hash_hash.Hash, _random:stdgo._internal.io.Io_reader.Reader, _priv:stdgo.Ref<stdgo._internal.crypto.rsa.Rsa_privatekey.PrivateKey>, _ciphertext:stdgo.Slice<stdgo.GoUInt8>, _label:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L713"
        {
        ...
        if (false) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L724"
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L725"
                return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
            };
            ...
            //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L728"
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L729"
                return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : stdgo._internal.crypto.rsa.Rsa_errdecryption.errDecryption };
            };
            //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L731"
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L735"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L736"
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
        };
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L739"
        _hash.write(_label);
        var _lHash = _hash.sum((null : stdgo.Slice<stdgo.GoUInt8>));
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L741"
        _hash.reset();
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L748"
        stdgo._internal.crypto.rsa.Rsa__mgf1xor._mgf1XOR(_seed, _mgfHash, _db);
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L749"
        ...
        var _lHash2Good = @:assignType (stdgo._internal.crypto.subtle.Subtle_constanttimecompare.constantTimeCompare(_lHash, _lHash2) : stdgo.GoInt);
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L768"
        {
            var _i = @:assignType (0 : stdgo.GoInt);
            while ((_i < (_rest.length) : Bool)) {
                var _equals0 = @:assignType (stdgo._internal.crypto.subtle.Subtle_constanttimebyteeq.constantTimeByteEq(_rest[(_i : stdgo.GoInt)], (0 : stdgo.GoUInt8)) : stdgo.GoInt);
var _equals1 = @:assignType (stdgo._internal.crypto.subtle.Subtle_constanttimebyteeq.constantTimeByteEq(_rest[(_i : stdgo.GoInt)], (1 : stdgo.GoUInt8)) : stdgo.GoInt);
...
_invalid = stdgo._internal.crypto.subtle.Subtle_constanttimeselect.constantTimeSelect((_lookingForIndex & ((_equals0 ^ (-1i64 : stdgo.GoInt32) : stdgo.GoInt)) : stdgo.GoInt), (1 : stdgo.GoInt), _invalid);
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L776"
        if ((((_firstByteIsZero & _lHash2Good : stdgo.GoInt) & ((_invalid ^ (-1i64 : stdgo.GoInt32) : stdgo.GoInt)) : stdgo.GoInt) & ((_lookingForIndex ^ (-1i64 : stdgo.GoInt32) : stdgo.GoInt)) : stdgo.GoInt) != ((1 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L777"
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : stdgo._internal.crypto.rsa.Rsa_errdecryption.errDecryption };
        };
        //"file:///Users/o/.go/go1.21.3/src/crypto/rsa/rsa.go#L780"
