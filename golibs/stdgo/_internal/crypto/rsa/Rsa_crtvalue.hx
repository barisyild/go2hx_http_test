...
@:structInit @:using(stdgo._internal.crypto.rsa.Rsa_crtvalue_static_extension.CRTValue_static_extension) @:using(stdgo._internal.crypto.rsa.Rsa_crtvalue_static_extension.CRTValue_static_extension) class CRTValue {
