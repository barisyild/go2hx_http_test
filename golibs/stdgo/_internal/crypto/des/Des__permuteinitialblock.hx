...
function _permuteInitialBlock(_block:stdgo.GoUInt64):stdgo.GoUInt64 {
        var _b1 = @:assignType (_block >> (48i64 : stdgo.GoUInt64) : stdgo.GoUInt64);
        var _b2 = @:assignType (_block << (48i64 : stdgo.GoUInt64) : stdgo.GoUInt64);
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/des/block.go#L182"
        return _block;
    }
