...
function _xorBytes(_dstb:stdgo.Pointer<stdgo.GoUInt8>, _xb:stdgo.Pointer<stdgo.GoUInt8>, _yb:stdgo.Pointer<stdgo.GoUInt8>, _n:stdgo.GoInt):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/subtle/xor_generic.go#L28"
        if ((false || stdgo._internal.crypto.subtle.Subtle__aligned._aligned(_dstb, _xb, _yb) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/subtle/xor_generic.go#L29"
            ...
            //"file:///Users/o/.go/go1.21.3/src/crypto/subtle/xor_generic.go#L30"
            if (((new stdgo.GoUIntptr(_n) : stdgo.GoUIntptr) % (new stdgo.GoUIntptr(4) : stdgo.GoUIntptr) : stdgo.GoUIntptr) == ((new stdgo.GoUIntptr(0) : stdgo.GoUIntptr))) {
                //"file:///Users/o/.go/go1.21.3/src/crypto/subtle/xor_generic.go#L31"
                return;
            };
            var _done = @:assignType (_n & ((((new stdgo.GoUIntptr(3) : stdgo.GoUIntptr) : stdgo.GoInt) ^ (-1i64 : stdgo.GoInt32) : stdgo.GoInt)) : stdgo.GoInt);
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/subtle/xor_generic.go#L38"
