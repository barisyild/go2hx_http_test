...
@:structInit @:using(stdgo._internal.crypto.md5.Md5_t_digest_static_extension.T_digest_static_extension) @:using(stdgo._internal.crypto.md5.Md5_t_digest_static_extension.T_digest_static_extension) class T_digest {
