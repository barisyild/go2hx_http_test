...
function _blockGeneric(_dig:stdgo.Ref<stdgo._internal.crypto.md5.Md5_t_digest.T_digest>, _p:stdgo.Slice<stdgo.GoUInt8>):Void {
        var __0 = @:assignType ((@:checkr _dig ?? throw stdgo.Error._nullPointerDereference.__underlying__())._s[(0 : stdgo.GoInt)] : stdgo.GoUInt32), __1 = @:assignType ((@:checkr _dig ?? throw stdgo.Error._nullPointerDereference.__underlying__())._s[(1 : stdgo.GoInt)] : stdgo.GoUInt32), __2 = @:assignType ((@:checkr _dig ?? throw stdgo.Error._nullPointerDereference.__underlying__())._s[(2 : stdgo.GoInt)] : stdgo.GoUInt32), __3 = @:assignType ((@:checkr _dig ?? throw stdgo.Error._nullPointerDereference.__underlying__())._s[(3 : stdgo.GoInt)] : stdgo.GoUInt32);
var _d = __3, _c = __2, _b = __1, _a = __0;
        //"file:///Users/o/.go/go1.21.3/src/crypto/md5/md5block.go#L18"
        {
...
var __0 = @:assignType (_a : stdgo.GoUInt32), __1 = @:assignType (_b : stdgo.GoUInt32), __2 = @:assignType (_c : stdgo.GoUInt32), __3 = @:assignType (_d : stdgo.GoUInt32);
var _dd = __3, _cc = __2, _bb = __1, _aa = __0;
var _x0 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x1 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((4 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x2 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((8 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x3 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((12 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x4 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((16 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x5 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((20 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x6 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((24 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x7 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((28 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x8 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((32 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _x9 = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((36 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _xa = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((40 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _xb = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((44 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _xc = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((48 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _xd = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((52 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _xe = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((56 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
var _xf = @:assignType (stdgo._internal.encoding.binary.Binary_littleendian.littleEndian.uint32((_q.__slice__((60 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoUInt32);
...
_d = (_d + (_dd) : stdgo.GoUInt32);
        ...
        };
        {
            ...
            final __tmp__2 = _c;
            final __tmp__3 = _d;
            final __tmp__4 = (@:checkr _dig ?? throw stdgo.Error._nullPointerDereference.__underlying__())._s;
            final __tmp__5 = (0 : stdgo.GoInt);
            final __tmp__6 = (@:checkr _dig ?? throw stdgo.Error._nullPointerDereference.__underlying__())._s;
            final __tmp__7 = (1 : stdgo.GoInt);
            final __tmp__8 = (@:checkr _dig ?? throw stdgo.Error._nullPointerDereference.__underlying__())._s;
            final __tmp__9 = (2 : stdgo.GoInt);
            final __tmp__10 = (@:checkr _dig ?? throw stdgo.Error._nullPointerDereference.__underlying__())._s;
