...
@:structInit @:using(stdgo._internal.crypto.elliptic.Elliptic_t_p256curve_static_extension.T_p256Curve_static_extension) @:using(stdgo._internal.crypto.elliptic.Elliptic_t_p256curve_static_extension.T_p256Curve_static_extension) class T_p256Curve {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_nistCurve", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotcryptodotellipticdotelliptic_t_nistcurvedott_nistcurve.__type__stdgodot_internaldotcryptodotellipticdotElliptic_t_nistcurvedotT_nistCurve }, optional : false }])));
