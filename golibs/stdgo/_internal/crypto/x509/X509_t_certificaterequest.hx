...
@:structInit @:using(stdgo._internal.crypto.x509.X509_t_certificaterequest_static_extension.T_certificateRequest_static_extension) @:using(stdgo._internal.crypto.x509.X509_t_certificaterequest_static_extension.T_certificateRequest_static_extension) class T_certificateRequest {
