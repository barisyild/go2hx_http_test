...
function systemCertPool():{ var _0 : stdgo.Ref<stdgo._internal.crypto.x509.X509_certpool.CertPool>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/crypto/x509/cert_pool.go#L112"
        {
            ...
            if (({
                ...
                //"file:///Users/o/.go/go1.21.3/src/crypto/x509/cert_pool.go#L113"
                return { _0 : _sysRoots.clone(), _1 : (null : stdgo.Error) };
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/crypto/x509/cert_pool.go#L116"
