...
@:structInit @:using(stdgo._internal.crypto.x509.X509_t_authorityinfoaccess_static_extension.T_authorityInfoAccess_static_extension) @:using(stdgo._internal.crypto.x509.X509_t_authorityinfoaccess_static_extension.T_authorityInfoAccess_static_extension) class T_authorityInfoAccess {
