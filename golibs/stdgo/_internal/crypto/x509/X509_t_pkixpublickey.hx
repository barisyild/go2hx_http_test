...
@:structInit @:using(stdgo._internal.crypto.x509.X509_t_pkixpublickey_static_extension.T_pkixPublicKey_static_extension) @:using(stdgo._internal.crypto.x509.X509_t_pkixpublickey_static_extension.T_pkixPublicKey_static_extension) class T_pkixPublicKey {
