...
function _extKeyUsageFromOID(_oid:stdgo._internal.encoding.asn1.Asn1_objectidentifier.ObjectIdentifier):{ var _0 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage; var _1 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/x509/x509.go#L659"
        if (stdgo._internal.crypto.x509.X509__extkeyusageoids._extKeyUsageOIDs != null) for (__1 => _pair in stdgo._internal.crypto.x509.X509__extkeyusageoids._extKeyUsageOIDs) {
            //"file:///Users/o/.go/go1.21.3/src/crypto/x509/x509.go#L660"
            if (_oid.equal(_pair._oid)) {
                //"file:///Users/o/.go/go1.21.3/src/crypto/x509/x509.go#L661"
                return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/crypto/x509/x509.go#L664"
