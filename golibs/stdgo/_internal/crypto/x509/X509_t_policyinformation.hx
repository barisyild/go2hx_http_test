...
@:structInit @:using(stdgo._internal.crypto.x509.X509_t_policyinformation_static_extension.T_policyInformation_static_extension) @:using(stdgo._internal.crypto.x509.X509_t_policyinformation_static_extension.T_policyInformation_static_extension) class T_policyInformation {
