...
function _cipherByKey(_key:stdgo._internal.crypto.x509.X509_pemcipher.PEMCipher):stdgo.Ref<stdgo._internal.crypto.x509.X509_t_rfc1423algo.T_rfc1423Algo> {
        //"file:///Users/o/.go/go1.21.3/src/crypto/x509/pem_decrypt.go#L245"
        if (stdgo._internal.crypto.x509.X509__rfc1423algos._rfc1423Algos != null) for (_i => _ in stdgo._internal.crypto.x509.X509__rfc1423algos._rfc1423Algos) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/crypto/x509/pem_decrypt.go#L247"
            if ((@:checkr _alg ?? throw stdgo.Error._nullPointerDereference.__underlying__())._cipher == (_key)) {
                //"file:///Users/o/.go/go1.21.3/src/crypto/x509/pem_decrypt.go#L248"
                return _alg;
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/crypto/x509/pem_decrypt.go#L251"
        return null;
    }
