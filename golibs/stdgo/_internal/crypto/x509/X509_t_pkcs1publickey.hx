...
@:structInit @:using(stdgo._internal.crypto.x509.X509_t_pkcs1publickey_static_extension.T_pkcs1PublicKey_static_extension) @:using(stdgo._internal.crypto.x509.X509_t_pkcs1publickey_static_extension.T_pkcs1PublicKey_static_extension) class T_pkcs1PublicKey {
