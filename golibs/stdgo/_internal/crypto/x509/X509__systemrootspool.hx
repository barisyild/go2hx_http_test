...
function _systemRootsPool():stdgo.Ref<stdgo._internal.crypto.x509.X509_certpool.CertPool> {
        ...
        try {
            ...
            //"file:///Users/o/.go/go1.21.3/src/crypto/x509/root.go#L24"
            {
