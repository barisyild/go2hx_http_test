...
@:structInit @:using(stdgo._internal.crypto.x509.X509_systemrootserror_static_extension.SystemRootsError_static_extension) @:using(stdgo._internal.crypto.x509.X509_systemrootserror_static_extension.SystemRootsError_static_extension) class SystemRootsError {
