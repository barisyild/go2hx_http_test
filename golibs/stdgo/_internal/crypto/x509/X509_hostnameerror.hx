...
@:structInit @:using(stdgo._internal.crypto.x509.X509_hostnameerror_static_extension.HostnameError_static_extension) @:using(stdgo._internal.crypto.x509.X509_hostnameerror_static_extension.HostnameError_static_extension) class HostnameError {
