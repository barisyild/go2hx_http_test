...
@:structInit @:using(stdgo._internal.crypto.x509.X509_t_certificate_static_extension.T_certificate_static_extension) @:using(stdgo._internal.crypto.x509.X509_t_certificate_static_extension.T_certificate_static_extension) class T_certificate {
