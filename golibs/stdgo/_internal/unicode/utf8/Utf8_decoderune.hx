...
function decodeRune(_p:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt32; var _1 : stdgo.GoInt; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L153"
        if ((_n < (1 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L154"
            return {
        ...
        var _p0 = @:assignType (_p[(0 : stdgo.GoInt)] : stdgo.GoUInt8);
        var _x = @:assignType (stdgo._internal.unicode.utf8.Utf8__first._first[(_p0 : stdgo.GoInt)] : stdgo.GoUInt8);
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L158"
        if ((_x >= (240 : stdgo.GoUInt8) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L163"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L167"
        if ((_n < _sz : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L168"
            return {
        ...
        var _b1 = @:assignType (_p[(1 : stdgo.GoInt)] : stdgo.GoUInt8);
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L171"
        if (((_b1 < _accept._lo : Bool) || (_accept._hi < _b1 : Bool) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L172"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt32; var _1 : stdgo.GoInt; } = { _0 : (65533 : stdgo.GoInt32), _1 : (1 : stdgo.GoInt) };
                _r = __tmp__._0;
                _size = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L174"
        if ((_sz <= (2 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L175"
            return {
        ...
        var _b2 = @:assignType (_p[(2 : stdgo.GoInt)] : stdgo.GoUInt8);
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L178"
        if (((_b2 < (128 : stdgo.GoUInt8) : Bool) || ((191 : stdgo.GoUInt8) < _b2 : Bool) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L179"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt32; var _1 : stdgo.GoInt; } = { _0 : (65533 : stdgo.GoInt32), _1 : (1 : stdgo.GoInt) };
                _r = __tmp__._0;
                _size = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L181"
        if ((_sz <= (3 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L182"
            return {
        ...
        var _b3 = @:assignType (_p[(3 : stdgo.GoInt)] : stdgo.GoUInt8);
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L185"
        if (((_b3 < (128 : stdgo.GoUInt8) : Bool) || ((191 : stdgo.GoUInt8) < _b3 : Bool) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L186"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt32; var _1 : stdgo.GoInt; } = { _0 : (65533 : stdgo.GoInt32), _1 : (1 : stdgo.GoInt) };
                _r = __tmp__._0;
                _size = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/unicode/utf8/utf8.go#L188"
        return {
