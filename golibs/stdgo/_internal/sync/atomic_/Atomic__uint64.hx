...
@:structInit @:using(stdgo._internal.sync.atomic_.Atomic__uint64_static_extension.Uint64_static_extension) @:using(stdgo._internal.sync.atomic_.Atomic__uint64_static_extension.Uint64_static_extension) class Uint64 {
    @:optional
    ...
    public function new(?__0:stdgo._internal.sync.atomic_.Atomic__t_nocopy.T_noCopy, ?__1:stdgo._internal.sync.atomic_.Atomic__t_align64.T_align64, ?_v:stdgo.GoUInt64) {
