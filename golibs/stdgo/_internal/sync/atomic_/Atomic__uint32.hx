...
@:structInit @:using(stdgo._internal.sync.atomic_.Atomic__uint32_static_extension.Uint32_static_extension) @:using(stdgo._internal.sync.atomic_.Atomic__uint32_static_extension.Uint32_static_extension) class Uint32 {
    @:optional
    ...
    public function new(?__0:stdgo._internal.sync.atomic_.Atomic__t_nocopy.T_noCopy, ?_v:stdgo.GoUInt32) {
