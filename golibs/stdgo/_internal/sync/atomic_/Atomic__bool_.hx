...
@:structInit @:using(stdgo._internal.sync.atomic_.Atomic__bool__static_extension.Bool__static_extension) @:using(stdgo._internal.sync.atomic_.Atomic__bool__static_extension.Bool__static_extension) class Bool_ {
    @:optional
