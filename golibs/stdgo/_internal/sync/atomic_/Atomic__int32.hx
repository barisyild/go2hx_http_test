...
@:structInit @:using(stdgo._internal.sync.atomic_.Atomic__int32_static_extension.Int32_static_extension) @:using(stdgo._internal.sync.atomic_.Atomic__int32_static_extension.Int32_static_extension) class Int32 {
    @:optional
    ...
    public function new(?__0:stdgo._internal.sync.atomic_.Atomic__t_nocopy.T_noCopy, ?_v:stdgo.GoInt32) {
