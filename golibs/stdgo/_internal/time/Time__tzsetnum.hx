...
function _tzsetNum(_s:stdgo.GoString, _min:stdgo.GoInt, _max:stdgo.GoInt):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L534"
        if ((_s.length) == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L535"
            return {
        ...
        _num = (0 : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L538"
        if (_s != null) for (_i => _r in _s) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L539"
            if (((_r < (48 : stdgo.GoInt32) : Bool) || (_r > (57 : stdgo.GoInt32) : Bool) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L540"
                if (((_i == (0 : stdgo.GoInt)) || (_num < _min : Bool) : Bool)) {
                    //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L541"
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : false };
                        _num = __tmp__._0;
                        _rest = __tmp__._1;
                ...
                //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L543"
                return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L547"
            if ((_num > _max : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L548"
                return {
                    @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : false };
                    _num = __tmp__._0;
                    _rest = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L551"
        if ((_num < _min : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L552"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : false };
                _num = __tmp__._0;
                _rest = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L554"
        return {
