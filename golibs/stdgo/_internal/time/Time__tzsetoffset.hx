...
function _tzsetOffset(_s:stdgo.GoString):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L399"
        if ((_s.length) == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L400"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L403"
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L414"
        if (!_ok) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L415"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : false };
                _offset = __tmp__._0;
                _rest = __tmp__._1;
        ...
        var _off = @:assignType (_hours * (3600 : stdgo.GoInt) : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L418"
        if (((_s.length == (0 : stdgo.GoInt)) || (_s[(0 : stdgo.GoInt)] != (58 : stdgo.GoUInt8)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L419"
            if (_neg) {
                _off = -_off;
            };
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L422"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L427"
        if (!_ok) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L428"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : false };
                _offset = __tmp__._0;
                _rest = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L431"
        if (((_s.length == (0 : stdgo.GoInt)) || (_s[(0 : stdgo.GoInt)] != (58 : stdgo.GoUInt8)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L432"
            if (_neg) {
                _off = -_off;
            };
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L435"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : _off, _1 : _s?.__copy__(), _2 : true };
                _offset = __tmp__._0;
                _rest = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L440"
        if (!_ok) {
            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L441"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : false };
                _offset = __tmp__._0;
                _rest = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L445"
        if (_neg) {
            _off = -_off;
        };
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L448"
        return {
            @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } = { _0 : _off, _1 : _s?.__copy__(), _2 : true };
            _offset = __tmp__._0;
            _rest = __tmp__._1;
