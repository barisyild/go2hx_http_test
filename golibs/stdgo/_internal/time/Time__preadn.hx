...
function _preadn(_fd:stdgo.GoUIntptr, _buf:stdgo.Slice<stdgo.GoUInt8>, _off:stdgo.GoInt):stdgo.Error {
        var _whence = @:assignType (0 : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L45"
        if ((_off < (0 : stdgo.GoInt) : Bool)) {
            _whence = (2 : stdgo.GoInt);
        };
        //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L48"
        {
            ...
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L49"
                return _err;
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L51"
        while (((_buf.length) > (0 : stdgo.GoInt) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L53"
            if ((_m <= (0 : stdgo.GoInt) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L54"
                if (_err == null) {
                    //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L55"
                    return stdgo._internal.errors.Errors_new_.new_(("short read" : stdgo.GoString));
                };
                //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L57"
                return _err;
            };
            _buf = (_buf.__slice__(_m) : stdgo.Slice<stdgo.GoUInt8>);
        };
        //"file:///Users/o/.go/go1.21.3/src/time/sys_unix.go#L61"
