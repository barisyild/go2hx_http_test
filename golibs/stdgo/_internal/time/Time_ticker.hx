...
@:structInit @:using(stdgo._internal.time.Time_ticker_static_extension.Ticker_static_extension) @:using(stdgo._internal.time.Time_ticker_static_extension.Ticker_static_extension) class Ticker {
