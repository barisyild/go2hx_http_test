...
function _tzruleTime(_year:stdgo.GoInt, _r:stdgo._internal.time.Time_t_rule.T_rule, _off:stdgo.GoInt):stdgo.GoInt {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L562"
        {
            ...
            while (__run__) {
                __run__ = false;
                {
                    ...
                    if (__value__ == ((0 : stdgo._internal.time.Time_t_rulekind.T_ruleKind))) {
                        ...
                        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L565"
                        ...
                        var _m1 = @:assignType ((((_r._mon + (9 : stdgo.GoInt) : stdgo.GoInt)) % (12 : stdgo.GoInt) : stdgo.GoInt) + (1 : stdgo.GoInt) : stdgo.GoInt);
                        var _yy0 = @:assignType (_year : stdgo.GoInt);
                        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L574"
                        if ((_r._mon <= (2 : stdgo.GoInt) : Bool)) {
                            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L575"
                            _yy0--;
                        };
                        var _yy1 = @:assignType (_yy0 / (100 : stdgo.GoInt) : stdgo.GoInt);
                        var _yy2 = @:assignType (_yy0 % (100 : stdgo.GoInt) : stdgo.GoInt);
                        var _dow = @:assignType ((((((((((((26 : stdgo.GoInt) * _m1 : stdgo.GoInt) - (2 : stdgo.GoInt) : stdgo.GoInt)) / (10 : stdgo.GoInt) : stdgo.GoInt) + (1 : stdgo.GoInt) : stdgo.GoInt) + _yy2 : stdgo.GoInt) + (_yy2 / (4 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoInt) + (_yy1 / (4 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoInt) - ((2 : stdgo.GoInt) * _yy1 : stdgo.GoInt) : stdgo.GoInt)) % (7 : stdgo.GoInt) : stdgo.GoInt);
                        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L580"
                        if ((_dow < (0 : stdgo.GoInt) : Bool)) {
                            _dow = (_dow + ((7 : stdgo.GoInt)) : stdgo.GoInt);
                        };
                        var _d = @:assignType (_r._day - _dow : stdgo.GoInt);
                        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L586"
                        if ((_d < (0 : stdgo.GoInt) : Bool)) {
                            _d = (_d + ((7 : stdgo.GoInt)) : stdgo.GoInt);
                        };
                        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L589"
                        {
                            var _i = @:assignType (1 : stdgo.GoInt);
                            while ((_i < _r._week : Bool)) {
                                //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L590"
                                if (((_d + (7 : stdgo.GoInt) : stdgo.GoInt) >= stdgo._internal.time.Time__daysin._daysIn((_r._mon : stdgo._internal.time.Time_month.Month), _year) : Bool)) {
                                    //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L591"
                                    break;
                                };
_d = (_d + ((7 : stdgo.GoInt)) : stdgo.GoInt);
                                _i++;
                        ...
                        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L596"
                        if ((stdgo._internal.time.Time__isleap._isLeap(_year) && (_r._mon > (2 : stdgo.GoInt) : Bool) : Bool)) {
                            //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L597"
                            _d++;
                        };
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/zoneinfo.go#L602"
