...
function _parseTimeZone(_value:stdgo.GoString):{ var _0 : stdgo.GoInt; var _1 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1412"
        if (((_value.length) < (3 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1413"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1416"
        if ((((_value.length) >= (4 : stdgo.GoInt) : Bool) && ((((_value.__slice__(0, (4 : stdgo.GoInt)) : stdgo.GoString) == ("ChST" : stdgo.GoString)) || ((_value.__slice__(0, (4 : stdgo.GoInt)) : stdgo.GoString) == ("MeST" : stdgo.GoString)) : Bool)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1417"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1420"
        if ((_value.__slice__(0, (3 : stdgo.GoInt)) : stdgo.GoString) == (("GMT" : stdgo.GoString))) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1422"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1425"
        if (((_value[(0 : stdgo.GoInt)] == (43 : stdgo.GoUInt8)) || (_value[(0 : stdgo.GoInt)] == (45 : stdgo.GoUInt8)) : Bool)) {
            ...
            var _ok = @:assignType (_length > (0 : stdgo.GoInt) : Bool);
            //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1428"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1432"
        {
            _nUpper = (0 : stdgo.GoInt);
            while ((_nUpper < (6 : stdgo.GoInt) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1433"
                if ((_nUpper >= (_value.length) : Bool)) {
                    //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1434"
                    break;
                };
//"file:///Users/o/.go/go1.21.3/src/time/format.go#L1436"
                {
                    var _c = @:assignType (_value[(_nUpper : stdgo.GoInt)] : stdgo.GoUInt8);
                    if (((_c < (65 : stdgo.GoUInt8) : Bool) || ((90 : stdgo.GoUInt8) < _c : Bool) : Bool)) {
                        //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1437"
                        break;
                    };
                };
                _nUpper++;
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1440"
        {
            ...
            if (__value__ == ((0 : stdgo.GoInt)) || __value__ == ((1 : stdgo.GoInt)) || __value__ == ((2 : stdgo.GoInt)) || __value__ == ((6 : stdgo.GoInt))) {
                //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1442"
                return {
                    @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : false };
                    _length = __tmp__._0;
                    _ok = __tmp__._1;
                ...
                //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1444"
                if (_value[(4 : stdgo.GoInt)] == ((84 : stdgo.GoUInt8))) {
                    //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1445"
                    return {
                ...
                //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1453"
                return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/time/format.go#L1455"
        return {
            @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : false };
            _length = __tmp__._0;
            _ok = __tmp__._1;
