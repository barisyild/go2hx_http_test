...
function trim(_s:stdgo.GoString, _cutset:stdgo.GoString):stdgo.GoString {
        //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L897"
        if (((_s == (stdgo.Go.str() : stdgo.GoString)) || (_cutset == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L898"
            return _s?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L900"
        if (((_cutset.length == (1 : stdgo.GoInt)) && (_cutset[(0 : stdgo.GoInt)] < (128 : stdgo.GoUInt8) : Bool) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L901"
        ...
        //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L903"
        {
            ...
            if (_ok) {
                //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L904"
                return stdgo._internal.strings.Strings__trimleftascii._trimLeftASCII(stdgo._internal.strings.Strings__trimrightascii._trimRightASCII(_s?.__copy__(), (stdgo.Go.setRef(_as, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotstringsdotstrings_t_asciisetdott_asciiset.__type__stdgodot_internaldotstringsdotStrings_t_asciisetdotT_asciiSet })) : stdgo.Ref<stdgo._internal.strings.Strings_t_asciiset.T_asciiSet>))?.__copy__(), (stdgo.Go.setRef(_as, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotstringsdotstrings_t_asciisetdott_asciiset.__type__stdgodot_internaldotstringsdotStrings_t_asciisetdotT_asciiSet })) : stdgo.Ref<stdgo._internal.strings.Strings_t_asciiset.T_asciiSet>))?.__copy__();
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L906"
