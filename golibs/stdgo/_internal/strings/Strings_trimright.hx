...
function trimRight(_s:stdgo.GoString, _cutset:stdgo.GoString):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L968"
        {
            ...
            if (_ok) {
                //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L969"
                return stdgo._internal.strings.Strings__trimrightascii._trimRightASCII(_s?.__copy__(), (stdgo.Go.setRef(_as, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotstringsdotstrings_t_asciisetdott_asciiset.__type__stdgodot_internaldotstringsdotStrings_t_asciisetdotT_asciiSet })) : stdgo.Ref<stdgo._internal.strings.Strings_t_asciiset.T_asciiSet>))?.__copy__();
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/strings/strings.go#L971"
