...
@:keep @:allow(stdgo._internal.mime.Mime.WordEncoder_asInterface) class WordEncoder_static_extension {
    ...
    static public function _splitWord( _e:stdgo._internal.mime.Mime_wordencoder.WordEncoder, _buf:stdgo.Ref<stdgo._internal.strings.Strings_builder.Builder>, _charset:stdgo.GoString):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L175"
        stdgo._internal.mime.Mime__closeword._closeWord(_buf);
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L176"
        _buf.writeByte((32 : stdgo.GoUInt8));
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L177"
    ...
    static public function _openWord( _e:stdgo._internal.mime.Mime_wordencoder.WordEncoder, _buf:stdgo.Ref<stdgo._internal.strings.Strings_builder.Builder>, _charset:stdgo.GoString):Void {
        @:recv var _e:stdgo._internal.mime.Mime_wordencoder.WordEncoder = _e;
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L161"
        _buf.writeString(("=?" : stdgo.GoString));
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L162"
        _buf.writeString(_charset?.__copy__());
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L163"
        _buf.writeByte((63 : stdgo.GoUInt8));
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L164"
        _buf.writeByte((_e : stdgo.GoUInt8));
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L165"
        _buf.writeByte((63 : stdgo.GoUInt8));
    }
    @:keep
    @:tdfield
...
//"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L134"
                if (((_currentLen + _encLen : stdgo.GoInt) > (63 : stdgo.GoInt) : Bool)) {
                    //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L135"
                    _e._splitWord(_buf, _charset.__copy__());
                    _currentLen = (0 : stdgo.GoInt);
                };
//"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L138"
...
_currentLen = (_currentLen + (_encLen) : stdgo.GoInt);
    ...
    static public function _bEncode( _e:stdgo._internal.mime.Mime_wordencoder.WordEncoder, _buf:stdgo.Ref<stdgo._internal.strings.Strings_builder.Builder>, _charset:stdgo.GoString, _s:stdgo.GoString):Void {
        @:recv var _e:stdgo._internal.mime.Mime_wordencoder.WordEncoder = _e;
        var _w = @:assignType (stdgo._internal.encoding.base64.Base64_newencoder.newEncoder(stdgo._internal.encoding.base64.Base64_stdencoding.stdEncoding, stdgo.Go.asInterface(_buf, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotstringsdotstrings_builderdotbuilder.__type__stdgodot_internaldotstringsdotStrings_builderdotBuilder }))) : stdgo._internal.io.Io_writecloser.WriteCloser);
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L86"
        if ((!stdgo._internal.mime.Mime__isutf8._isUTF8(_charset?.__copy__()) || (stdgo._internal.encoding.base64.Base64_stdencoding.stdEncoding.encodedLen((_s.length)) <= (63 : stdgo.GoInt) : Bool) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L87"
            stdgo._internal.io.Io_writestring.writeString(_w, _s?.__copy__());
            //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L88"
            _w.close();
            //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L89"
            return;
        };
        var _currentLen:stdgo.GoInt = (0 : stdgo.GoInt), _last:stdgo.GoInt = (0 : stdgo.GoInt), _runeLen:stdgo.GoInt = (0 : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L93"
        {
            var _i = @:assignType (0 : stdgo.GoInt);
            while ((_i < (_s.length) : Bool)) {
                {
...
//"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L98"
                if (((_currentLen + _runeLen : stdgo.GoInt) <= stdgo._internal.mime.Mime__maxbase64len._maxBase64Len : Bool)) {
                    ...
                    //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L101"
                    stdgo._internal.io.Io_writestring.writeString(_w, (_s.__slice__(_last, _i) : stdgo.GoString).__copy__());
                    //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L102"
                    _w.close();
                    //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L103"
                    _e._splitWord(_buf, _charset.__copy__());
                    _last = _i;
        ...
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L108"
        stdgo._internal.io.Io_writestring.writeString(_w, (_s.__slice__(_last) : stdgo.GoString)?.__copy__());
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L109"
        _w.close();
    }
    @:keep
    @:tdfield
    static public function _encodeWord( _e:stdgo._internal.mime.Mime_wordencoder.WordEncoder, _charset:stdgo.GoString, _s:stdgo.GoString):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L57"
        _buf.grow((48 : stdgo.GoInt));
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L59"
        _e._openWord((stdgo.Go.setRef(_buf, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotstringsdotstrings_builderdotbuilder.__type__stdgodot_internaldotstringsdotStrings_builderdotBuilder })) : stdgo.Ref<stdgo._internal.strings.Strings_builder.Builder>), _charset?.__copy__());
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L60"
        if (_e == ((98 : stdgo._internal.mime.Mime_wordencoder.WordEncoder))) {
            //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L61"
            _e._bEncode((stdgo.Go.setRef(_buf, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotstringsdotstrings_builderdotbuilder.__type__stdgodot_internaldotstringsdotStrings_builderdotBuilder })) : stdgo.Ref<stdgo._internal.strings.Strings_builder.Builder>), _charset?.__copy__(), _s?.__copy__());
        } else {
            //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L63"
            _e._qEncode((stdgo.Go.setRef(_buf, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotstringsdotstrings_builderdotbuilder.__type__stdgodot_internaldotstringsdotStrings_builderdotBuilder })) : stdgo.Ref<stdgo._internal.strings.Strings_builder.Builder>), _charset?.__copy__(), _s?.__copy__());
        };
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L65"
        stdgo._internal.mime.Mime__closeword._closeWord((stdgo.Go.setRef(_buf, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotstringsdotstrings_builderdotbuilder.__type__stdgodot_internaldotstringsdotStrings_builderdotBuilder })) : stdgo.Ref<stdgo._internal.strings.Strings_builder.Builder>));
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L67"
    ...
    static public function encode( _e:stdgo._internal.mime.Mime_wordencoder.WordEncoder, _charset:stdgo.GoString, _s:stdgo.GoString):stdgo.GoString {
        @:recv var _e:stdgo._internal.mime.Mime_wordencoder.WordEncoder = _e;
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L36"
        if (!stdgo._internal.mime.Mime__needsencoding._needsEncoding(_s?.__copy__())) {
            //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L37"
            return _s?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/mime/encodedword.go#L39"
