...
function _readHexByte(_v:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoUInt8; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/mime/quotedprintable/reader.go#L44"
        if (((_v.length) < (2 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/mime/quotedprintable/reader.go#L45"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/mime/quotedprintable/reader.go#L48"
        {
            {
            ...
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/mime/quotedprintable/reader.go#L49"
                return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/mime/quotedprintable/reader.go#L51"
        {
            {
            ...
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/mime/quotedprintable/reader.go#L52"
                return {
                    @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoUInt8; var _1 : stdgo.Error; } = { _0 : (0 : stdgo.GoUInt8), _1 : _err };
                    _b = __tmp__._0;
                    _err = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/mime/quotedprintable/reader.go#L54"
        return {
