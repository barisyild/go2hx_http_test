...
@:structInit class T__readForm___localname___T__readForm___localname___writerOnly_5240_5240 {
    @:embedded
    ...
    public function __copy__() {
        return new T__readForm___localname___T__readForm___localname___writerOnly_5240_5240(writer);
    }
}
