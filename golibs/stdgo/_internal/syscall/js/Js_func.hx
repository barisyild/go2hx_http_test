...
@:structInit @:using(stdgo._internal.syscall.js.Js_func_static_extension.Func_static_extension) @:using(stdgo._internal.syscall.js.Js_func_static_extension.Func_static_extension) class Func {
    @:embedded
