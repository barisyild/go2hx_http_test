...
@:structInit @:using(stdgo._internal.syscall.Syscall_procattr_static_extension.ProcAttr_static_extension) @:using(stdgo._internal.syscall.Syscall_procattr_static_extension.ProcAttr_static_extension) class ProcAttr {
