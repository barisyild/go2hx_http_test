...
function yn(_n:stdgo.GoInt, _x:stdgo.GoFloat64):stdgo.GoFloat64 {
        {};
        //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L238"
        if (((_x < (0 : stdgo.GoFloat64) : Bool) || stdgo._internal.math.Math_isnan.isNaN(_x) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L240"
            return stdgo._internal.math.Math_nan.naN();
        } else if (stdgo._internal.math.Math_isinf.isInf(_x, (1 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L242"
            return (0 : stdgo.GoFloat64);
        };
        //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L245"
        if (_n == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L246"
            return stdgo._internal.math.Math_y0.y0(_x);
        };
        //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L248"
        if (_x == ((0 : stdgo.GoFloat64))) {
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L249"
            if (((_n < (0 : stdgo.GoInt) : Bool) && ((_n & (1 : stdgo.GoInt) : stdgo.GoInt) == (1 : stdgo.GoInt)) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L250"
                return stdgo._internal.math.Math_inf.inf((1 : stdgo.GoInt));
            };
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L252"
            return stdgo._internal.math.Math_inf.inf((-1 : stdgo.GoInt));
        };
        var _sign = @:assignType (false : Bool);
        //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L255"
        if ((_n < (0 : stdgo.GoInt) : Bool)) {
            _n = -_n;
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L257"
            if ((_n & (1 : stdgo.GoInt) : stdgo.GoInt) == ((1 : stdgo.GoInt))) {
                _sign = true;
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L261"
        if (_n == ((1 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L262"
            if (_sign) {
                //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L263"
                return -stdgo._internal.math.Math_y1.y1(_x);
            };
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L265"
            return stdgo._internal.math.Math_y1.y1(_x);
        };
        var _b:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L268"
        if ((_x >= (8.148143905337944e+90 : stdgo.GoFloat64) : Bool)) {
            var _temp:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L283"
            {
            ...
            var _a = @:assignType (stdgo._internal.math.Math_y0.y0(_x) : stdgo.GoFloat64);
            _b = stdgo._internal.math.Math_y1.y1(_x);
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L298"
            {
        ...
        //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L302"
        if (_sign) {
            //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L303"
            return -_b;
        };
        //"file:///Users/o/.go/go1.21.3/src/math/jn.go#L305"
        return _b;
    }
