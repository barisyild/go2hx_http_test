...
@:structInit @:using(stdgo._internal.reflect.Reflect_mapiter_static_extension.MapIter_static_extension) @:using(stdgo._internal.reflect.Reflect_mapiter_static_extension.MapIter_static_extension) class MapIter {
    @:local
