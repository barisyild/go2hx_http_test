...
@:structInit @:using(stdgo._internal.reflect.Reflect_t_makefuncimpl_static_extension.T_makeFuncImpl_static_extension) @:using(stdgo._internal.reflect.Reflect_t_makefuncimpl_static_extension.T_makeFuncImpl_static_extension) class T_makeFuncImpl {
    @:embedded
