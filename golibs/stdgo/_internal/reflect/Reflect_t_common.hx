...
@:structInit @:using(stdgo._internal.reflect.Reflect_t_common_static_extension.T_common_static_extension) @:using(stdgo._internal.reflect.Reflect_t_common_static_extension.T_common_static_extension) class T_common {
    @:embedded
