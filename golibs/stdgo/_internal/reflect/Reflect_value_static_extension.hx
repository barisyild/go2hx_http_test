...
if (std.StringTools.endsWith(name, "_asInterface")) value = (value : Dynamic).__underlying__().value;
        ...
        switch t {
            ...
            case stdgo._internal.internal.reflect.GoType.named(path, methods, stdgo._internal.internal.reflect.GoType.arrayType(elem, _), alias, params):
                t = stdgo._internal.internal.reflect.GoType.named(path, methods, stdgo._internal.internal.reflect.GoType.sliceType(elem), alias, params);
            default:
                final _ = false;
        };
        final k = _v.kind();
...
throw "not supported";
    ...
    static public function isValid( _v:stdgo._internal.reflect.Reflect_value.Value):Bool {
        ...
        if (@:privateAccess _v.value.type._common() != stdgo._internal.internal.reflect.GoType.invalidType) return true;
...
if (std.StringTools.endsWith(name, "_asInterface")) value = (value : Dynamic).__underlying__().value;
    ...
    static public function addr( _v:stdgo._internal.reflect.Reflect_value.Value):stdgo._internal.reflect.Reflect_value.Value {
        final gt = @:privateAccess stdgo._internal.internal.reflect.GoType.pointerType({ get : () -> return _v.value.type._common() });
