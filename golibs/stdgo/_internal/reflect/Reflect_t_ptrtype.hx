...
@:structInit @:using(stdgo._internal.reflect.Reflect_t_ptrtype_static_extension.T_ptrType_static_extension) @:using(stdgo._internal.reflect.Reflect_t_ptrtype_static_extension.T_ptrType_static_extension) class T_ptrType {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "ptrType", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotinternaldotabidotabi_ptrtypedotptrtype.__type__stdgodot_internaldotinternaldotabidotAbi_ptrtypedotPtrType }, optional : false }])));
