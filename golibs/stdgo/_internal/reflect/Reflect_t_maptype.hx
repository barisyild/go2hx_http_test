...
@:structInit @:using(stdgo._internal.reflect.Reflect_t_maptype_static_extension.T_mapType_static_extension) @:using(stdgo._internal.reflect.Reflect_t_maptype_static_extension.T_mapType_static_extension) class T_mapType {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "mapType", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotinternaldotabidotabi_maptypedotmaptype.__type__stdgodot_internaldotinternaldotabidotAbi_maptypedotMapType }, optional : false }])));
