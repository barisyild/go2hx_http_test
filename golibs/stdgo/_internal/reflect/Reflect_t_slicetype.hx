...
@:structInit @:using(stdgo._internal.reflect.Reflect_t_slicetype_static_extension.T_sliceType_static_extension) @:using(stdgo._internal.reflect.Reflect_t_slicetype_static_extension.T_sliceType_static_extension) class T_sliceType {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "sliceType", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotinternaldotabidotabi_slicetypedotslicetype.__type__stdgodot_internaldotinternaldotabidotAbi_slicetypedotSliceType }, optional : false }])));
