...
function dialUnix(_network:stdgo.GoString, _laddr:stdgo.Ref<stdgo._internal.net.Net_unixaddr.UnixAddr>, _raddr:stdgo.Ref<stdgo._internal.net.Net_unixaddr.UnixAddr>):{ var _0 : stdgo.Ref<stdgo._internal.net.Net_unixconn.UnixConn>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L204"
        {
            final __value__ = _network;
            if (__value__ == (("unix" : stdgo.GoString)) || __value__ == (("unixgram" : stdgo.GoString)) || __value__ == (("unixpacket" : stdgo.GoString))) {} else {
                //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L207"
        ...
        var __tmp__ = _sd._dialUnix(stdgo._internal.context.Context_background.background(), _laddr, _raddr), _c:stdgo.Ref<stdgo._internal.net.Net_unixconn.UnixConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L211"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L212"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L214"
