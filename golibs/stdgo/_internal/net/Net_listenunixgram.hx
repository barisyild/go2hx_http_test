...
function listenUnixgram(_network:stdgo.GoString, _laddr:stdgo.Ref<stdgo._internal.net.Net_unixaddr.UnixAddr>):{ var _0 : stdgo.Ref<stdgo._internal.net.Net_unixconn.UnixConn>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L338"
        {
            final __value__ = _network;
            if (__value__ == (("unixgram" : stdgo.GoString))) {} else {
                //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L341"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L343"
        if (({
            final value = _laddr;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L344"
            return { _0 : null, _1 : stdgo.Go.asInterface((stdgo.Go.setRef(({ op : ("listen" : stdgo.GoString), net : _network?.__copy__(), source : (null : stdgo._internal.net.Net_addr.Addr), addr : (null : stdgo._internal.net.Net_addr.Addr), err : stdgo._internal.net.Net__errmissingaddress._errMissingAddress } : stdgo._internal.net.Net_operror.OpError), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_operrordotoperror.__type__stdgodot_internaldotnetdotNet_operrordotOpError })) : stdgo.Ref<stdgo._internal.net.Net_operror.OpError>), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_operrordotoperror.__type__stdgodot_internaldotnetdotNet_operrordotOpError })) };
        };
        ...
        var __tmp__ = _sl._listenUnixgram(stdgo._internal.context.Context_background.background(), _laddr), _c:stdgo.Ref<stdgo._internal.net.Net_unixconn.UnixConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L348"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L349"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/unixsock.go#L351"
