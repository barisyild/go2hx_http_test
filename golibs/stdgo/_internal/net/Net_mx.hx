...
@:structInit @:using(stdgo._internal.net.Net_mx_static_extension.MX_static_extension) @:using(stdgo._internal.net.Net_mx_static_extension.MX_static_extension) class MX {
