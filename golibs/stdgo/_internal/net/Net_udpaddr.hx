...
@:structInit @:using(stdgo._internal.net.Net_udpaddr_static_extension.UDPAddr_static_extension) @:using(stdgo._internal.net.Net_udpaddr_static_extension.UDPAddr_static_extension) class UDPAddr {
