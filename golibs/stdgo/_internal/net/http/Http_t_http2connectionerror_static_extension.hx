...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2ConnectionError_asInterface) class T_http2ConnectionError_static_extension {
    ...
    static public function error( _e:stdgo._internal.net.http.Http_t_http2connectionerror.T_http2ConnectionError):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L1225"
        return stdgo._internal.fmt.Fmt_sprintf.sprintf(("connection error: %s" : stdgo.GoString), new stdgo.AnyInterface(stdgo.Go.asInterface((_e : stdgo._internal.net.http.Http_t_http2errcode.T_http2ErrCode), _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2errcodedott_http2errcode.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2errcodedotT_http2ErrCode), new stdgo._internal.internal.reflect.Reflect._Type(_internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2errcodedott_http2errcode.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2errcodedotT_http2ErrCode)))?.__copy__();
    }
}
