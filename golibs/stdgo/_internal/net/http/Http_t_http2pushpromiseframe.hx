...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2pushpromiseframe_static_extension.T_http2PushPromiseFrame_static_extension) @:using(stdgo._internal.net.http.Http_t_http2pushpromiseframe_static_extension.T_http2PushPromiseFrame_static_extension) class T_http2PushPromiseFrame {
    @:embedded
