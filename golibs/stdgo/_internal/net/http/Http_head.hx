...
function head(_url:stdgo.GoString):{ var _0 : stdgo.Ref<stdgo._internal.net.http.Http_response.Response>; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L913"
        return ({
            @:explicitConversion final __tmp__ = stdgo._internal.net.http.Http_defaultclient.defaultClient.head(_url?.__copy__());
