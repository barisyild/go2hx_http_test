...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2unstartedhandler_static_extension.T_http2unstartedHandler_static_extension) @:using(stdgo._internal.net.http.Http_t_http2unstartedhandler_static_extension.T_http2unstartedHandler_static_extension) class T_http2unstartedHandler {
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_streamID", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "_rw", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2responsewriterdott_http2responsewriter.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2responsewriterdotT_http2responseWriter }) }, optional : false }, { name : "_req", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_requestdotrequest.__type__stdgodot_internaldotnetdothttpdotHttp_requestdotRequest }) }, optional : false }, { name : "_handler", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.signature(false, { get : () -> [_internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_responsewriterdotresponsewriter.__type__stdgodot_internaldotnetdothttpdotHttp_responsewriterdotResponseWriter, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_requestdotrequest.__type__stdgodot_internaldotnetdothttpdotHttp_requestdotRequest })] }, { get : () -> [] }, { get : () -> stdgo._internal.internal.reflect.GoType.invalidType }) }, optional : false }])));
