...
function allowQuerySemicolons(_h:stdgo._internal.net.http.Http_handler.Handler):stdgo._internal.net.http.Http_handler.Handler {
        //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L2951"
        return stdgo.Go.asInterface((function(_w:stdgo._internal.net.http.Http_responsewriter.ResponseWriter, _r:stdgo.Ref<stdgo._internal.net.http.Http_request.Request>):Void {
            //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L2952"
            if (stdgo._internal.strings.Strings_contains.contains((@:checkr (@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__()).uRL ?? throw stdgo.Error._nullPointerDereference.__underlying__()).rawQuery?.__copy__(), (";" : stdgo.GoString))) {
                ...
                (@:checkr (@:checkr _r2 ?? throw stdgo.Error._nullPointerDereference.__underlying__()).uRL ?? throw stdgo.Error._nullPointerDereference.__underlying__()).rawQuery = stdgo._internal.strings.Strings_replaceall.replaceAll((@:checkr (@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__()).uRL ?? throw stdgo.Error._nullPointerDereference.__underlying__()).rawQuery?.__copy__(), (";" : stdgo.GoString), ("&" : stdgo.GoString))?.__copy__();
                //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L2958"
                _h.serveHTTP(_w, _r2);
            } else {
                //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L2960"
                _h.serveHTTP(_w, _r);
            };
