...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2headerFieldValueError_asInterface) class T_http2headerFieldValueError_static_extension {
    ...
    static public function error( _e:stdgo._internal.net.http.Http_t_http2headerfieldvalueerror.T_http2headerFieldValueError):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L1298"
        return stdgo._internal.fmt.Fmt_sprintf.sprintf(("invalid header field value for %q" : stdgo.GoString), new stdgo.AnyInterface((_e : stdgo.GoString), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(string_kind))))?.__copy__();
    }
}
