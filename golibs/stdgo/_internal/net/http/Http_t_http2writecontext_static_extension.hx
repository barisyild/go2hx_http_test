...
@:keep class T_http2writeContext_static_extension {
    @:interfacetypeffun
    static public function headerEncoder(t:stdgo._internal.net.http.Http_t_http2writecontext.T_http2writeContext):{ var _0 : stdgo.Ref<_internal.golangdotorg.x.net.http2.hpack.Hpack_encoder.Encoder>; var _1 : stdgo.Ref<stdgo._internal.bytes.Bytes_buffer.Buffer>; } return t.headerEncoder();
    @:interfacetypeffun
