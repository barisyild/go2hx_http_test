...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2writewindowupdate_static_extension.T_http2writeWindowUpdate_static_extension) @:using(stdgo._internal.net.http.Http_t_http2writewindowupdate_static_extension.T_http2writeWindowUpdate_static_extension) class T_http2writeWindowUpdate {
