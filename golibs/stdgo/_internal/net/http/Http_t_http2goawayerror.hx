...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2goawayerror_static_extension.T_http2GoAwayError_static_extension) @:using(stdgo._internal.net.http.Http_t_http2goawayerror_static_extension.T_http2GoAwayError_static_extension) class T_http2GoAwayError {
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "lastStreamID", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "errCode", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2errcodedott_http2errcode.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2errcodedotT_http2ErrCode }, optional : false }, { name : "debugData", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(string_kind) }, optional : false }])));
