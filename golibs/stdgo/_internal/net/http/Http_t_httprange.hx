...
@:structInit @:using(stdgo._internal.net.http.Http_t_httprange_static_extension.T_httpRange_static_extension) @:using(stdgo._internal.net.http.Http_t_httprange_static_extension.T_httpRange_static_extension) class T_httpRange {
