...
function _urlErrorOp(_method:stdgo.GoString):stdgo.GoString {
        //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L544"
        if (_method == ((stdgo.Go.str() : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L545"
            return ("Get" : stdgo.GoString);
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L547"
        {
            ...
            if (_ok) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L548"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L550"
