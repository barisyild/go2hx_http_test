...
@:interface typedef T_http2writeContext = stdgo.StructType & {
    ...
    **/
    @:interfacetypeffun
    public dynamic function headerEncoder():{ var _0 : stdgo.Ref<_internal.golangdotorg.x.net.http2.hpack.Hpack_encoder.Encoder>; var _1 : stdgo.Ref<stdgo._internal.bytes.Bytes_buffer.Buffer>; };
};
