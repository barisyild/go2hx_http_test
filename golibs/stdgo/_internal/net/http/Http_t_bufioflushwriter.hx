...
@:structInit @:using(stdgo._internal.net.http.Http_t_bufioflushwriter_static_extension.T_bufioFlushWriter_static_extension) @:using(stdgo._internal.net.http.Http_t_bufioflushwriter_static_extension.T_bufioFlushWriter_static_extension) class T_bufioFlushWriter {
