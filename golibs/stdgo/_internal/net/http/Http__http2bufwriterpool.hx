...
var _http2bufWriterPool : stdgo._internal.sync.Sync_pool.Pool = ({ new_ : function():stdgo.AnyInterface {
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L3574"
        return new stdgo.AnyInterface(stdgo.Go.asInterface(stdgo._internal.bufio.Bufio_newwritersize.newWriterSize((null : stdgo._internal.io.Io_writer.Writer), (4096 : stdgo.GoInt)), _internal.gotype.Gotype___type__stdgodot_internaldotbufiodotbufio_writerdotwriter.__type__stdgodot_internaldotbufiodotBufio_writerdotWriter), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotbufiodotbufio_writerdotwriter.__type__stdgodot_internaldotbufiodotBufio_writerdotWriter })));
