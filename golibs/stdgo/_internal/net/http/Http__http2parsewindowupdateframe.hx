...
function _http2parseWindowUpdateFrame(__12:stdgo.Ref<stdgo._internal.net.http.Http_t_http2framecache.T_http2frameCache>, _fh:stdgo._internal.net.http.Http_t_http2frameheader.T_http2FrameHeader, _countError:stdgo.GoString -> Void, _p:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo._internal.net.http.Http_t_http2frame.T_http2Frame; var _1 : stdgo.Error; } {
        ...
        var _inc = @:assignType (stdgo._internal.encoding.binary.Binary_bigendian.bigEndian.uint32((_p.__slice__(0, (4 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) & (2147483647u32 : stdgo.GoUInt32) : stdgo.GoUInt32);
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L2359"
        if (_inc == ((0u32 : stdgo.GoUInt32))) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L2366"
            if (_fh.streamID == ((0u32 : stdgo.GoUInt32))) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L2367"
                _countError(("frame_windowupdate_zero_inc_conn" : stdgo.GoString));
                //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L2368"
                return { _0 : (null : stdgo._internal.net.http.Http_t_http2frame.T_http2Frame), _1 : stdgo.Go.asInterface(((1u32 : stdgo._internal.net.http.Http_t_http2errcode.T_http2ErrCode) : stdgo._internal.net.http.Http_t_http2connectionerror.T_http2ConnectionError), _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2connectionerrordott_http2connectionerror.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2connectionerrordotT_http2ConnectionError) };
            };
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L2370"
            _countError(("frame_windowupdate_zero_inc_stream" : stdgo.GoString));
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L2371"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L2373"
        return { _0 : stdgo.Go.asInterface((stdgo.Go.setRef(({ _http2FrameHeader : _fh?.__copy__(), increment : _inc } : stdgo._internal.net.http.Http_t_http2windowupdateframe.T_http2WindowUpdateFrame), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2windowupdateframedott_http2windowupdateframe.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2windowupdateframedotT_http2WindowUpdateFrame })) : stdgo.Ref<stdgo._internal.net.http.Http_t_http2windowupdateframe.T_http2WindowUpdateFrame>), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2windowupdateframedott_http2windowupdateframe.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2windowupdateframedotT_http2WindowUpdateFrame })), _1 : (null : stdgo.Error) };
    }
