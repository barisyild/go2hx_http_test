...
@:structInit @:using(stdgo._internal.net.http.Http_t_iofs_static_extension.T_ioFS_static_extension) @:using(stdgo._internal.net.http.Http_t_iofs_static_extension.T_ioFS_static_extension) class T_ioFS {
