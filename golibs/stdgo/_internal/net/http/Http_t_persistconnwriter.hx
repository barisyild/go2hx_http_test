...
@:structInit @:using(stdgo._internal.net.http.Http_t_persistconnwriter_static_extension.T_persistConnWriter_static_extension) @:using(stdgo._internal.net.http.Http_t_persistconnwriter_static_extension.T_persistConnWriter_static_extension) class T_persistConnWriter {
