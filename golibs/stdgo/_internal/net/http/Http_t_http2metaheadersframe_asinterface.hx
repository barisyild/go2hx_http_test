...
class T_http2MetaHeadersFrame_asInterface {
    ...
    @:keep
    public dynamic function pseudoFields():stdgo.Slice<_internal.golangdotorg.x.net.http2.hpack.Hpack_headerfield.HeaderField> return @:_0 __self__.value.pseudoFields();
    @:keep
    public dynamic function regularFields():stdgo.Slice<_internal.golangdotorg.x.net.http2.hpack.Hpack_headerfield.HeaderField> return @:_0 __self__.value.regularFields();
    @:keep
