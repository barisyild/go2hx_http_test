...
@:structInit @:using(stdgo._internal.net.http.Http_t_readresult_static_extension.T_readResult_static_extension) @:using(stdgo._internal.net.http.Http_t_readresult_static_extension.T_readResult_static_extension) class T_readResult {
    @:optional
