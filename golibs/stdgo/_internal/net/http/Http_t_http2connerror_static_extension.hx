...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2connError_asInterface) class T_http2connError_static_extension {
    ...
    static public function error( _e:stdgo._internal.net.http.Http_t_http2connerror.T_http2connError):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L1274"
        return stdgo._internal.fmt.Fmt_sprintf.sprintf(("http2: connection error: %v: %v" : stdgo.GoString), new stdgo.AnyInterface(stdgo.Go.asInterface(_e.code, _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2errcodedott_http2errcode.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2errcodedotT_http2ErrCode), new stdgo._internal.internal.reflect.Reflect._Type(_internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2errcodedott_http2errcode.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2errcodedotT_http2ErrCode)), new stdgo.AnyInterface(_e.reason, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(string_kind))))?.__copy__();
    }
}
