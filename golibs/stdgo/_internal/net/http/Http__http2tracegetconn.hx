...
function _http2traceGetConn(_req:stdgo.Ref<stdgo._internal.net.http.Http_request.Request>, _hostPort:stdgo.GoString):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L10218"
        if ((({
            final value = _trace;
            (value == null || (value : Dynamic).__nil__);
        }) || ((@:checkr _trace ?? throw stdgo.Error._nullPointerDereference.__underlying__()).getConn == null) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L10219"
            return;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L10221"
        (@:checkr _trace ?? throw stdgo.Error._nullPointerDereference.__underlying__()).getConn(_hostPort?.__copy__());
    }
