...
@:structInit @:using(stdgo._internal.net.http.Http_t_timeouthandler_static_extension.T_timeoutHandler_static_extension) @:using(stdgo._internal.net.http.Http_t_timeouthandler_static_extension.T_timeoutHandler_static_extension) class T_timeoutHandler {
