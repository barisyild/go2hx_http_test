...
function _http2authorityAddr(_scheme:stdgo.GoString, _authority:stdgo.GoString):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L7604"
        if (_err != null) {
            _host = _authority?.__copy__();
            _port = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L7608"
        if (_port == ((stdgo.Go.str() : stdgo.GoString))) {
            _port = ("443" : stdgo.GoString);
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L7610"
            if (_scheme == (("http" : stdgo.GoString))) {
                _port = ("80" : stdgo.GoString);
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L7614"
        {
            var __tmp__ = _internal.golangdotorg.x.net.idna.Idna_toascii.toASCII(_host?.__copy__()), _a:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err == null) {
                _host = _a?.__copy__();
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L7618"
        if ((stdgo._internal.strings.Strings_hasprefix.hasPrefix(_host?.__copy__(), ("[" : stdgo.GoString)) && stdgo._internal.strings.Strings_hassuffix.hasSuffix(_host?.__copy__(), ("]" : stdgo.GoString)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L7619"
            return _addr = ((_host + (":" : stdgo.GoString)?.__copy__() : stdgo.GoString) + _port?.__copy__() : stdgo.GoString)?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L7621"
