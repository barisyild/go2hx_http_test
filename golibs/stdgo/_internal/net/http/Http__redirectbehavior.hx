...
function _redirectBehavior(_reqMethod:stdgo.GoString, _resp:stdgo.Ref<stdgo._internal.net.http.Http_response.Response>, _ireq:stdgo.Ref<stdgo._internal.net.http.Http_request.Request>):{ var _0 : stdgo.GoString; var _1 : Bool; var _2 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L512"
        {
            final __value__ = (@:checkr _resp ?? throw stdgo.Error._nullPointerDereference.__underlying__()).statusCode;
            if (__value__ == ((301 : stdgo.GoInt)) || __value__ == ((302 : stdgo.GoInt)) || __value__ == ((303 : stdgo.GoInt))) {
                _redirectMethod = _reqMethod?.__copy__();
                _shouldRedirect = true;
                _includeBody = false;
                //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L522"
                ...
                _shouldRedirect = true;
                _includeBody = true;
                //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L530"
                if ((((@:checkr _ireq ?? throw stdgo.Error._nullPointerDereference.__underlying__()).getBody == null) && (_ireq._outgoingLength() != (0i64 : stdgo.GoInt64)) : Bool)) {
                    _shouldRedirect = false;
                };
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L538"
        return {
            @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : Bool; var _2 : Bool; } = { _0 : _redirectMethod?.__copy__(), _1 : _shouldRedirect, _2 : _includeBody };
