...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2clientconnreadloop_static_extension.T_http2clientConnReadLoop_static_extension) @:using(stdgo._internal.net.http.Http_t_http2clientconnreadloop_static_extension.T_http2clientConnReadLoop_static_extension) class T_http2clientConnReadLoop {
    @:optional
