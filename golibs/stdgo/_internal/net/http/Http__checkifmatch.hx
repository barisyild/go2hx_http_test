...
function _checkIfMatch(_w:stdgo._internal.net.http.Http_responsewriter.ResponseWriter, _r:stdgo.Ref<stdgo._internal.net.http.Http_request.Request>):stdgo._internal.net.http.Http_t_condresult.T_condResult {
        var _im = @:assignType ((@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__()).header.get(("If-Match" : stdgo.GoString))?.__copy__() : stdgo.GoString);
        //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L409"
        if (_im == ((stdgo.Go.str() : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L410"
            return (0 : stdgo._internal.net.http.Http_t_condresult.T_condResult);
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L412"
        while (true) {
            _im = stdgo._internal.net.textproto.Textproto_trimstring.trimString(_im?.__copy__())?.__copy__();
            //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L414"
            if ((_im.length) == ((0 : stdgo.GoInt))) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L415"
                break;
            };
            //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L417"
            if (_im[(0 : stdgo.GoInt)] == ((44 : stdgo.GoUInt8))) {
                _im = (_im.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L419"
                continue;
            };
            //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L421"
            if (_im[(0 : stdgo.GoInt)] == ((42 : stdgo.GoUInt8))) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L422"
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L425"
            if (_etag == ((stdgo.Go.str() : stdgo.GoString))) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L426"
                break;
            };
            //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L428"
            if (stdgo._internal.net.http.Http__etagstrongmatch._etagStrongMatch(_etag?.__copy__(), _w.header()._get(("Etag" : stdgo.GoString))?.__copy__())) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L429"
                return (1 : stdgo._internal.net.http.Http_t_condresult.T_condResult);
            };
            _im = _remain?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/fs.go#L434"
