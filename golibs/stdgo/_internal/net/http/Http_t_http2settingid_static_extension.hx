...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2SettingID_asInterface) class T_http2SettingID_static_extension {
    ...
    static public function string( _s:stdgo._internal.net.http.Http_t_http2settingid.T_http2SettingID):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L3478"
        {
            ...
            if (_ok) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L3479"
                return _v?.__copy__();
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L3481"
        return stdgo._internal.fmt.Fmt_sprintf.sprintf(("UNKNOWN_SETTING_%d" : stdgo.GoString), new stdgo.AnyInterface((_s : stdgo.GoUInt16), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(uint16_kind))))?.__copy__();
    }
}
