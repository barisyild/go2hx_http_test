...
@:keep @:allow(stdgo._internal.net.http.Http.T_arrayReader_asInterface) class T_arrayReader_static_extension {
    ...
    static public function close( _r:stdgo.Ref<stdgo._internal.net.http.Http_t_arrayreader.T_arrayReader>):stdgo.Error {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L356"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L359"
    ...
    static public function read( _r:stdgo.Ref<stdgo._internal.net.http.Http_t_arrayreader.T_arrayReader>, _p:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        try {
            //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L312"
            if ((@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__())._err != null) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L313"
                return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L315"
            if (!(@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__())._read) {
                (@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__())._read = true;
                ...
                var _success = @:assignType (stdgo._internal.syscall.js.Js_funcof.funcOf(function(_this:stdgo._internal.syscall.js.Js_value.Value, _args:stdgo.Slice<stdgo._internal.syscall.js.Js_value.Value>):stdgo.AnyInterface {
                    ...
                    //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L325"
                    stdgo._internal.syscall.js.Js_copybytestogo.copyBytesToGo(_value, _uint8arrayWrapper?.__copy__());
                    //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L326"
                    _bCh.__send__(_value);
                    //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L327"
                ...
                var _failure = @:assignType (stdgo._internal.syscall.js.Js_funcof.funcOf(function(_this:stdgo._internal.syscall.js.Js_value.Value, _args:stdgo.Slice<stdgo._internal.syscall.js.Js_value.Value>):stdgo.AnyInterface {
                    //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L335"
                    ...
                    //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L336"
                    return (null : stdgo.AnyInterface);
                })?.__copy__() : stdgo._internal.syscall.js.Js_func.Func);
                {
                    ...
                    while (__select__) {
                        if ({
                            ...
                            __select__ = false;
                            {
                                ...
                                {
                                    //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L344"
                                    {
...
__c__1.__reset__();
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L347"
            if (((@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__())._pending.length) == ((0 : stdgo.GoInt))) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L348"
                {
                    final __ret__:{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } = {
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/http/roundtrip_js.go#L352"
            {
                final __ret__:{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } = {
