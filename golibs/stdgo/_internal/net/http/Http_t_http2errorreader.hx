...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2errorreader_static_extension.T_http2errorReader_static_extension) @:using(stdgo._internal.net.http.Http_t_http2errorreader_static_extension.T_http2errorReader_static_extension) class T_http2errorReader {
