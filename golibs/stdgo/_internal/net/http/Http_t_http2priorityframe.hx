...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2priorityframe_static_extension.T_http2PriorityFrame_static_extension) @:using(stdgo._internal.net.http.Http_t_http2priorityframe_static_extension.T_http2PriorityFrame_static_extension) class T_http2PriorityFrame {
    @:embedded
    ...
    @:embeddededffieldsffun
    @:embeddededffieldsffun
    public function get_isZero():() -> Bool return @:check31 (this._http2PriorityParam ?? throw stdgo.Error._nullPointerDereference.__underlying__()).isZero;
