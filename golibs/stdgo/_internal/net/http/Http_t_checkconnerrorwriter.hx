...
@:structInit @:using(stdgo._internal.net.http.Http_t_checkconnerrorwriter_static_extension.T_checkConnErrorWriter_static_extension) @:using(stdgo._internal.net.http.Http_t_checkconnerrorwriter_static_extension.T_checkConnErrorWriter_static_extension) class T_checkConnErrorWriter {
