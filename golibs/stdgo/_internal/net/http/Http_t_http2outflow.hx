...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2outflow_static_extension.T_http2outflow_static_extension) @:using(stdgo._internal.net.http.Http_t_http2outflow_static_extension.T_http2outflow_static_extension) class T_http2outflow {
    @:optional
    ...
    public function new(?__0:stdgo._internal.net.http.Http_t_http2incomparable.T_http2incomparable, ?_n:stdgo.GoInt32, ?_conn:stdgo.Ref<stdgo._internal.net.http.Http_t_http2outflow.T_http2outflow>) {
        if (__0 != null) this.__0 = __0;
        if (_n != null) this._n = _n;
        if (_conn != null) this._conn = _conn;
    }
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "__0", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2incomparabledott_http2incomparable.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2incomparabledotT_http2incomparable }, optional : false }, { name : "_n", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int32_kind) }, optional : false }, { name : "_conn", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdothttpdothttp_t_http2outflowdott_http2outflow.__type__stdgodot_internaldotnetdothttpdotHttp_t_http2outflowdotT_http2outflow }) }, optional : false }])));
    public function __copy__() {
        return new T_http2outflow(__0, _n, _conn);
    }
}
