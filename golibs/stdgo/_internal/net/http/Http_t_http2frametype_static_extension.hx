...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2FrameType_asInterface) class T_http2FrameType_static_extension {
    ...
    static public function string( _t:stdgo._internal.net.http.Http_t_http2frametype.T_http2FrameType):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L1454"
        {
            ...
            if (_ok) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L1455"
                return _s?.__copy__();
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L1457"
        return stdgo._internal.fmt.Fmt_sprintf.sprintf(("UNKNOWN_FRAME_TYPE_%d" : stdgo.GoString), new stdgo.AnyInterface((_t : stdgo.GoUInt8), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(uint8_kind))))?.__copy__();
    }
}
