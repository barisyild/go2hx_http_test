...
@:structInit @:using(stdgo._internal.net.http.Http_t_iofile_static_extension.T_ioFile_static_extension) @:using(stdgo._internal.net.http.Http_t_iofile_static_extension.T_ioFile_static_extension) class T_ioFile {
