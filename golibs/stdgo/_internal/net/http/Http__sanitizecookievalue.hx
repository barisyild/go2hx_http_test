...
function _sanitizeCookieValue(_v:stdgo.GoString):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L405"
        if ((_v.length) == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L406"
            return _v?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L408"
        if (stdgo._internal.strings.Strings_containsany.containsAny(_v?.__copy__(), (" ," : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L409"
            return ((("\"" : stdgo.GoString) + _v?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L411"
        return _v?.__copy__();
    }
