...
@:structInit @:using(stdgo._internal.net.http.Http_t_httperror_static_extension.T_httpError_static_extension) @:using(stdgo._internal.net.http.Http_t_httperror_static_extension.T_httpError_static_extension) class T_httpError {
