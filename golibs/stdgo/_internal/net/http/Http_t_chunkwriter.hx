...
@:structInit @:using(stdgo._internal.net.http.Http_t_chunkwriter_static_extension.T_chunkWriter_static_extension) @:using(stdgo._internal.net.http.Http_t_chunkwriter_static_extension.T_chunkWriter_static_extension) class T_chunkWriter {
