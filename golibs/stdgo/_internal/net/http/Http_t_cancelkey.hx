...
@:structInit @:using(stdgo._internal.net.http.Http_t_cancelkey_static_extension.T_cancelKey_static_extension) @:using(stdgo._internal.net.http.Http_t_cancelkey_static_extension.T_cancelKey_static_extension) class T_cancelKey {
