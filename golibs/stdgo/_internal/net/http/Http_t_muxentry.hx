...
@:structInit @:using(stdgo._internal.net.http.Http_t_muxentry_static_extension.T_muxEntry_static_extension) @:using(stdgo._internal.net.http.Http_t_muxentry_static_extension.T_muxEntry_static_extension) class T_muxEntry {
