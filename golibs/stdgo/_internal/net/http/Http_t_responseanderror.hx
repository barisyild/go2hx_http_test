...
@:structInit @:using(stdgo._internal.net.http.Http_t_responseanderror_static_extension.T_responseAndError_static_extension) @:using(stdgo._internal.net.http.Http_t_responseanderror_static_extension.T_responseAndError_static_extension) class T_responseAndError {
    @:optional
    ...
    public function new(?__0:stdgo._internal.net.http.Http_t_incomparable.T_incomparable, ?_res:stdgo.Ref<stdgo._internal.net.http.Http_response.Response>, ?_err:stdgo.Error) {
    ...
    public function __copy__() {
        return new T_responseAndError(__0, _res, _err);
    }
}
