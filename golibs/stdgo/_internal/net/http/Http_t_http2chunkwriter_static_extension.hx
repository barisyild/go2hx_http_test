...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2chunkWriter_asInterface) class T_http2chunkWriter_static_extension {
    ...
    static public function write( _cw:stdgo._internal.net.http.Http_t_http2chunkwriter.T_http2chunkWriter, _p:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L6390"
        if (({
            final __t__ = _err;
            if (__t__ == null) {
            ...
            final __t__ = stdgo._internal.net.http.Http__http2errstreamclosed._http2errStreamClosed;
            if (__t__ == null) {
                new stdgo.AnyInterface(null, new stdgo._internal.internal.reflect.Reflect._Type(_internal.gotype.Gotype___type__stdgodoterror.__type__stdgodotError)).__setNil__();
            } else {
                new stdgo.AnyInterface(__t__, __t__.__underlying__().type);
            ...
            _err = (@:checkr (@:checkr _cw._rws ?? throw stdgo.Error._nullPointerDereference.__underlying__())._stream ?? throw stdgo.Error._nullPointerDereference.__underlying__())._closeErr;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L6395"
        return {
