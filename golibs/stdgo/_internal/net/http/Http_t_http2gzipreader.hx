...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2gzipreader_static_extension.T_http2gzipReader_static_extension) @:using(stdgo._internal.net.http.Http_t_http2gzipreader_static_extension.T_http2gzipReader_static_extension) class T_http2gzipReader {
    @:optional
