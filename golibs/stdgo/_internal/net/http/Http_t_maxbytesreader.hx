...
@:structInit @:using(stdgo._internal.net.http.Http_t_maxbytesreader_static_extension.T_maxBytesReader_static_extension) @:using(stdgo._internal.net.http.Http_t_maxbytesreader_static_extension.T_maxBytesReader_static_extension) class T_maxBytesReader {
