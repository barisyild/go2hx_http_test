...
@:structInit @:using(stdgo._internal.net.http.Http_t_initalpnrequest_static_extension.T_initALPNRequest_static_extension) @:using(stdgo._internal.net.http.Http_t_initalpnrequest_static_extension.T_initALPNRequest_static_extension) class T_initALPNRequest {
