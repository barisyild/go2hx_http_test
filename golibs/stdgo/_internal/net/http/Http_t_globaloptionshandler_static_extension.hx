...
@:keep @:allow(stdgo._internal.net.http.Http.T_globalOptionsHandler_asInterface) class T_globalOptionsHandler_static_extension {
    ...
    static public function serveHTTP( _:stdgo._internal.net.http.Http_t_globaloptionshandler.T_globalOptionsHandler, _w:stdgo._internal.net.http.Http_responsewriter.ResponseWriter, _r:stdgo.Ref<stdgo._internal.net.http.Http_request.Request>):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L3508"
        _w.header().set(("Content-Length" : stdgo.GoString), ("0" : stdgo.GoString));
        //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L3509"
        if ((@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__()).contentLength != ((0i64 : stdgo.GoInt64))) {
            var _mb = @:assignType (stdgo._internal.net.http.Http_maxbytesreader.maxBytesReader(_w, (@:checkr _r ?? throw stdgo.Error._nullPointerDereference.__underlying__()).body, (4096i64 : stdgo.GoInt64)) : stdgo._internal.io.Io_readcloser.ReadCloser);
            //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L3516"
