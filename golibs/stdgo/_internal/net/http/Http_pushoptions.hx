...
@:structInit @:using(stdgo._internal.net.http.Http_pushoptions_static_extension.PushOptions_static_extension) @:using(stdgo._internal.net.http.Http_pushoptions_static_extension.PushOptions_static_extension) class PushOptions {
