...
function _envProxyFunc():stdgo.Ref<stdgo._internal.net.url.Url_url.URL> -> { var _0 : stdgo.Ref<stdgo._internal.net.url.Url_url.URL>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/net/http/transport.go#L835"
        stdgo._internal.net.http.Http__envproxyonce._envProxyOnce.do_(function():Void {
            stdgo._internal.net.http.Http__envproxyfuncvalue._envProxyFuncValue = _internal.golangdotorg.x.net.http.httpproxy.Httpproxy_fromenvironment.fromEnvironment().proxyFunc();
        });
        //"file:///Users/o/.go/go1.21.3/src/net/http/transport.go#L838"
