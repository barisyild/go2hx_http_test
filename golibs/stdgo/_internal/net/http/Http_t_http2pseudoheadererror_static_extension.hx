...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2pseudoHeaderError_asInterface) class T_http2pseudoHeaderError_static_extension {
    ...
    static public function error( _e:stdgo._internal.net.http.Http_t_http2pseudoheadererror.T_http2pseudoHeaderError):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L1280"
        return stdgo._internal.fmt.Fmt_sprintf.sprintf(("invalid pseudo-header %q" : stdgo.GoString), new stdgo.AnyInterface((_e : stdgo.GoString), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(string_kind))))?.__copy__();
    }
}
