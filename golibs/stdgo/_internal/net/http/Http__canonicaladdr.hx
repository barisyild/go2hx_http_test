...
function _canonicalAddr(_url:stdgo.Ref<stdgo._internal.net.url.Url_url.URL>):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/transport.go#L2771"
        if (_port == ((stdgo.Go.str() : stdgo.GoString))) {
            _port = (stdgo._internal.net.http.Http__portmap._portMap[(@:checkr _url ?? throw stdgo.Error._nullPointerDereference.__underlying__()).scheme] ?? ("" : stdgo.GoString))?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/transport.go#L2774"
