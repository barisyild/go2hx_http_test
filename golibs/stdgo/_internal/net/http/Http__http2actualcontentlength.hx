...
function _http2actualContentLength(_req:stdgo.Ref<stdgo._internal.net.http.Http_request.Request>):stdgo.GoInt64 {
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L8280"
        if ((((@:checkr _req ?? throw stdgo.Error._nullPointerDereference.__underlying__()).body == null) || (({
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L8281"
            return (0i64 : stdgo.GoInt64);
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L8283"
        if ((@:checkr _req ?? throw stdgo.Error._nullPointerDereference.__underlying__()).contentLength != ((0i64 : stdgo.GoInt64))) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L8284"
            return (@:checkr _req ?? throw stdgo.Error._nullPointerDereference.__underlying__()).contentLength;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L8286"
