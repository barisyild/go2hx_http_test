...
function postForm(_url:stdgo.GoString, _data:stdgo._internal.net.url.Url_values.Values):{ var _0 : stdgo.Ref<stdgo._internal.net.http.Http_response.Response>; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L877"
        return ({
            @:explicitConversion final __tmp__ = stdgo._internal.net.http.Http_defaultclient.defaultClient.postForm(_url?.__copy__(), _data);
