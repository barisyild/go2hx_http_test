...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2addconncall_static_extension.T_http2addConnCall_static_extension) @:using(stdgo._internal.net.http.Http_t_http2addconncall_static_extension.T_http2addConnCall_static_extension) class T_http2addConnCall {
    @:optional
