...
function _http2cloneHeader(_h:stdgo._internal.net.http.Http_header.Header):stdgo._internal.net.http.Http_header.Header {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L6769"
        if (_h != null) for (_k => _vv in _h) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L6771"
            _vv2.__copyTo__(_vv);
            _h2[_k] = _vv2;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L6774"
        return _h2;
    }
