...
function _cloneOrMakeHeader(_hdr:stdgo._internal.net.http.Http_header.Header):stdgo._internal.net.http.Http_header.Header {
        var _clone = @:assignType (_hdr.clone() : stdgo._internal.net.http.Http_header.Header);
        //"file:///Users/o/.go/go1.21.3/src/net/http/clone.go#L70"
        if (_clone == null) {
            _clone = (({
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/clone.go#L73"
        return _clone;
    }
