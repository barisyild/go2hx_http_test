...
function post(_url:stdgo.GoString, _contentType:stdgo.GoString, _body:stdgo._internal.io.Io_reader.Reader):{ var _0 : stdgo.Ref<stdgo._internal.net.http.Http_response.Response>; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/client.go#L834"
        return ({
            @:explicitConversion final __tmp__ = stdgo._internal.net.http.Http_defaultclient.defaultClient.post(_url?.__copy__(), _contentType?.__copy__(), _body);
