...
@:structInit @:using(stdgo._internal.net.http.Http_t_errorreader_static_extension.T_errorReader_static_extension) @:using(stdgo._internal.net.http.Http_t_errorreader_static_extension.T_errorReader_static_extension) class T_errorReader {
