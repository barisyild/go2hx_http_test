...
function _validCookieDomain(_v:stdgo.GoString):Bool {
        //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L314"
        if (stdgo._internal.net.http.Http__iscookiedomainname._isCookieDomainName(_v?.__copy__())) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L315"
            return true;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L317"
        if (((stdgo._internal.net.Net_parseip.parseIP(_v?.__copy__()) != null) && !stdgo._internal.strings.Strings_contains.contains(_v?.__copy__(), (":" : stdgo.GoString)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L318"
            return true;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/cookie.go#L320"
        return false;
    }
