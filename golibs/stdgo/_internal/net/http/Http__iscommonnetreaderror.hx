...
function _isCommonNetReadError(_err:stdgo.Error):Bool {
        //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L1845"
        if (({
            final __t__ = _err;
            if (__t__ == null) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L1846"
            return true;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L1848"
        {
            ...
            if ((_ok && _neterr.timeout() : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L1849"
                return true;
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L1851"
        {
            var __tmp__ = @:castTranslate try {
                { _0 : (stdgo.Go.typeAssert(({
                    final __t__ = _err;
            ...
            if ((_ok && ((@:checkr _oe ?? throw stdgo.Error._nullPointerDereference.__underlying__()).op == ("read" : stdgo.GoString)) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L1852"
                return true;
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/http/server.go#L1854"
        return false;
    }
