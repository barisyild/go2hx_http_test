...
function _parseHexUint(_v:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoUInt64; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/internal/chunked.go#L244"
        if (_v != null) for (_i => _b in _v) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/internal/chunked.go#L245"
            if ((((48 : stdgo.GoUInt8) <= _b : Bool) && (_b <= (57 : stdgo.GoUInt8) : Bool) : Bool)) {
                ...
                //"file:///Users/o/.go/go1.21.3/src/net/http/internal/chunked.go#L253"
                return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/http/internal/chunked.go#L255"
            if (_i == ((16 : stdgo.GoInt))) {
                //"file:///Users/o/.go/go1.21.3/src/net/http/internal/chunked.go#L256"
                return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/internal/chunked.go#L261"
