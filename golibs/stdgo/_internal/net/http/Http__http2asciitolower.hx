...
function _http2asciiToLower(_s:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L96"
        if (!stdgo._internal.net.http.Http__http2isasciiprint._http2isASCIIPrint(_s?.__copy__())) {
            //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L97"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/http/h2_bundle.go#L99"
        return {
