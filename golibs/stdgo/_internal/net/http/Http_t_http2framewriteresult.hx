...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2framewriteresult_static_extension.T_http2frameWriteResult_static_extension) @:using(stdgo._internal.net.http.Http_t_http2framewriteresult_static_extension.T_http2frameWriteResult_static_extension) class T_http2frameWriteResult {
    @:optional
