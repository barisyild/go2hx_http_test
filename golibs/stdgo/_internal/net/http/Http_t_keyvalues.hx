...
@:structInit @:using(stdgo._internal.net.http.Http_t_keyvalues_static_extension.T_keyValues_static_extension) @:using(stdgo._internal.net.http.Http_t_keyvalues_static_extension.T_keyValues_static_extension) class T_keyValues {
