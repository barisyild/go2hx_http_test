...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2unknownframe_static_extension.T_http2UnknownFrame_static_extension) @:using(stdgo._internal.net.http.Http_t_http2unknownframe_static_extension.T_http2UnknownFrame_static_extension) class T_http2UnknownFrame {
    @:embedded
