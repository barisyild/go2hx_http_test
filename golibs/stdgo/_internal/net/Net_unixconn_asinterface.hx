...
class UnixConn_asInterface {
    @:keep
    public dynamic function _writeMsg(_b:stdgo.Slice<stdgo.GoUInt8>, _oob:stdgo.Slice<stdgo.GoUInt8>, _addr:stdgo.Ref<stdgo._internal.net.Net_unixaddr.UnixAddr>):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } return @:_0 __self__.value._writeMsg(_b, _oob, _addr);
    @:keep
    public dynamic function _writeTo(_b:stdgo.Slice<stdgo.GoUInt8>, _addr:stdgo.Ref<stdgo._internal.net.Net_unixaddr.UnixAddr>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } return @:_0 __self__.value._writeTo(_b, _addr);
    @:keep
    public dynamic function _readMsg(_b:stdgo.Slice<stdgo.GoUInt8>, _oob:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : stdgo.GoInt; var _3 : stdgo.Ref<stdgo._internal.net.Net_unixaddr.UnixAddr>; var _4 : stdgo.Error; } return @:_0 __self__.value._readMsg(_b, _oob);
    @:keep
    public dynamic function _readFrom(_b:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Ref<stdgo._internal.net.Net_unixaddr.UnixAddr>; var _2 : stdgo.Error; } return @:_0 __self__.value._readFrom(_b);
    @:keep
