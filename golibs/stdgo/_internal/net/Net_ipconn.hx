...
@:structInit @:using(stdgo._internal.net.Net_ipconn_static_extension.IPConn_static_extension) @:using(stdgo._internal.net.Net_ipconn_static_extension.IPConn_static_extension) class IPConn {
    @:embedded
