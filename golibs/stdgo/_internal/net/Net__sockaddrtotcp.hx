...
function _sockaddrToTCP(_sa:stdgo._internal.syscall.Syscall_sockaddr.Sockaddr):stdgo._internal.net.Net_addr.Addr {
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock_posix.go#L17"
        {
            final __type__ = _sa;
            if (stdgo.Go.typeEquals(__type__, stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotsyscalldotsyscall_sockaddrinet4dotsockaddrinet4.__type__stdgodot_internaldotsyscalldotSyscall_sockaddrinet4dotSockaddrInet4 }))) {
                ...
                //"file:///Users/o/.go/go1.21.3/src/net/tcpsock_posix.go#L19"
                return stdgo.Go.asInterface((stdgo.Go.setRef(({ iP : ((@:checkr _sa ?? throw stdgo.Error._nullPointerDereference.__underlying__()).addr.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), port : (@:checkr _sa ?? throw stdgo.Error._nullPointerDereference.__underlying__()).port } : stdgo._internal.net.Net_tcpaddr.TCPAddr), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_tcpaddrdottcpaddr.__type__stdgodot_internaldotnetdotNet_tcpaddrdotTCPAddr })) : stdgo.Ref<stdgo._internal.net.Net_tcpaddr.TCPAddr>), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_tcpaddrdottcpaddr.__type__stdgodot_internaldotnetdotNet_tcpaddrdotTCPAddr }));
                ...
                //"file:///Users/o/.go/go1.21.3/src/net/tcpsock_posix.go#L21"
                return stdgo.Go.asInterface((stdgo.Go.setRef(({ iP : ((@:checkr _sa ?? throw stdgo.Error._nullPointerDereference.__underlying__()).addr.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), port : (@:checkr _sa ?? throw stdgo.Error._nullPointerDereference.__underlying__()).port, zone : stdgo._internal.net.Net__zonecache._zoneCache._name(((@:checkr _sa ?? throw stdgo.Error._nullPointerDereference.__underlying__()).zoneId : stdgo.GoInt))?.__copy__() } : stdgo._internal.net.Net_tcpaddr.TCPAddr), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_tcpaddrdottcpaddr.__type__stdgodot_internaldotnetdotNet_tcpaddrdotTCPAddr })) : stdgo.Ref<stdgo._internal.net.Net_tcpaddr.TCPAddr>), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_tcpaddrdottcpaddr.__type__stdgodot_internaldotnetdotNet_tcpaddrdotTCPAddr }));
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock_posix.go#L23"
