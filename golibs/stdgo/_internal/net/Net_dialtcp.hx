...
function dialTCP(_network:stdgo.GoString, _laddr:stdgo.Ref<stdgo._internal.net.Net_tcpaddr.TCPAddr>, _raddr:stdgo.Ref<stdgo._internal.net.Net_tcpaddr.TCPAddr>):{ var _0 : stdgo.Ref<stdgo._internal.net.Net_tcpconn.TCPConn>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L261"
        {
            final __value__ = _network;
            if (__value__ == (("tcp" : stdgo.GoString)) || __value__ == (("tcp4" : stdgo.GoString)) || __value__ == (("tcp6" : stdgo.GoString))) {} else {
                //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L264"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L266"
        if (({
            final value = _raddr;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L267"
        ...
        var __tmp__ = _sd._dialTCP(stdgo._internal.context.Context_background.background(), _laddr, _raddr), _c:stdgo.Ref<stdgo._internal.net.Net_tcpconn.TCPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L271"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L272"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L274"
