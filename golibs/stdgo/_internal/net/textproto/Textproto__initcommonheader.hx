...
function _initCommonHeader():Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/textproto/reader.go#L779"
        if ((new stdgo.Slice<stdgo.GoString>(39, 39, ...[
...
("X-Powered-By" : stdgo.GoString)]).__setString__() : stdgo.Slice<stdgo.GoString>) != null) for (__0 => _v in (new stdgo.Slice<stdgo.GoString>(39, 39, ...[
("Accept" : stdgo.GoString),
("Accept-Charset" : stdgo.GoString),
("Accept-Encoding" : stdgo.GoString),
("Accept-Language" : stdgo.GoString),
