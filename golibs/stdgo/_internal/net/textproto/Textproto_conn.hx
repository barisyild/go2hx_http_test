...
@:structInit @:using(stdgo._internal.net.textproto.Textproto_conn_static_extension.Conn_static_extension) @:using(stdgo._internal.net.textproto.Textproto_conn_static_extension.Conn_static_extension) class Conn {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "reader", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdottextprotodottextproto_readerdotreader.__type__stdgodot_internaldotnetdottextprotodotTextproto_readerdotReader }, optional : false }, { name : "writer", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdottextprotodottextproto_writerdotwriter.__type__stdgodot_internaldotnetdottextprotodotTextproto_writerdotWriter }, optional : false }, { name : "pipeline", embedded : true, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdottextprotodottextproto_pipelinedotpipeline.__type__stdgodot_internaldotnetdottextprotodotTextproto_pipelinedotPipeline }, optional : false }, { name : "_conn", embedded : false, tag : "", type : { get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotiodotio_readwritecloserdotreadwritecloser.__type__stdgodot_internaldotiodotIo_readwritecloserdotReadWriteCloser }, optional : false }])));
