...
@:structInit @:using(stdgo._internal.net.Net_t__dialparallel___localname___dialresult_15967_static_extension.T__dialParallel___localname___dialResult_15967_static_extension) class T__dialParallel___localname___dialResult_15967 {
    @:embedded
    ...
    public function __copy__() {
        return new T__dialParallel___localname___dialResult_15967(conn, _error, _primary, _done);
    }
}
