...
function fileConn(_f:stdgo.Ref<stdgo._internal.os.Os_file.File>):{ var _0 : stdgo._internal.net.Net_conn.Conn; var _1 : stdgo.Error; } {
        var _c = (null : stdgo._internal.net.Net_conn.Conn), _err = (null : stdgo.Error);
        {
            var __tmp__ = stdgo._internal.net.Net__fileconn._fileConn(_f);
            _c = @:tmpset0 __tmp__._0;
            _err = @:tmpset0 __tmp__._1;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/file.go#L23"
        if (_err != null) {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/file.go#L26"
