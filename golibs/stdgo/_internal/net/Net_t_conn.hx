...
@:structInit @:using(stdgo._internal.net.Net_t_conn_static_extension.T_conn_static_extension) @:using(stdgo._internal.net.Net_t_conn_static_extension.T_conn_static_extension) class T_conn {
    public var _fd : stdgo.Ref<stdgo._internal.net.Net_t_netfd.T_netFD> = (null : stdgo.Ref<stdgo._internal.net.Net_t_netfd.T_netFD>);
    public var _ok = () -> true;
    public function new(?_fd:stdgo.Ref<stdgo._internal.net.Net_t_netfd.T_netFD>, ?_ok) {
