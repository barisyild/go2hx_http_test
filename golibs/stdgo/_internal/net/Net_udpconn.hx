...
@:structInit @:using(stdgo._internal.net.Net_udpconn_static_extension.UDPConn_static_extension) @:using(stdgo._internal.net.Net_udpconn_static_extension.UDPConn_static_extension) class UDPConn {
    @:embedded
