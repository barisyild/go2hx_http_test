...
@:structInit @:using(stdgo._internal.net.Net_ns_static_extension.NS_static_extension) @:using(stdgo._internal.net.Net_ns_static_extension.NS_static_extension) class NS {
