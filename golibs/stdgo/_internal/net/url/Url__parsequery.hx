...
function _parseQuery(_m:stdgo._internal.net.url.Url_values.Values, _query:stdgo.GoString):stdgo.Error {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L933"
        while (_query != ((stdgo.Go.str() : stdgo.GoString))) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L936"
            if (stdgo._internal.strings.Strings_contains.contains(_key?.__copy__(), (";" : stdgo.GoString))) {
                ...
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L938"
                continue;
            };
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L940"
            if (_key == ((stdgo.Go.str() : stdgo.GoString))) {
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L941"
                continue;
            };
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L945"
            if (_err1 != null) {
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L946"
                if (_err == null) {
                    _err = _err1;
                };
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L949"
                continue;
            };
            {
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L952"
            if (_err1 != null) {
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L953"
                if (_err == null) {
                    _err = _err1;
                };
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L956"
                continue;
            };
            _m[_key] = ((_m[_key] ?? (null : stdgo.Slice<stdgo.GoString>)).__append__(_value?.__copy__()) : stdgo.Slice<stdgo.GoString>);
        };
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L960"
        return _err;
    }
