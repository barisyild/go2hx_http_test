...
function _parseAuthority(_authority:stdgo.GoString):{ var _0 : stdgo.Ref<stdgo._internal.net.url.Url_userinfo.Userinfo>; var _1 : stdgo.GoString; var _2 : stdgo.Error; } {
        ...
        var _i = @:assignType (stdgo._internal.strings.Strings_lastindex.lastIndex(_authority?.__copy__(), ("@" : stdgo.GoString)) : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L581"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L586"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L587"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L589"
        if ((_i < (0 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L590"
            return {
        ...
        var _userinfo = @:assignType ((_authority.__slice__(0, _i) : stdgo.GoString)?.__copy__() : stdgo.GoString);
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L593"
        if (!stdgo._internal.net.url.Url__validuserinfo._validUserinfo(_userinfo?.__copy__())) {
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L594"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L596"
        if (!stdgo._internal.strings.Strings_contains.contains(_userinfo?.__copy__(), (":" : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L597"
            {
                {
                ...
                if (_err != null) {
                    //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L598"
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Ref<stdgo._internal.net.url.Url_userinfo.Userinfo>; var _1 : stdgo.GoString; var _2 : stdgo.Error; } = { _0 : null, _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : _err };
                        _user = __tmp__._0;
                        _host = __tmp__._1;
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L603"
            {
                {
                ...
                if (_err != null) {
                    //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L604"
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Ref<stdgo._internal.net.url.Url_userinfo.Userinfo>; var _1 : stdgo.GoString; var _2 : stdgo.Error; } = { _0 : null, _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : _err };
                        _user = __tmp__._0;
                        _host = __tmp__._1;
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L606"
            {
                {
                ...
                if (_err != null) {
                    //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L607"
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Ref<stdgo._internal.net.url.Url_userinfo.Userinfo>; var _1 : stdgo.GoString; var _2 : stdgo.Error; } = { _0 : null, _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : _err };
                        _user = __tmp__._0;
                        _host = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L611"
        return {
