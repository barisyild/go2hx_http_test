...
var _hexCount = __1, _spaceCount = __0;
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L287"
        {
            var _i = @:assignType (0 : stdgo.GoInt);
            while ((_i < (_s.length) : Bool)) {
                var _c = @:assignType (_s[(_i : stdgo.GoInt)] : stdgo.GoUInt8);
//"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L289"
                if (stdgo._internal.net.url.Url__shouldescape._shouldEscape(_c, _mode)) {
                    //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L290"
                    if (((_c == (32 : stdgo.GoUInt8)) && (_mode == (6 : stdgo._internal.net.url.Url_t_encoding.T_encoding)) : Bool)) {
                        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L291"
                        _spaceCount++;
                    } else {
                        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L293"
                        _hexCount++;
                    };
                };
                _i++;
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L298"
        if (((_spaceCount == (0 : stdgo.GoInt)) && (_hexCount == (0 : stdgo.GoInt)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L299"
            return _s?.__copy__();
        };
        ...
        var _required = @:assignType ((_s.length) + ((2 : stdgo.GoInt) * _hexCount : stdgo.GoInt) : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L306"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L312"
        if (_hexCount == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L313"
            _t.__copyTo__(_s);
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L314"
            {
                var _i = @:assignType (0 : stdgo.GoInt);
                while ((_i < (_s.length) : Bool)) {
                    //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L315"
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L319"
            return (_t : stdgo.GoString)?.__copy__();
        };
        var _j = @:assignType (0 : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L323"
        {
            var _i = @:assignType (0 : stdgo.GoInt);
            while ((_i < (_s.length) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L324"
                {
                    var _c = @:assignType (_s[(_i : stdgo.GoInt)] : stdgo.GoUInt8);
                    if (((_c == (32 : stdgo.GoUInt8)) && (_mode == (6 : stdgo._internal.net.url.Url_t_encoding.T_encoding)) : Bool)) {
                        _t[(_j : stdgo.GoInt)] = (43 : stdgo.GoUInt8);
                        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L327"
                        _j++;
                        ...
                        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L335"
                        _j++;
                    };
                };
                _i++;
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L338"
        return (_t : stdgo.GoString)?.__copy__();
    }
