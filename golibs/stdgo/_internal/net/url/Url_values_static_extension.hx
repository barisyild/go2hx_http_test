...
@:keep @:allow(stdgo._internal.net.url.Url.Values_asInterface) class Values_static_extension {
    ...
    static public function encode( _v:stdgo._internal.net.url.Url_values.Values):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L966"
        if (_v == null) {
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L967"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L971"
        if (_v != null) for (_k => _ in _v) {
            _keys = (_keys.__append__(_k?.__copy__()) : stdgo.Slice<stdgo.GoString>);
        };
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L974"
        stdgo._internal.sort.Sort_strings.strings(_keys);
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L975"
        if (_keys != null) for (__0 => _k in _keys) {
            var _vs = (_v[_k] ?? (null : stdgo.Slice<stdgo.GoString>));
            var _keyEscaped = @:assignType (stdgo._internal.net.url.Url_queryescape.queryEscape(_k?.__copy__())?.__copy__() : stdgo.GoString);
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L978"
            if (_vs != null) for (__1 => _v in _vs) {
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L979"
                if ((_buf.len() > (0 : stdgo.GoInt) : Bool)) {
                    //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L980"
                    _buf.writeByte((38 : stdgo.GoUInt8));
                };
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L982"
                _buf.writeString(_keyEscaped?.__copy__());
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L983"
                _buf.writeByte((61 : stdgo.GoUInt8));
                //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L984"
                _buf.writeString(stdgo._internal.net.url.Url_queryescape.queryEscape(_v?.__copy__())?.__copy__());
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L987"
    ...
    static public function has( _v:stdgo._internal.net.url.Url_values.Values, _key:stdgo.GoString):Bool {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L913"
        return _ok;
    }
    @:keep
    @:tdfield
    static public function del( _v:stdgo._internal.net.url.Url_values.Values, _key:stdgo.GoString):Void {
        @:recv var _v:stdgo._internal.net.url.Url_values.Values = _v;
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L907"
    ...
    static public function get( _v:stdgo._internal.net.url.Url_values.Values, _key:stdgo.GoString):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L887"
        if ((_vs.length) == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L888"
            return (stdgo.Go.str() : stdgo.GoString)?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/net/url/url.go#L890"
