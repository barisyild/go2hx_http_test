...
function _setNoDelay(_fd:stdgo.Ref<stdgo._internal.net.Net_t_netfd.T_netFD>, _noDelay:Bool):stdgo.Error {
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsockopt_stub.go#L15"
