...
function _setKeepAlive(_fd:stdgo.Ref<stdgo._internal.net.Net_t_netfd.T_netFD>, _keepalive:Bool):stdgo.Error {
        //"file:///Users/o/.go/go1.21.3/src/net/sockopt_stub.go#L32"
