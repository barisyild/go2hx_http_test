...
function _fakeUDPAddr(_addr:stdgo.Ref<stdgo._internal.net.Net_udpaddr.UDPAddr>):stdgo.Ref<stdgo._internal.net.Net_udpaddr.UDPAddr> {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/net_fake.go#L83"
        if (({
            final value = _addr;
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/net_fake.go#L87"
        return (stdgo.Go.setRef(({ iP : _ip, port : _port, zone : _zone?.__copy__() } : stdgo._internal.net.Net_udpaddr.UDPAddr), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_udpaddrdotudpaddr.__type__stdgodot_internaldotnetdotNet_udpaddrdotUDPAddr })) : stdgo.Ref<stdgo._internal.net.Net_udpaddr.UDPAddr>);
    }
