...
function fileListener(_f:stdgo.Ref<stdgo._internal.os.Os_file.File>):{ var _0 : stdgo._internal.net.Net_listener.Listener; var _1 : stdgo.Error; } {
        var _ln = (null : stdgo._internal.net.Net_listener.Listener), _err = (null : stdgo.Error);
        {
            var __tmp__ = stdgo._internal.net.Net__filelistener._fileListener(_f);
            _ln = @:tmpset0 __tmp__._0;
            _err = @:tmpset0 __tmp__._1;
        };
        //"file:///Users/o/.go/go1.21.3/src/net/file.go#L35"
        if (_err != null) {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/file.go#L38"
