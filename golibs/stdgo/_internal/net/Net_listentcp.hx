...
function listenTCP(_network:stdgo.GoString, _laddr:stdgo.Ref<stdgo._internal.net.Net_tcpaddr.TCPAddr>):{ var _0 : stdgo.Ref<stdgo._internal.net.Net_tcplistener.TCPListener>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L379"
        {
            final __value__ = _network;
            if (__value__ == (("tcp" : stdgo.GoString)) || __value__ == (("tcp4" : stdgo.GoString)) || __value__ == (("tcp6" : stdgo.GoString))) {} else {
                //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L382"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L384"
        if (({
            final value = _laddr;
            (value == null || (value : Dynamic).__nil__);
        })) {
            _laddr = (stdgo.Go.setRef((new stdgo._internal.net.Net_tcpaddr.TCPAddr() : stdgo._internal.net.Net_tcpaddr.TCPAddr), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_tcpaddrdottcpaddr.__type__stdgodot_internaldotnetdotNet_tcpaddrdotTCPAddr })) : stdgo.Ref<stdgo._internal.net.Net_tcpaddr.TCPAddr>);
        };
        ...
        var __tmp__ = _sl._listenTCP(stdgo._internal.context.Context_background.background(), _laddr), _ln:stdgo.Ref<stdgo._internal.net.Net_tcplistener.TCPListener> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L389"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L390"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsock.go#L392"
