...
function _setKeepAlivePeriod(_fd:stdgo.Ref<stdgo._internal.net.Net_t_netfd.T_netFD>, _d:stdgo._internal.time.Time_duration.Duration):stdgo.Error {
        //"file:///Users/o/.go/go1.21.3/src/net/tcpsockopt_stub.go#L19"
