...
@:keep @:allow(stdgo._internal.net.netip.Netip.AddrPort_asInterface) class AddrPort_static_extension {
    ...
    static public function unmarshalBinary( _p:stdgo.Ref<stdgo._internal.net.netip.Netip_addrport.AddrPort>, _b:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1208"
        if (((_b.length) < (2 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1209"
        ...
        var _err = @:assignType (_addr.unmarshalBinary((_b.__slice__(0, ((_b.length) - (2 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.Error);
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1213"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1214"
            return _err;
        };
        {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1217"
    ...
    static public function marshalBinary( _p:stdgo._internal.net.netip.Netip_addrport.AddrPort):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1201"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1202"
    ...
    static public function unmarshalText( _p:stdgo.Ref<stdgo._internal.net.netip.Netip_addrport.AddrPort>, _text:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
        @:recv var _p:stdgo.Ref<stdgo._internal.net.netip.Netip_addrport.AddrPort> = _p;
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1187"
        if ((_text.length) == ((0 : stdgo.GoInt))) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1189"
            return (null : stdgo.Error);
        };
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1193"
        return _err;
    }
    @:keep
    @:tdfield
    static public function marshalText( _p:stdgo._internal.net.netip.Netip_addrport.AddrPort):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1171"
        {
        ...
        _b = _p.appendTo(_b);
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1180"
        return { _0 : _b, _1 : (null : stdgo.Error) };
    }
    @:keep
    @:tdfield
    static public function appendTo( _p:stdgo._internal.net.netip.Netip_addrport.AddrPort, _b:stdgo.Slice<stdgo.GoUInt8>):stdgo.Slice<stdgo.GoUInt8> {
        @:recv var _p:stdgo._internal.net.netip.Netip_addrport.AddrPort = _p?.__copy__();
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1142"
        {
            final __value__ = _p._ip._z;
            if (__value__ == (stdgo._internal.net.netip.Netip__z0._z0)) {
                //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1144"
                return _b;
            } else if (__value__ == (stdgo._internal.net.netip.Netip__z4._z4)) {
                _b = _p._ip._appendTo4(_b);
            } else {
                //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1148"
                if (_p._ip.is4In6()) {
                    ...
                    //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1151"
                    {
                        var _z = @:assignType (_p._ip.zone()?.__copy__() : stdgo.GoString);
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1163"
        return _b;
    }
    @:keep
    @:tdfield
    static public function string( _p:stdgo._internal.net.netip.Netip_addrport.AddrPort):stdgo.GoString {
        @:recv var _p:stdgo._internal.net.netip.Netip_addrport.AddrPort = _p?.__copy__();
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1111"
        {
            final __value__ = _p._ip._z;
            if (__value__ == (stdgo._internal.net.netip.Netip__z0._z0)) {
                //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1113"
                ...
                //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1117"
                ...
                //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1122"
                return (_buf : stdgo.GoString)?.__copy__();
            } else {
                //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1125"
    ...
    static public function isValid( _p:stdgo._internal.net.netip.Netip_addrport.AddrPort):Bool {
        @:recv var _p:stdgo._internal.net.netip.Netip_addrport.AddrPort = _p?.__copy__();
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1108"
    ...
    static public function port( _p:stdgo._internal.net.netip.Netip_addrport.AddrPort):stdgo.GoUInt16 {
        @:recv var _p:stdgo._internal.net.netip.Netip_addrport.AddrPort = _p?.__copy__();
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1038"
        return _p._port;
    }
    @:keep
    @:tdfield
    static public function addr( _p:stdgo._internal.net.netip.Netip_addrport.AddrPort):stdgo._internal.net.netip.Netip_addr.Addr {
        @:recv var _p:stdgo._internal.net.netip.Netip_addrport.AddrPort = _p?.__copy__();
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L1035"
