...
function mustParseAddr(_s:stdgo.GoString):stdgo._internal.net.netip.Netip_addr.Addr {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L134"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L135"
            throw ({
                final __t__ = _err;
                if (__t__ == null) {
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/netip/netip.go#L137"
        return _ip?.__copy__();
    }
