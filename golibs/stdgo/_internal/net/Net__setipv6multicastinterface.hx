...
function _setIPv6MulticastInterface(_fd:stdgo.Ref<stdgo._internal.net.Net_t_netfd.T_netFD>, _ifi:stdgo.Ref<stdgo._internal.net.Net_interface.Interface>):stdgo.Error {
        //"file:///Users/o/.go/go1.21.3/src/net/sockoptip_stub.go#L24"
