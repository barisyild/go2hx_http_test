...
function resolveUDPAddr(_network:stdgo.GoString, _address:stdgo.GoString):{ var _0 : stdgo.Ref<stdgo._internal.net.Net_udpaddr.UDPAddr>; var _1 : stdgo.Error; } {
        //"file:///Users/o/.go/go1.21.3/src/net/udpsock.go#L88"
        {
            final __value__ = _network;
            if (__value__ == (("udp" : stdgo.GoString)) || __value__ == (("udp4" : stdgo.GoString)) || __value__ == (("udp6" : stdgo.GoString))) {} else if (__value__ == ((stdgo.Go.str() : stdgo.GoString))) {
                _network = ("udp" : stdgo.GoString);
            } else {
                //"file:///Users/o/.go/go1.21.3/src/net/udpsock.go#L93"
        ...
        //"file:///Users/o/.go/go1.21.3/src/net/udpsock.go#L96"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/net/udpsock.go#L97"
            return { _0 : null, _1 : _err };
        };
        //"file:///Users/o/.go/go1.21.3/src/net/udpsock.go#L99"
        ...
        }), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotnetdotnet_udpaddrdotudpaddr.__type__stdgodot_internaldotnetdotNet_udpaddrdotUDPAddr })) : stdgo.Ref<stdgo._internal.net.Net_udpaddr.UDPAddr>), _1 : (null : stdgo.Error) };
    }
