...
@:structInit @:using(stdgo._internal.net.Net_tcpconn_static_extension.TCPConn_static_extension) @:using(stdgo._internal.net.Net_tcpconn_static_extension.TCPConn_static_extension) class TCPConn {
    @:embedded
