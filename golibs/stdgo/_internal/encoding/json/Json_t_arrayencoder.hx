...
@:structInit @:using(stdgo._internal.encoding.json.Json_t_arrayencoder_static_extension.T_arrayEncoder_static_extension) @:using(stdgo._internal.encoding.json.Json_t_arrayencoder_static_extension.T_arrayEncoder_static_extension) class T_arrayEncoder {
