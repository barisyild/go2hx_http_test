...
@:structInit @:using(stdgo._internal.encoding.json.Json_t_mapencoder_static_extension.T_mapEncoder_static_extension) @:using(stdgo._internal.encoding.json.Json_t_mapencoder_static_extension.T_mapEncoder_static_extension) class T_mapEncoder {
