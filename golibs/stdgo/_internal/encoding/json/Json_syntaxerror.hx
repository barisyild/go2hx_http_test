...
@:structInit @:using(stdgo._internal.encoding.json.Json_syntaxerror_static_extension.SyntaxError_static_extension) @:using(stdgo._internal.encoding.json.Json_syntaxerror_static_extension.SyntaxError_static_extension) class SyntaxError {
