...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_sliceEncoder_asInterface) class T_sliceEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_sliceencoder.T_sliceEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        try {
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L803"
            if (_v.isNil()) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L804"
                _e.writeString(("null" : stdgo.GoString));
                //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L805"
                return;
            };
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L807"
            {
                ...
                if (((@:checkr _e ?? throw stdgo.Error._nullPointerDereference.__underlying__())._ptrLevel > (1000u32 : stdgo.GoUInt) : Bool)) {
                    var _ptr = @:assignType ({ _ptr : new stdgo.AnyInterface(_v.unsafePointer(), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.basic(unsafepointer_kind))), _len : _v.len() } : stdgo._internal.encoding.json.Json_t__struct_26.T__struct_26);
                    //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L816"
                    {
                        var __tmp__ = ((@:checkr _e ?? throw stdgo.Error._nullPointerDereference.__underlying__())._ptrSeen != null && (@:checkr _e ?? throw stdgo.Error._nullPointerDereference.__underlying__())._ptrSeen.__exists__(new stdgo.AnyInterface(stdgo.Go.asInterface(_ptr, stdgo._internal.internal.reflect.GoType.structType([{ name : "_ptr", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "_len", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_ptr", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "_len", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])))) ? { _0 : (@:checkr _e ?? throw stdgo.Error._nullPointerDereference.__underlying__())._ptrSeen[new stdgo.AnyInterface(stdgo.Go.asInterface(_ptr, stdgo._internal.internal.reflect.GoType.structType([{ name : "_ptr", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "_len", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_ptr", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "_len", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])))], _1 : true } : { _0 : ({  } : stdgo._internal.encoding.json.Json_t__struct_25.T__struct_25), _1 : false }), __2:stdgo._internal.encoding.json.Json_t__struct_25.T__struct_25 = __tmp__._0, _ok:Bool = __tmp__._1;
                        if (_ok) {
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L817"
                    ...
                    (@:checkr _e ?? throw stdgo.Error._nullPointerDereference.__underlying__())._ptrSeen[new stdgo.AnyInterface(stdgo.Go.asInterface(_ptr, stdgo._internal.internal.reflect.GoType.structType([{ name : "_ptr", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "_len", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_ptr", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "_len", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])))] = ({  } : stdgo._internal.encoding.json.Json_t__struct_25.T__struct_25);
                    {
                        var _a0 = (@:checkr _e ?? throw stdgo.Error._nullPointerDereference.__underlying__())._ptrSeen;
                        var _a1 = _ptr;
                        __deferstack__.unshift({ ran : false, f : () -> if (_a0 != null) _a0.__remove__(new stdgo.AnyInterface(stdgo.Go.asInterface(_a1, stdgo._internal.internal.reflect.GoType.structType([{ name : "_ptr", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "_len", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])), new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "_ptr", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "_len", embedded : false, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.basic(int_kind) }, optional : false }])))) });
                    };
                };
            };
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L822"
            _se._arrayEnc(_e, _v?.__copy__(), _opts?.__copy__());
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L823"
            (@:checkr _e ?? throw stdgo.Error._nullPointerDereference.__underlying__())._ptrLevel--;
            {
