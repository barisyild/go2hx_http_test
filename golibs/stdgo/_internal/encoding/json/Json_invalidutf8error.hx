...
@:structInit @:using(stdgo._internal.encoding.json.Json_invalidutf8error_static_extension.InvalidUTF8Error_static_extension) @:using(stdgo._internal.encoding.json.Json_invalidutf8error_static_extension.InvalidUTF8Error_static_extension) class InvalidUTF8Error {
