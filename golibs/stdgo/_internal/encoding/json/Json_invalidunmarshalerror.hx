...
@:structInit @:using(stdgo._internal.encoding.json.Json_invalidunmarshalerror_static_extension.InvalidUnmarshalError_static_extension) @:using(stdgo._internal.encoding.json.Json_invalidunmarshalerror_static_extension.InvalidUnmarshalError_static_extension) class InvalidUnmarshalError {
