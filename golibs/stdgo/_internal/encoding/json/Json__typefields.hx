...
function _typeFields(_t:stdgo._internal.reflect.Reflect_type_.Type_):stdgo._internal.encoding.json.Json_t_structfields.T_structFields {
        ...
        //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1087"
        while (((_next.length) > (0 : stdgo.GoInt) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1091"
            if (_current != null) for (__2 => _f in _current) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1092"
                if ((_visited[_f._typ] ?? false)) {
                    //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1093"
                    continue;
                };
                _visited[_f._typ] = true;
                //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1098"
                {
                    var _i = @:assignType (0 : stdgo.GoInt);
                    while ((_i < _f._typ.numField() : Bool)) {
                        var _sf = @:assignType (_f._typ.field(_i).__copy__() : stdgo._internal.reflect.Reflect_structfield.StructField);
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1100"
                        if (_sf.anonymous) {
                            var _t = @:assignType (_sf.type : stdgo._internal.reflect.Reflect_type_.Type_);
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1102"
                            if (_t.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                                _t = _t.elem();
                            };
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1105"
                            if ((!_sf.isExported() && (_t.kind() != (25u32 : stdgo._internal.reflect.Reflect_kind.Kind)) : Bool)) {
                                //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1107"
                                {
                                    _i++;
                                    continue;
                                };
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1113"
                            {
                                _i++;
                                continue;
                            };
                        };
var _tag = @:assignType (_sf.tag.get(("json" : stdgo.GoString)).__copy__() : stdgo.GoString);
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1116"
                        if (_tag == (("-" : stdgo.GoString))) {
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1117"
                            {
                                _i++;
                                continue;
                            };
...
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1120"
...
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1124"
                        _index.__copyTo__(_f._index);
_index[(_f._index.length : stdgo.GoInt)] = _i;
var _ft = @:assignType (_sf.type : stdgo._internal.reflect.Reflect_type_.Type_);
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1128"
                        if (((_ft.name() == (stdgo.Go.str() : stdgo.GoString)) && (_ft.kind() == (22u32 : stdgo._internal.reflect.Reflect_kind.Kind)) : Bool)) {
                            _ft = _ft.elem();
                        };
var _quoted = @:assignType (false : Bool);
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1135"
                        if (_opts.contains(("string" : stdgo.GoString))) {
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1136"
                            {
...
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1147"
                        if (((_name != ((stdgo.Go.str() : stdgo.GoString)) || !_sf.anonymous : Bool) || (_ft.kind() != (25u32 : stdgo._internal.reflect.Reflect_kind.Kind)) : Bool)) {
                            var _tagged = @:assignType (_name != ((stdgo.Go.str() : stdgo.GoString)) : Bool);
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1149"
                            if (_name == ((stdgo.Go.str() : stdgo.GoString))) {
                                _name = _sf.name.__copy__();
                            };
                            var _field = @:assignType ({ _name : _name.__copy__(), _tag : _tagged, _index : _index, _typ : _ft, _omitEmpty : _opts.contains(("omitempty" : stdgo.GoString)), _quoted : _quoted } : stdgo._internal.encoding.json.Json_t_field.T_field);
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1168"
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1175"
                            {
                                _i++;
                                continue;
                            };
                        };
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1179"
                        (@:typeIncDecStmt_escapeParens _nextCount[_ft] != null ? _nextCount[_ft]++ : (0 : stdgo.GoInt));
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1180"
        ...
        //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1187"
        stdgo._internal.sort.Sort_slice.slice(new stdgo.AnyInterface(_fields, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.sliceType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotencodingdotjsondotjson_t_fielddott_field.__type__stdgodot_internaldotencodingdotjsondotJson_t_fielddotT_field }))), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
            var _x = _fields;
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1192"
            if (_x[(_i : stdgo.GoInt)]._name != (_x[(_j : stdgo.GoInt)]._name)) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1193"
                return (_x[(_i : stdgo.GoInt)]._name < _x[(_j : stdgo.GoInt)]._name : Bool);
            };
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1195"
            if ((_x[(_i : stdgo.GoInt)]._index.length) != ((_x[(_j : stdgo.GoInt)]._index.length))) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1196"
                return ((_x[(_i : stdgo.GoInt)]._index.length) < (_x[(_j : stdgo.GoInt)]._index.length) : Bool);
            };
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1198"
            if (_x[(_i : stdgo.GoInt)]._tag != (_x[(_j : stdgo.GoInt)]._tag)) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1199"
                return _x[(_i : stdgo.GoInt)]._tag;
            };
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1201"
        ...
        //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1211"
        {
            var __0 = @:assignType (0 : stdgo.GoInt), __1 = @:assignType (0 : stdgo.GoInt);
var _i = __1, _advance = __0;
            while ((_i < (_fields.length) : Bool)) {
                var _fi = @:assignType (_fields[(_i : stdgo.GoInt)] : stdgo._internal.encoding.json.Json_t_field.T_field);
var _name = @:assignType (_fi._name.__copy__() : stdgo.GoString);
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1216"
                {
                    _advance = (1 : stdgo.GoInt);
                    while (((_i + _advance : stdgo.GoInt) < (_fields.length) : Bool)) {
                        var _fj = @:assignType (_fields[(_i + _advance : stdgo.GoInt)] : stdgo._internal.encoding.json.Json_t_field.T_field);
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1218"
                        if (_fj._name != (_name)) {
                            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1219"
                            break;
                        };
                        _advance++;
                    };
                };
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1222"
                if (_advance == ((1 : stdgo.GoInt))) {
                    ...
                    //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1224"
                    {
...
//"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1227"
                if (_ok) {
        ...
        _fields = _out;
        //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1233"
        stdgo._internal.sort.Sort_sort.sort(stdgo.Go.asInterface((_fields : stdgo._internal.encoding.json.Json_t_byindex.T_byIndex), _internal.gotype.Gotype___type__stdgodot_internaldotencodingdotjsondotjson_t_byindexdott_byindex.__type__stdgodot_internaldotencodingdotjsondotJson_t_byindexdotT_byIndex));
        //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1235"
        if (_fields != null) for (_i => _ in _fields) {
            var _f = (stdgo.Go.setRef(_fields[(_i : stdgo.GoInt)], stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotencodingdotjsondotjson_t_fielddott_field.__type__stdgodot_internaldotencodingdotjsondotJson_t_fielddotT_field })) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_field.T_field>);
            (@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._encoder = stdgo._internal.encoding.json.Json__typeencoder._typeEncoder(stdgo._internal.encoding.json.Json__typebyindex._typeByIndex(_t, (@:checkr _f ?? throw stdgo.Error._nullPointerDereference.__underlying__())._index));
        };
        var _exactNameIndex = (({
        ...
        //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1241"
        if (_fields != null) for (_i => _field in _fields) {
            _exactNameIndex[_field._name] = (stdgo.Go.setRef(_fields[(_i : stdgo.GoInt)], stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotencodingdotjsondotjson_t_fielddott_field.__type__stdgodot_internaldotencodingdotjsondotJson_t_fielddotT_field })) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_field.T_field>);
            //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1244"
            {
                var __tmp__ = (_foldedNameIndex != null && _foldedNameIndex.__exists__((stdgo._internal.encoding.json.Json__foldname._foldName(_field._nameBytes) : stdgo.GoString)?.__copy__()) ? { _0 : _foldedNameIndex[(stdgo._internal.encoding.json.Json__foldname._foldName(_field._nameBytes) : stdgo.GoString)?.__copy__()], _1 : true } : { _0 : (null : stdgo.Ref<stdgo._internal.encoding.json.Json_t_field.T_field>), _1 : false }), __2:stdgo.Ref<stdgo._internal.encoding.json.Json_t_field.T_field> = __tmp__._0, _ok:Bool = __tmp__._1;
                if (!_ok) {
                    _foldedNameIndex[(stdgo._internal.encoding.json.Json__foldname._foldName(_field._nameBytes) : stdgo.GoString)] = (stdgo.Go.setRef(_fields[(_i : stdgo.GoInt)], stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotencodingdotjsondotjson_t_fielddott_field.__type__stdgodot_internaldotencodingdotjsondotJson_t_fielddotT_field })) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_field.T_field>);
                };
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/encoding/json/encode.go#L1248"
