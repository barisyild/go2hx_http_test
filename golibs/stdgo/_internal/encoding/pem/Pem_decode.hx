...
function decode(_data:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.Ref<stdgo._internal.encoding.pem.Pem_block.Block>; var _1 : stdgo.Slice<stdgo.GoUInt8>; } {
        ...
        _rest = _data;
        //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L93"
        while (true) {
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L94"
            if (stdgo._internal.bytes.Bytes_hasprefix.hasPrefix(_rest, (stdgo._internal.encoding.pem.Pem__pemstart._pemStart.__slice__((1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>))) {
                ...
                if (_ok) {
                    ...
                    //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L99"
                    return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L104"
            if (!stdgo._internal.bytes.Bytes_hassuffix.hasSuffix(_typeLine, stdgo._internal.encoding.pem.Pem__pemendofline._pemEndOfLine)) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L105"
                continue;
            };
            ...
            _p = (stdgo.Go.setRef(({ headers : (({
                ...
                {};
                x;
            } : stdgo.GoMap<stdgo.GoString, stdgo.GoString>) : stdgo.GoMap<stdgo.GoString, stdgo.GoString>), type : (_typeLine : stdgo.GoString)?.__copy__() } : stdgo._internal.encoding.pem.Pem_block.Block), stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotencodingdotpemdotpem_blockdotblock.__type__stdgodot_internaldotencodingdotpemdotPem_blockdotBlock })) : stdgo.Ref<stdgo._internal.encoding.pem.Pem_block.Block>);
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L114"
            while (true) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L117"
                if ((_rest.length) == ((0 : stdgo.GoInt))) {
                    //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L118"
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Ref<stdgo._internal.encoding.pem.Pem_block.Block>; var _1 : stdgo.Slice<stdgo.GoUInt8>; } = { _0 : null, _1 : _data };
                        _p = __tmp__._0;
                        _rest = __tmp__._1;
                ...
                //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L123"
                if (!_ok) {
                    //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L124"
                    break;
                };
                _key = stdgo._internal.bytes.Bytes_trimspace.trimSpace(_key);
                _val = stdgo._internal.bytes.Bytes_trimspace.trimSpace(_val);
                (@:checkr _p ?? throw stdgo.Error._nullPointerDereference.__underlying__()).headers[(_key : stdgo.GoString)] = (_val : stdgo.GoString)?.__copy__();
                _rest = _next;
            };
            var _endIndex:stdgo.GoInt = (0 : stdgo.GoInt), _endTrailerIndex:stdgo.GoInt = (0 : stdgo.GoInt);
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L138"
            if ((((@:checkr _p ?? throw stdgo.Error._nullPointerDereference.__underlying__()).headers.length == (0 : stdgo.GoInt)) && stdgo._internal.bytes.Bytes_hasprefix.hasPrefix(_rest, (stdgo._internal.encoding.pem.Pem__pemend._pemEnd.__slice__((1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L146"
            if ((_endIndex < (0 : stdgo.GoInt) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L147"
                continue;
            };
            var _endTrailer = (_rest.__slice__(_endTrailerIndex) : stdgo.Slice<stdgo.GoUInt8>);
            var _endTrailerLen = @:assignType ((_typeLine.length) + (stdgo._internal.encoding.pem.Pem__pemendofline._pemEndOfLine.length) : stdgo.GoInt);
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L154"
            if (((_endTrailer.length) < _endTrailerLen : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L155"
                continue;
            };
            ...
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L160"
            if ((!stdgo._internal.bytes.Bytes_hasprefix.hasPrefix(_endTrailer, _typeLine) || !stdgo._internal.bytes.Bytes_hassuffix.hasSuffix(_endTrailer, stdgo._internal.encoding.pem.Pem__pemendofline._pemEndOfLine) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L162"
                continue;
            };
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L166"
            {
                ...
                if ((_s.length) != ((0 : stdgo.GoInt))) {
                    //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L167"
                    continue;
                };
            };
            ...
            (@:checkr _p ?? throw stdgo.Error._nullPointerDereference.__underlying__()).bytes = (new stdgo.Slice<stdgo.GoUInt8>((stdgo._internal.encoding.base64.Base64_stdencoding.stdEncoding.decodedLen((_base64Data.length)) : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
            var __tmp__ = stdgo._internal.encoding.base64.Base64_stdencoding.stdEncoding.decode((@:checkr _p ?? throw stdgo.Error._nullPointerDereference.__underlying__()).bytes, _base64Data), _n:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L173"
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L174"
                continue;
            };
            (@:checkr _p ?? throw stdgo.Error._nullPointerDereference.__underlying__()).bytes = ((@:checkr _p ?? throw stdgo.Error._nullPointerDereference.__underlying__()).bytes.__slice__(0, _n) : stdgo.Slice<stdgo.GoUInt8>);
            {
            ...
            //"file:///Users/o/.go/go1.21.3/src/encoding/pem/pem.go#L181"
            return {
