...
@:structInit @:using(stdgo._internal.encoding.asn1.Asn1_structuralerror_static_extension.StructuralError_static_extension) @:using(stdgo._internal.encoding.asn1.Asn1_structuralerror_static_extension.StructuralError_static_extension) class StructuralError {
