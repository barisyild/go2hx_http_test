...
function _sizeof(_t:stdgo._internal.reflect.Reflect_type_.Type_):stdgo.GoInt {
        //"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L503"
        {
            final __value__ = _t.kind();
            if (__value__ == ((17u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                //"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L505"
                {
                    var _s = @:assignType (stdgo._internal.encoding.binary.Binary__sizeof._sizeof(_t.elem()) : stdgo.GoInt);
                    if ((_s >= (0 : stdgo.GoInt) : Bool)) {
                        //"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L506"
                        return (_s * _t.len() : stdgo.GoInt);
                    };
                };
            } else if (__value__ == ((25u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                var _sum = @:assignType (0 : stdgo.GoInt);
                //"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L511"
                {
                    var __0 = @:assignType (0 : stdgo.GoInt), __1 = @:assignType (_t.numField() : stdgo.GoInt);
var _n = __1, _i = __0;
                    while ((_i < _n : Bool)) {
                        var _s = @:assignType (stdgo._internal.encoding.binary.Binary__sizeof._sizeof(_t.field(_i).type) : stdgo.GoInt);
//"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L513"
                        if ((_s < (0 : stdgo.GoInt) : Bool)) {
                            //"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L514"
...
_sum = (_sum + (_s) : stdgo.GoInt);
                ...
                //"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L518"
                return _sum;
                ...
                //"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L524"
                return (_t.size() : stdgo.GoInt);
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/encoding/binary/binary.go#L527"
        return (-1 : stdgo.GoInt);
    }
