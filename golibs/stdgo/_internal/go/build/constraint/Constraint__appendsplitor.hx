...
function _appendSplitOr(_list:stdgo.Slice<stdgo._internal.go.build.constraint.Constraint_expr.Expr>, _x:stdgo._internal.go.build.constraint.Constraint_expr.Expr):stdgo.Slice<stdgo._internal.go.build.constraint.Constraint_expr.Expr> {
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L568"
        {
            ...
            if (_ok) {
                _list = stdgo._internal.go.build.constraint.Constraint__appendsplitor._appendSplitOr(_list, (@:checkr _x ?? throw stdgo.Error._nullPointerDereference.__underlying__()).x);
                _list = stdgo._internal.go.build.constraint.Constraint__appendsplitor._appendSplitOr(_list, (@:checkr _x ?? throw stdgo.Error._nullPointerDereference.__underlying__()).y);
                //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L571"
                return _list;
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L573"
