...
@:structInit @:using(stdgo._internal.go.build.constraint.Constraint_andexpr_static_extension.AndExpr_static_extension) @:using(stdgo._internal.go.build.constraint.Constraint_andexpr_static_extension.AndExpr_static_extension) class AndExpr {
