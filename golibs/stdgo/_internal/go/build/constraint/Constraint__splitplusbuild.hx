...
function _splitPlusBuild(_line:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L359"
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L362"
        if (stdgo._internal.strings.Strings_contains.contains(_line?.__copy__(), ("\n" : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L363"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L366"
        if (!stdgo._internal.strings.Strings_hasprefix.hasPrefix(_line?.__copy__(), ("//" : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L367"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : Bool; } = { _0 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _1 : false };
                _expr = __tmp__._0;
                _ok = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L373"
        if (!stdgo._internal.strings.Strings_hasprefix.hasPrefix(_line?.__copy__(), ("+build" : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L374"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : Bool; } = { _0 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _1 : false };
                _expr = __tmp__._0;
                _ok = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L383"
        if (((_line.length == (_trim.length)) && (_line != (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L384"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : Bool; } = { _0 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _1 : false };
                _expr = __tmp__._0;
                _ok = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L387"
        return {
