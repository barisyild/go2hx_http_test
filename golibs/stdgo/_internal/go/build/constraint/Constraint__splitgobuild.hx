...
function _splitGoBuild(_line:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : Bool; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L170"
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L173"
        if (stdgo._internal.strings.Strings_contains.contains(_line?.__copy__(), ("\n" : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L174"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L177"
        if (!stdgo._internal.strings.Strings_hasprefix.hasPrefix(_line?.__copy__(), ("//go:build" : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L178"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : Bool; } = { _0 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _1 : false };
                _expr = __tmp__._0;
                _ok = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L189"
        if (((_line.length == (_trim.length)) && (_line != (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L190"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : Bool; } = { _0 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _1 : false };
                _expr = __tmp__._0;
                _ok = __tmp__._1;
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L193"
        return {
