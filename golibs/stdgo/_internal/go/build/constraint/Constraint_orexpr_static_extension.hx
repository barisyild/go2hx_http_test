...
@:keep @:allow(stdgo._internal.go.build.constraint.Constraint.OrExpr_asInterface) class OrExpr_static_extension {
    ...
    static public function string( _x:stdgo.Ref<stdgo._internal.go.build.constraint.Constraint_orexpr.OrExpr>):stdgo.GoString {
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L120"
        return ((stdgo._internal.go.build.constraint.Constraint__orarg._orArg((@:checkr _x ?? throw stdgo.Error._nullPointerDereference.__underlying__()).x) + (" || " : stdgo.GoString)?.__copy__() : stdgo.GoString) + stdgo._internal.go.build.constraint.Constraint__orarg._orArg((@:checkr _x ?? throw stdgo.Error._nullPointerDereference.__underlying__()).y)?.__copy__() : stdgo.GoString)?.__copy__();
    }
    @:keep
    @:tdfield
    static public function eval( _x:stdgo.Ref<stdgo._internal.go.build.constraint.Constraint_orexpr.OrExpr>, _ok:stdgo.GoString -> Bool):Bool {
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/build/constraint/expr.go#L116"
