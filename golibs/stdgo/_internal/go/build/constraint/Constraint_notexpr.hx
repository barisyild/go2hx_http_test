...
@:structInit @:using(stdgo._internal.go.build.constraint.Constraint_notexpr_static_extension.NotExpr_static_extension) @:using(stdgo._internal.go.build.constraint.Constraint_notexpr_static_extension.NotExpr_static_extension) class NotExpr {
