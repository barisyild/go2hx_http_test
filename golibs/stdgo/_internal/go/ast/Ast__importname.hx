...
function _importName(_s:stdgo._internal.go.ast.Ast_spec.Spec):stdgo.GoString {
        var _n = (@:checkr (stdgo.Go.typeAssert(({
            final __t__ = _s;
            if (__t__ == null) {
        ...
        //"file:///Users/o/.go/go1.21.3/src/go/ast/import.go#L69"
        if (({
            final value = _n;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///Users/o/.go/go1.21.3/src/go/ast/import.go#L70"
            return (stdgo.Go.str() : stdgo.GoString)?.__copy__();
        };
        //"file:///Users/o/.go/go1.21.3/src/go/ast/import.go#L72"
        return (@:checkr _n ?? throw stdgo.Error._nullPointerDereference.__underlying__()).name?.__copy__();
    }
