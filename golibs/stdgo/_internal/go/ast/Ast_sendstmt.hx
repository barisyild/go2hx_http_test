...
@:structInit @:using(stdgo._internal.go.ast.Ast_sendstmt_static_extension.SendStmt_static_extension) @:using(stdgo._internal.go.ast.Ast_sendstmt_static_extension.SendStmt_static_extension) class SendStmt {
