...
@:structInit @:using(stdgo._internal.go.ast.Ast_arraytype_static_extension.ArrayType_static_extension) @:using(stdgo._internal.go.ast.Ast_arraytype_static_extension.ArrayType_static_extension) class ArrayType {
