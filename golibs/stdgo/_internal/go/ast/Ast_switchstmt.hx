...
@:structInit @:using(stdgo._internal.go.ast.Ast_switchstmt_static_extension.SwitchStmt_static_extension) @:using(stdgo._internal.go.ast.Ast_switchstmt_static_extension.SwitchStmt_static_extension) class SwitchStmt {
