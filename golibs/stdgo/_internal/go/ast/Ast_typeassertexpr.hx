...
@:structInit @:using(stdgo._internal.go.ast.Ast_typeassertexpr_static_extension.TypeAssertExpr_static_extension) @:using(stdgo._internal.go.ast.Ast_typeassertexpr_static_extension.TypeAssertExpr_static_extension) class TypeAssertExpr {
