...
@:structInit @:using(stdgo._internal.go.ast.Ast_gostmt_static_extension.GoStmt_static_extension) @:using(stdgo._internal.go.ast.Ast_gostmt_static_extension.GoStmt_static_extension) class GoStmt {
