...
function _fieldName(_x:stdgo._internal.go.ast.Ast_expr.Expr):stdgo.Ref<stdgo._internal.go.ast.Ast_ident.Ident> {
        //"file:///Users/o/.go/go1.21.3/src/go/ast/filter.go#L61"
        {
            final __type__ = _x;
            if (stdgo.Go.typeEquals(({
                ...
                //"file:///Users/o/.go/go1.21.3/src/go/ast/filter.go#L63"
                return _t;
                ...
                //"file:///Users/o/.go/go1.21.3/src/go/ast/filter.go#L65"
                {
                    var __tmp__ = @:castTranslate try {
                        { _0 : (stdgo.Go.typeAssert(({
                            final __t__ = (@:checkr _t ?? throw stdgo.Error._nullPointerDereference.__underlying__()).x;
                            if (__t__ == null) {
                                new stdgo.AnyInterface(null, new stdgo._internal.internal.reflect.Reflect._Type(_internal.gotype.Gotype___type__stdgodot_internaldotgodotastdotast_exprdotexpr.__type__stdgodot_internaldotgodotastdotAst_exprdotExpr)).__setNil__();
                            } else {
                                new stdgo.AnyInterface(__t__, __t__.__underlying__().type);
                    ...
                    if (_ok) {
                        //"file:///Users/o/.go/go1.21.3/src/go/ast/filter.go#L66"
                        return (@:checkr _t ?? throw stdgo.Error._nullPointerDereference.__underlying__()).sel;
                    };
                };
            } else if (stdgo.Go.typeEquals(({
                final __t__ = __type__;
                ...
                //"file:///Users/o/.go/go1.21.3/src/go/ast/filter.go#L69"
                return stdgo._internal.go.ast.Ast__fieldname._fieldName((@:checkr _t ?? throw stdgo.Error._nullPointerDereference.__underlying__()).x);
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/go/ast/filter.go#L71"
        return null;
    }
