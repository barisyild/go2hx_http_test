...
@:structInit @:using(stdgo._internal.go.ast.Ast_forstmt_static_extension.ForStmt_static_extension) @:using(stdgo._internal.go.ast.Ast_forstmt_static_extension.ForStmt_static_extension) class ForStmt {
