...
@:structInit @:using(stdgo._internal.go.ast.Ast_badexpr_static_extension.BadExpr_static_extension) @:using(stdgo._internal.go.ast.Ast_badexpr_static_extension.BadExpr_static_extension) class BadExpr {
