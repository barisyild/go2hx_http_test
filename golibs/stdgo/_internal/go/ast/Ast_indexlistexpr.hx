...
@:structInit @:using(stdgo._internal.go.ast.Ast_indexlistexpr_static_extension.IndexListExpr_static_extension) @:using(stdgo._internal.go.ast.Ast_indexlistexpr_static_extension.IndexListExpr_static_extension) class IndexListExpr {
