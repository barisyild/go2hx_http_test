...
@:structInit @:using(stdgo._internal.go.ast.Ast_badstmt_static_extension.BadStmt_static_extension) @:using(stdgo._internal.go.ast.Ast_badstmt_static_extension.BadStmt_static_extension) class BadStmt {
