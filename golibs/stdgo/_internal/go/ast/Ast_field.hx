...
@:structInit @:using(stdgo._internal.go.ast.Ast_field_static_extension.Field_static_extension) @:using(stdgo._internal.go.ast.Ast_field_static_extension.Field_static_extension) class Field {
