...
@:structInit @:using(stdgo._internal.go.ast.Ast_starexpr_static_extension.StarExpr_static_extension) @:using(stdgo._internal.go.ast.Ast_starexpr_static_extension.StarExpr_static_extension) class StarExpr {
