...
@:structInit @:using(stdgo._internal.go.ast.Ast_keyvalueexpr_static_extension.KeyValueExpr_static_extension) @:using(stdgo._internal.go.ast.Ast_keyvalueexpr_static_extension.KeyValueExpr_static_extension) class KeyValueExpr {
