...
function _pdqsort(_data:stdgo._internal.sort.Sort_interface.Interface, _a:stdgo.GoInt, _b:stdgo.GoInt, _limit:stdgo.GoInt):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L69"
        while (true) {
            var _length = @:assignType (_b - _a : stdgo.GoInt);
            //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L72"
            if ((_length <= (12 : stdgo.GoInt) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L73"
                stdgo._internal.sort.Sort__insertionsort._insertionSort(_data, _a, _b);
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L74"
                return;
            };
            //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L78"
            if (_limit == ((0 : stdgo.GoInt))) {
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L79"
                stdgo._internal.sort.Sort__heapsort._heapSort(_data, _a, _b);
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L80"
                return;
            };
            //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L84"
            if (!_wasBalanced) {
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L85"
                stdgo._internal.sort.Sort__breakpatterns._breakPatterns(_data, _a, _b);
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L86"
                _limit--;
            };
            ...
            //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L90"
            if (_hint == ((2 : stdgo._internal.sort.Sort_t_sortedhint.T_sortedHint))) {
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L91"
            ...
            //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L100"
            if (((_wasBalanced && _wasPartitioned : Bool) && (_hint == (1 : stdgo._internal.sort.Sort_t_sortedhint.T_sortedHint)) : Bool)) {
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L101"
                if (stdgo._internal.sort.Sort__partialinsertionsort._partialInsertionSort(_data, _a, _b)) {
                    //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L102"
                    return;
                };
            };
            //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L108"
            if (((_a > (0 : stdgo.GoInt) : Bool) && !_data.less((_a - (1 : stdgo.GoInt) : stdgo.GoInt), _pivot) : Bool)) {
                var _mid = @:assignType (stdgo._internal.sort.Sort__partitionequal._partitionEqual(_data, _a, _b, _pivot) : stdgo.GoInt);
                _a = _mid;
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L111"
                continue;
            };
...
var _rightLen = __1, _leftLen = __0;
            ...
            //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L119"
            if ((_leftLen < _rightLen : Bool)) {
                _wasBalanced = (_leftLen >= _balanceThreshold : Bool);
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L121"
                ...
                //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L125"
