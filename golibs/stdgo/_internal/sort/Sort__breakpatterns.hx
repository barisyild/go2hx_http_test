...
function _breakPatterns(_data:stdgo._internal.sort.Sort_interface.Interface, _a:stdgo.GoInt, _b:stdgo.GoInt):Void {
        ...
        //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L242"
        if ((_length >= (8 : stdgo.GoInt) : Bool)) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L246"
            {
...
//"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L248"
                    if ((_other >= _length : Bool)) {
                        _other = (_other - (_length) : stdgo.GoInt);
                    };
//"file:///Users/o/.go/go1.21.3/src/sort/zsortinterface.go#L251"
