...
@:structInit @:using(stdgo._internal.context.Context_t_stopctx_static_extension.T_stopCtx_static_extension) @:using(stdgo._internal.context.Context_t_stopctx_static_extension.T_stopCtx_static_extension) class T_stopCtx {
    @:embedded
