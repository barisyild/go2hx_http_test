...
@:structInit @:using(stdgo._internal.context.Context_t_todoctx_static_extension.T_todoCtx_static_extension) @:using(stdgo._internal.context.Context_t_todoctx_static_extension.T_todoCtx_static_extension) class T_todoCtx {
    @:embedded
