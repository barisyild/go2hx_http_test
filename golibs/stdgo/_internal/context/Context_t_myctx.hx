...
@:structInit @:using(stdgo._internal.context.Context_t_myctx_static_extension.T_myCtx_static_extension) @:using(stdgo._internal.context.Context_t_myctx_static_extension.T_myCtx_static_extension) class T_myCtx {
    @:embedded
