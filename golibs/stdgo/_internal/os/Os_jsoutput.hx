...
@:using(stdgo._internal.os.Os_jsoutput_static_extension.JsOutput_static_extension) @:using(stdgo._internal.os.Os_jsoutput_static_extension.JsOutput_static_extension) class JsOutput extends haxe.io.Output {
    public function new() {}
