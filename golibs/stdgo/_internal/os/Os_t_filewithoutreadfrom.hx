...
@:structInit @:using(stdgo._internal.os.Os_t_filewithoutreadfrom_static_extension.T_fileWithoutReadFrom_static_extension) @:using(stdgo._internal.os.Os_t_filewithoutreadfrom_static_extension.T_fileWithoutReadFrom_static_extension) class T_fileWithoutReadFrom {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface(this, new stdgo._internal.internal.reflect.Reflect._Type(stdgo._internal.internal.reflect.GoType.structType([{ name : "file", embedded : true, tag : "", type : { get : () -> stdgo._internal.internal.reflect.GoType.refType({ get : () -> _internal.gotype.Gotype___type__stdgodot_internaldotosdotos_filedotfile.__type__stdgodot_internaldotosdotOs_filedotFile }) }, optional : false }])));
