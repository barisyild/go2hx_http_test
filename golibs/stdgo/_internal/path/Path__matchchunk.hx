...
function _matchChunk(_chunk:stdgo.GoString, _s:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : Bool; var _2 : stdgo.Error; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/path/match.go#L128"
        while (((_chunk.length) > (0 : stdgo.GoInt) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L129"
            if ((!_failed && (_s.length == (0 : stdgo.GoInt)) : Bool)) {
                _failed = true;
            };
            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L132"
            {
                ...
                while (__run__) {
                    __run__ = false;
                    {
                        ...
                        if (__switchIndex__ == 0 || (__switchIndex__ == -1 && (__value__ == (91 : stdgo.GoUInt8)))) {
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L136"
                            if (!_failed) {
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L144"
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L151"
                            while (true) {
                                //"file:///Users/o/.go/go1.21.3/src/path/match.go#L152"
                                if (((((_chunk.length) > (0 : stdgo.GoInt) : Bool) && _chunk[(0 : stdgo.GoInt)] == ((93 : stdgo.GoUInt8)) : Bool) && (_nrange > (0 : stdgo.GoInt) : Bool) : Bool)) {
                                    _chunk = (_chunk.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                                    //"file:///Users/o/.go/go1.21.3/src/path/match.go#L154"
                                    break;
                                };
                                var _lo:stdgo.GoInt32 = (0 : stdgo.GoInt32), _hi:stdgo.GoInt32 = (0 : stdgo.GoInt32);
                                //"file:///Users/o/.go/go1.21.3/src/path/match.go#L157"
                                {
                                    {
                                    ...
                                    if (_err != null) {
                                        //"file:///Users/o/.go/go1.21.3/src/path/match.go#L158"
                                        return {
                                ...
                                _hi = _lo;
                                //"file:///Users/o/.go/go1.21.3/src/path/match.go#L161"
                                if (_chunk[(0 : stdgo.GoInt)] == ((45 : stdgo.GoUInt8))) {
                                    //"file:///Users/o/.go/go1.21.3/src/path/match.go#L162"
                                    {
                                        {
                                        ...
                                        if (_err != null) {
                                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L163"
                                            return {
                                                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : Bool; var _2 : stdgo.Error; } = { _0 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _1 : false, _2 : _err };
                                                _rest = __tmp__._0;
                                                _ok = __tmp__._1;
                                ...
                                //"file:///Users/o/.go/go1.21.3/src/path/match.go#L166"
                                if (((_lo <= _r : Bool) && (_r <= _hi : Bool) : Bool)) {
                                    _match = true;
                                };
                                //"file:///Users/o/.go/go1.21.3/src/path/match.go#L169"
                                _nrange++;
                            };
                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L171"
                            if (_match == (_negated)) {
                                _failed = true;
                            };
                            break;
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L176"
                            if (!_failed) {
                                //"file:///Users/o/.go/go1.21.3/src/path/match.go#L177"
                            ...
                            _chunk = (_chunk.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L187"
                            if ((_chunk.length) == ((0 : stdgo.GoInt))) {
                                //"file:///Users/o/.go/go1.21.3/src/path/match.go#L188"
                                return {
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L190"
                            @:fallthrough {
                                __switchIndex__ = 3;
                                __run__ = true;
                                continue;
                            ...
                            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L193"
                            if (!_failed) {
                                //"file:///Users/o/.go/go1.21.3/src/path/match.go#L194"
        ...
        //"file:///Users/o/.go/go1.21.3/src/path/match.go#L202"
        if (_failed) {
            //"file:///Users/o/.go/go1.21.3/src/path/match.go#L203"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/path/match.go#L205"
        return {
