...
function _cleanGlobPathWindows(_path:stdgo.GoString):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; } {
        ...
        //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L311"
        if (_path == ((stdgo.Go.str() : stdgo.GoString))) {
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L313"
            return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L316"
            return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L318"
            return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L320"
            if ((_vollen >= (_path.length) : Bool)) {
                _vollen = ((_path.length) - (1 : stdgo.GoInt) : stdgo.GoInt);
            };
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L323"
            return {
