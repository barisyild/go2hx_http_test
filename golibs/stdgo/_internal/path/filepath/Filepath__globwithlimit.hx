...
function _globWithLimit(_pattern:stdgo.GoString, _depth:stdgo.GoInt):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } {
        ...
        {};
        //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L249"
        if (_depth == ((10000 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L250"
            return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L254"
        {
            ...
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L255"
                return {
        ...
        //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L257"
        if (!stdgo._internal.path.filepath.Filepath__hasmeta._hasMeta(_pattern?.__copy__())) {
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L258"
            {
                {
                ...
                if (_err != null) {
                    //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L259"
                    return {
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L261"
            return {
        ...
        var _volumeLen = @:assignType (0 : stdgo.GoInt);
        //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L266"
        if (false) {
            {
        ...
        //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L283"
        if (_err != null) {
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L284"
            return { _0 : _matches, _1 : _err };
        };
        //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L286"
        if (_m != null) for (__1 => _d in _m) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L288"
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L289"
                return { _0 : _matches, _1 : _err };
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L292"
        return { _0 : _matches, _1 : _err };
    }
