...
function _glob(_dir:stdgo.GoString, _pattern:stdgo.GoString, _matches:stdgo.Slice<stdgo.GoString>):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } {
        ...
        try {
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L334"
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L335"
                return { _0 : _m, _1 : _e };
            };
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L337"
            if (!_fi.isDir()) {
                //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L338"
                return { _0 : _m, _1 : _e };
            };
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L341"
            if (_err != null) {
                //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L342"
                return { _0 : _m, _1 : _e };
            };
            {
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L347"
            stdgo._internal.sort.Sort_strings.strings(_names);
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L349"
            if (_names != null) for (__1 => _n in _names) {
                ...
                //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L351"
                if (_err != null) {
                    //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L352"
                    {
                ...
                //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L354"
                if (_matched) {
            ...
            //"file:///Users/o/.go/go1.21.3/src/path/filepath/match.go#L358"
            {
                for (defer in __deferstack__) {
                    if (defer.ran) continue;
                    defer.ran = true;
