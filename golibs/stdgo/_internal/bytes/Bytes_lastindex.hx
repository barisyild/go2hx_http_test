...
function lastIndex(_s:stdgo.Slice<stdgo.GoUInt8>, _sep:stdgo.Slice<stdgo.GoUInt8>):stdgo.GoInt {
        ...
        //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L111"
        if (_n == ((0 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L113"
            return (_s.length);
        } else if (_n == ((1 : stdgo.GoInt))) {
            //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L115"
            return stdgo._internal.bytes.Bytes_lastindexbyte.lastIndexByte(_s, _sep[(0 : stdgo.GoInt)]);
        } else if (_n == ((_s.length))) {
            //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L117"
            if (stdgo._internal.bytes.Bytes_equal.equal(_s, _sep)) {
                //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L118"
                return (0 : stdgo.GoInt);
            };
            //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L120"
            return (-1 : stdgo.GoInt);
        } else if ((_n > (_s.length) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L122"
            return (-1 : stdgo.GoInt);
        };
        ...
        //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L128"
        {
        ...
        //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L131"
        if (((_h == _hashss) && stdgo._internal.bytes.Bytes_equal.equal((_s.__slice__(_last) : stdgo.Slice<stdgo.GoUInt8>), _sep) : Bool)) {
            //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L132"
            return _last;
        };
        //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L134"
        {
...
//"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L138"
                if (((_h == _hashss) && stdgo._internal.bytes.Bytes_equal.equal((_s.__slice__(_i, (_i + _n : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), _sep) : Bool)) {
                    //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L139"
                    return _i;
                };
                _i--;
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/bytes/bytes.go#L142"
        return (-1 : stdgo.GoInt);
    }
