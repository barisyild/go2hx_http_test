...
@:structInit @:using(stdgo._internal.bytes.Bytes_reader_static_extension.Reader_static_extension) @:using(stdgo._internal.bytes.Bytes_reader_static_extension.Reader_static_extension) class Reader {
