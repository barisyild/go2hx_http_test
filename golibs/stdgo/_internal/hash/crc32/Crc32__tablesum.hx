...
function _tableSum(_t:stdgo.Ref<stdgo._internal.hash.crc32.Crc32_table.Table>):stdgo.GoUInt32 {
        ...
        //"file:///Users/o/.go/go1.21.3/src/hash/crc32/crc32.go#L259"
        if (({
            final value = _t;
            (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
        })) {
            //"file:///Users/o/.go/go1.21.3/src/hash/crc32/crc32.go#L260"
            if (_t != null) for (__0 => _x in _t) {
                _b = stdgo._internal.hash.crc32.Crc32__appenduint32._appendUint32(_b, _x);
            };
        };
        //"file:///Users/o/.go/go1.21.3/src/hash/crc32/crc32.go#L264"
