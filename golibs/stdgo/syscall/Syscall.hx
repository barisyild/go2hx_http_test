...
typedef SockaddrInet4PointerPointer = stdgo._internal.syscall.Syscall_sockaddrinet4pointerpointer.SockaddrInet4PointerPointer;
typedef SockaddrInet6PointerPointer = stdgo._internal.syscall.Syscall_sockaddrinet6pointerpointer.SockaddrInet6PointerPointer;
typedef SockaddrUnixPointerPointer = stdgo._internal.syscall.Syscall_sockaddrunixpointerpointer.SockaddrUnixPointerPointer;
typedef DirentPointerPointer = stdgo._internal.syscall.Syscall_direntpointerpointer.DirentPointerPointer;
typedef Stat_tPointerPointer = stdgo._internal.syscall.Syscall_stat_tpointerpointer.Stat_tPointerPointer;
typedef RusagePointerPointer = stdgo._internal.syscall.Syscall_rusagepointerpointer.RusagePointerPointer;
typedef ProcAttrPointerPointer = stdgo._internal.syscall.Syscall_procattrpointerpointer.ProcAttrPointerPointer;
typedef SysProcAttrPointerPointer = stdgo._internal.syscall.Syscall_sysprocattrpointerpointer.SysProcAttrPointerPointer;
typedef IovecPointerPointer = stdgo._internal.syscall.Syscall_iovecpointerpointer.IovecPointerPointer;
typedef TimespecPointerPointer = stdgo._internal.syscall.Syscall_timespecpointerpointer.TimespecPointerPointer;
typedef TimevalPointerPointer = stdgo._internal.syscall.Syscall_timevalpointerpointer.TimevalPointerPointer;
typedef SockaddrPointerPointer = stdgo._internal.syscall.Syscall_sockaddrpointerpointer.SockaddrPointerPointer;
typedef ErrnoPointerPointer = stdgo._internal.syscall.Syscall_errnopointerpointer.ErrnoPointerPointer;
typedef SignalPointerPointer = stdgo._internal.syscall.Syscall_signalpointerpointer.SignalPointerPointer;
typedef WaitStatusPointerPointer = stdgo._internal.syscall.Syscall_waitstatuspointerpointer.WaitStatusPointerPointer;
/**
