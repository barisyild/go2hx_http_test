...
typedef WriterPointerPointer = stdgo._internal.compress.flate.Flate_writerpointerpointer.WriterPointerPointer;
typedef ReadErrorPointerPointer = stdgo._internal.compress.flate.Flate_readerrorpointerpointer.ReadErrorPointerPointer;
typedef WriteErrorPointerPointer = stdgo._internal.compress.flate.Flate_writeerrorpointerpointer.WriteErrorPointerPointer;
typedef CorruptInputErrorPointerPointer = stdgo._internal.compress.flate.Flate_corruptinputerrorpointerpointer.CorruptInputErrorPointerPointer;
typedef InternalErrorPointerPointer = stdgo._internal.compress.flate.Flate_internalerrorpointerpointer.InternalErrorPointerPointer;
/**
