...
typedef HeaderPointerPointer = stdgo._internal.compress.gzip.Gzip_headerpointerpointer.HeaderPointerPointer;
typedef ReaderPointerPointer = stdgo._internal.compress.gzip.Gzip_readerpointerpointer.ReaderPointerPointer;
typedef WriterPointerPointer = stdgo._internal.compress.gzip.Gzip_writerpointerpointer.WriterPointerPointer;
/**
