...
typedef MethodPointerPointer = stdgo._internal.reflect.Reflect_methodpointerpointer.MethodPointerPointer;
typedef StructFieldPointerPointer = stdgo._internal.reflect.Reflect_structfieldpointerpointer.StructFieldPointerPointer;
typedef ValuePointerPointer = stdgo._internal.reflect.Reflect_valuepointerpointer.ValuePointerPointer;
typedef ValueErrorPointerPointer = stdgo._internal.reflect.Reflect_valueerrorpointerpointer.ValueErrorPointerPointer;
typedef MapIterPointerPointer = stdgo._internal.reflect.Reflect_mapiterpointerpointer.MapIterPointerPointer;
typedef StringHeaderPointerPointer = stdgo._internal.reflect.Reflect_stringheaderpointerpointer.StringHeaderPointerPointer;
typedef SliceHeaderPointerPointer = stdgo._internal.reflect.Reflect_sliceheaderpointerpointer.SliceHeaderPointerPointer;
typedef SelectCasePointerPointer = stdgo._internal.reflect.Reflect_selectcasepointerpointer.SelectCasePointerPointer;
typedef KindPointerPointer = stdgo._internal.reflect.Reflect_kindpointerpointer.KindPointerPointer;
typedef ChanDirPointerPointer = stdgo._internal.reflect.Reflect_chandirpointerpointer.ChanDirPointerPointer;
typedef StructTagPointerPointer = stdgo._internal.reflect.Reflect_structtagpointerpointer.StructTagPointerPointer;
typedef SelectDirPointerPointer = stdgo._internal.reflect.Reflect_selectdirpointerpointer.SelectDirPointerPointer;
/**
