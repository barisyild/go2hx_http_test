...
typedef CoordinateFuzzingOptsPointerPointer = stdgo._internal.internal.fuzz.Fuzz_coordinatefuzzingoptspointerpointer.CoordinateFuzzingOptsPointerPointer;
typedef CorpusEntryPointerPointer = stdgo._internal.internal.fuzz.Fuzz_corpusentrypointerpointer.CorpusEntryPointerPointer;
typedef MalformedCorpusErrorPointerPointer = stdgo._internal.internal.fuzz.Fuzz_malformedcorpuserrorpointerpointer.MalformedCorpusErrorPointerPointer;
/**
...
class Fuzz {
    ...
    **/
    ...
    /**
        ...
        * error.
    **/
    static public inline function readCorpus(_dir:stdgo.GoString, _types:stdgo.Slice<stdgo._internal.reflect.Reflect_type_.Type_>):{ var _0 : stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }>; var _1 : stdgo.Error; } return stdgo._internal.internal.fuzz.Fuzz_readcorpus.readCorpus(_dir, _types);
    /**
    ...
    **/
    ...
    /**
        ...
        * coordinator process.
    **/
    static public inline function runFuzzWorker(_ctx:stdgo._internal.context.Context_context.Context, _fn:({ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.GoUInt8>; var values : stdgo.Slice<stdgo.AnyInterface>; var generation : stdgo.GoInt; var isSeed : Bool; }) -> stdgo.Error):stdgo.Error return stdgo._internal.internal.fuzz.Fuzz_runfuzzworker.runFuzzWorker(_ctx, _fn);
}
