...
typedef ReaderPointerPointer = stdgo._internal.mime.quotedprintable.Quotedprintable_readerpointerpointer.ReaderPointerPointer;
typedef WriterPointerPointer = stdgo._internal.mime.quotedprintable.Quotedprintable_writerpointerpointer.WriterPointerPointer;
/**
