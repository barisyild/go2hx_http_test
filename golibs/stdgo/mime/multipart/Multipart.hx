...
typedef FormPointerPointer = stdgo._internal.mime.multipart.Multipart_formpointerpointer.FormPointerPointer;
typedef FileHeaderPointerPointer = stdgo._internal.mime.multipart.Multipart_fileheaderpointerpointer.FileHeaderPointerPointer;
typedef PartPointerPointer = stdgo._internal.mime.multipart.Multipart_partpointerpointer.PartPointerPointer;
typedef ReaderPointerPointer = stdgo._internal.mime.multipart.Multipart_readerpointerpointer.ReaderPointerPointer;
typedef WriterPointerPointer = stdgo._internal.mime.multipart.Multipart_writerpointerpointer.WriterPointerPointer;
/**
    * 
