...
typedef LimitedReaderPointerPointer = stdgo._internal.io.Io_limitedreaderpointerpointer.LimitedReaderPointerPointer;
typedef SectionReaderPointerPointer = stdgo._internal.io.Io_sectionreaderpointerpointer.SectionReaderPointerPointer;
typedef OffsetWriterPointerPointer = stdgo._internal.io.Io_offsetwriterpointerpointer.OffsetWriterPointerPointer;
typedef PipeReaderPointerPointer = stdgo._internal.io.Io_pipereaderpointerpointer.PipeReaderPointerPointer;
typedef PipeWriterPointerPointer = stdgo._internal.io.Io_pipewriterpointerpointer.PipeWriterPointerPointer;
/**
