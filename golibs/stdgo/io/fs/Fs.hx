...
typedef PathErrorPointerPointer = stdgo._internal.io.fs.Fs_patherrorpointerpointer.PathErrorPointerPointer;
typedef FileModePointerPointer = stdgo._internal.io.fs.Fs_filemodepointerpointer.FileModePointerPointer;
typedef WalkDirFuncPointerPointer = stdgo._internal.io.fs.Fs_walkdirfuncpointerpointer.WalkDirFuncPointerPointer;
/**
