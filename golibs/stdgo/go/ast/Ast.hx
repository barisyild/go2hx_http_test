...
typedef CommentPointerPointer = stdgo._internal.go.ast.Ast_commentpointerpointer.CommentPointerPointer;
typedef CommentGroupPointerPointer = stdgo._internal.go.ast.Ast_commentgrouppointerpointer.CommentGroupPointerPointer;
typedef FieldPointerPointer = stdgo._internal.go.ast.Ast_fieldpointerpointer.FieldPointerPointer;
typedef FieldListPointerPointer = stdgo._internal.go.ast.Ast_fieldlistpointerpointer.FieldListPointerPointer;
typedef BadExprPointerPointer = stdgo._internal.go.ast.Ast_badexprpointerpointer.BadExprPointerPointer;
typedef IdentPointerPointer = stdgo._internal.go.ast.Ast_identpointerpointer.IdentPointerPointer;
typedef EllipsisPointerPointer = stdgo._internal.go.ast.Ast_ellipsispointerpointer.EllipsisPointerPointer;
typedef BasicLitPointerPointer = stdgo._internal.go.ast.Ast_basiclitpointerpointer.BasicLitPointerPointer;
typedef FuncLitPointerPointer = stdgo._internal.go.ast.Ast_funclitpointerpointer.FuncLitPointerPointer;
typedef CompositeLitPointerPointer = stdgo._internal.go.ast.Ast_compositelitpointerpointer.CompositeLitPointerPointer;
typedef ParenExprPointerPointer = stdgo._internal.go.ast.Ast_parenexprpointerpointer.ParenExprPointerPointer;
typedef SelectorExprPointerPointer = stdgo._internal.go.ast.Ast_selectorexprpointerpointer.SelectorExprPointerPointer;
typedef IndexExprPointerPointer = stdgo._internal.go.ast.Ast_indexexprpointerpointer.IndexExprPointerPointer;
typedef IndexListExprPointerPointer = stdgo._internal.go.ast.Ast_indexlistexprpointerpointer.IndexListExprPointerPointer;
typedef SliceExprPointerPointer = stdgo._internal.go.ast.Ast_sliceexprpointerpointer.SliceExprPointerPointer;
typedef TypeAssertExprPointerPointer = stdgo._internal.go.ast.Ast_typeassertexprpointerpointer.TypeAssertExprPointerPointer;
typedef CallExprPointerPointer = stdgo._internal.go.ast.Ast_callexprpointerpointer.CallExprPointerPointer;
typedef StarExprPointerPointer = stdgo._internal.go.ast.Ast_starexprpointerpointer.StarExprPointerPointer;
typedef UnaryExprPointerPointer = stdgo._internal.go.ast.Ast_unaryexprpointerpointer.UnaryExprPointerPointer;
typedef BinaryExprPointerPointer = stdgo._internal.go.ast.Ast_binaryexprpointerpointer.BinaryExprPointerPointer;
typedef KeyValueExprPointerPointer = stdgo._internal.go.ast.Ast_keyvalueexprpointerpointer.KeyValueExprPointerPointer;
typedef ArrayTypePointerPointer = stdgo._internal.go.ast.Ast_arraytypepointerpointer.ArrayTypePointerPointer;
typedef StructTypePointerPointer = stdgo._internal.go.ast.Ast_structtypepointerpointer.StructTypePointerPointer;
typedef FuncTypePointerPointer = stdgo._internal.go.ast.Ast_functypepointerpointer.FuncTypePointerPointer;
typedef InterfaceTypePointerPointer = stdgo._internal.go.ast.Ast_interfacetypepointerpointer.InterfaceTypePointerPointer;
typedef MapTypePointerPointer = stdgo._internal.go.ast.Ast_maptypepointerpointer.MapTypePointerPointer;
typedef ChanTypePointerPointer = stdgo._internal.go.ast.Ast_chantypepointerpointer.ChanTypePointerPointer;
typedef BadStmtPointerPointer = stdgo._internal.go.ast.Ast_badstmtpointerpointer.BadStmtPointerPointer;
typedef DeclStmtPointerPointer = stdgo._internal.go.ast.Ast_declstmtpointerpointer.DeclStmtPointerPointer;
typedef EmptyStmtPointerPointer = stdgo._internal.go.ast.Ast_emptystmtpointerpointer.EmptyStmtPointerPointer;
typedef LabeledStmtPointerPointer = stdgo._internal.go.ast.Ast_labeledstmtpointerpointer.LabeledStmtPointerPointer;
typedef ExprStmtPointerPointer = stdgo._internal.go.ast.Ast_exprstmtpointerpointer.ExprStmtPointerPointer;
typedef SendStmtPointerPointer = stdgo._internal.go.ast.Ast_sendstmtpointerpointer.SendStmtPointerPointer;
typedef IncDecStmtPointerPointer = stdgo._internal.go.ast.Ast_incdecstmtpointerpointer.IncDecStmtPointerPointer;
typedef AssignStmtPointerPointer = stdgo._internal.go.ast.Ast_assignstmtpointerpointer.AssignStmtPointerPointer;
typedef GoStmtPointerPointer = stdgo._internal.go.ast.Ast_gostmtpointerpointer.GoStmtPointerPointer;
typedef DeferStmtPointerPointer = stdgo._internal.go.ast.Ast_deferstmtpointerpointer.DeferStmtPointerPointer;
typedef ReturnStmtPointerPointer = stdgo._internal.go.ast.Ast_returnstmtpointerpointer.ReturnStmtPointerPointer;
typedef BranchStmtPointerPointer = stdgo._internal.go.ast.Ast_branchstmtpointerpointer.BranchStmtPointerPointer;
typedef BlockStmtPointerPointer = stdgo._internal.go.ast.Ast_blockstmtpointerpointer.BlockStmtPointerPointer;
typedef IfStmtPointerPointer = stdgo._internal.go.ast.Ast_ifstmtpointerpointer.IfStmtPointerPointer;
typedef CaseClausePointerPointer = stdgo._internal.go.ast.Ast_caseclausepointerpointer.CaseClausePointerPointer;
typedef SwitchStmtPointerPointer = stdgo._internal.go.ast.Ast_switchstmtpointerpointer.SwitchStmtPointerPointer;
typedef TypeSwitchStmtPointerPointer = stdgo._internal.go.ast.Ast_typeswitchstmtpointerpointer.TypeSwitchStmtPointerPointer;
typedef CommClausePointerPointer = stdgo._internal.go.ast.Ast_commclausepointerpointer.CommClausePointerPointer;
typedef SelectStmtPointerPointer = stdgo._internal.go.ast.Ast_selectstmtpointerpointer.SelectStmtPointerPointer;
typedef ForStmtPointerPointer = stdgo._internal.go.ast.Ast_forstmtpointerpointer.ForStmtPointerPointer;
typedef RangeStmtPointerPointer = stdgo._internal.go.ast.Ast_rangestmtpointerpointer.RangeStmtPointerPointer;
typedef ImportSpecPointerPointer = stdgo._internal.go.ast.Ast_importspecpointerpointer.ImportSpecPointerPointer;
typedef ValueSpecPointerPointer = stdgo._internal.go.ast.Ast_valuespecpointerpointer.ValueSpecPointerPointer;
typedef TypeSpecPointerPointer = stdgo._internal.go.ast.Ast_typespecpointerpointer.TypeSpecPointerPointer;
typedef BadDeclPointerPointer = stdgo._internal.go.ast.Ast_baddeclpointerpointer.BadDeclPointerPointer;
typedef GenDeclPointerPointer = stdgo._internal.go.ast.Ast_gendeclpointerpointer.GenDeclPointerPointer;
typedef FuncDeclPointerPointer = stdgo._internal.go.ast.Ast_funcdeclpointerpointer.FuncDeclPointerPointer;
typedef FilePointerPointer = stdgo._internal.go.ast.Ast_filepointerpointer.FilePointerPointer;
typedef PackagePointerPointer = stdgo._internal.go.ast.Ast_packagepointerpointer.PackagePointerPointer;
typedef ScopePointerPointer = stdgo._internal.go.ast.Ast_scopepointerpointer.ScopePointerPointer;
typedef ObjectPointerPointer = stdgo._internal.go.ast.Ast_objectpointerpointer.ObjectPointerPointer;
typedef ChanDirPointerPointer = stdgo._internal.go.ast.Ast_chandirpointerpointer.ChanDirPointerPointer;
typedef CommentMapPointerPointer = stdgo._internal.go.ast.Ast_commentmappointerpointer.CommentMapPointerPointer;
typedef FilterPointerPointer = stdgo._internal.go.ast.Ast_filterpointerpointer.FilterPointerPointer;
typedef MergeModePointerPointer = stdgo._internal.go.ast.Ast_mergemodepointerpointer.MergeModePointerPointer;
typedef FieldFilterPointerPointer = stdgo._internal.go.ast.Ast_fieldfilterpointerpointer.FieldFilterPointerPointer;
typedef ImporterPointerPointer = stdgo._internal.go.ast.Ast_importerpointerpointer.ImporterPointerPointer;
typedef ObjKindPointerPointer = stdgo._internal.go.ast.Ast_objkindpointerpointer.ObjKindPointerPointer;
/**
