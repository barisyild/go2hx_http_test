...
typedef PositionPointerPointer = stdgo._internal.go.token.Token_positionpointerpointer.PositionPointerPointer;
typedef FilePointerPointer = stdgo._internal.go.token.Token_filepointerpointer.FilePointerPointer;
typedef FileSetPointerPointer = stdgo._internal.go.token.Token_filesetpointerpointer.FileSetPointerPointer;
typedef PosPointerPointer = stdgo._internal.go.token.Token_pospointerpointer.PosPointerPointer;
typedef TokenPointerPointer = stdgo._internal.go.token.Token_tokenpointerpointer.TokenPointerPointer;
/**
