...
typedef TagExprPointerPointer = stdgo._internal.go.build.constraint.Constraint_tagexprpointerpointer.TagExprPointerPointer;
typedef NotExprPointerPointer = stdgo._internal.go.build.constraint.Constraint_notexprpointerpointer.NotExprPointerPointer;
typedef AndExprPointerPointer = stdgo._internal.go.build.constraint.Constraint_andexprpointerpointer.AndExprPointerPointer;
typedef OrExprPointerPointer = stdgo._internal.go.build.constraint.Constraint_orexprpointerpointer.OrExprPointerPointer;
typedef SyntaxErrorPointerPointer = stdgo._internal.go.build.constraint.Constraint_syntaxerrorpointerpointer.SyntaxErrorPointerPointer;
/**
