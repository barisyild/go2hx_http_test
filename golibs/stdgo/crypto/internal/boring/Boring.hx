...
typedef PublicKeyECDSAPointerPointer = stdgo._internal.crypto.internal.boring.Boring_publickeyecdsapointerpointer.PublicKeyECDSAPointerPointer;
typedef PrivateKeyECDSAPointerPointer = stdgo._internal.crypto.internal.boring.Boring_privatekeyecdsapointerpointer.PrivateKeyECDSAPointerPointer;
typedef PublicKeyRSAPointerPointer = stdgo._internal.crypto.internal.boring.Boring_publickeyrsapointerpointer.PublicKeyRSAPointerPointer;
typedef PrivateKeyRSAPointerPointer = stdgo._internal.crypto.internal.boring.Boring_privatekeyrsapointerpointer.PrivateKeyRSAPointerPointer;
typedef PublicKeyECDHPointerPointer = stdgo._internal.crypto.internal.boring.Boring_publickeyecdhpointerpointer.PublicKeyECDHPointerPointer;
typedef PrivateKeyECDHPointerPointer = stdgo._internal.crypto.internal.boring.Boring_privatekeyecdhpointerpointer.PrivateKeyECDHPointerPointer;
typedef BigIntPointerPointer = stdgo._internal.crypto.internal.boring.Boring_bigintpointerpointer.BigIntPointerPointer;
/**
