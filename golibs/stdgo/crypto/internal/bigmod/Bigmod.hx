...
typedef NatPointerPointer = stdgo._internal.crypto.internal.bigmod.Bigmod_natpointerpointer.NatPointerPointer;
typedef ModulusPointerPointer = stdgo._internal.crypto.internal.bigmod.Bigmod_moduluspointerpointer.ModulusPointerPointer;
class Bigmod {
    /**
