...
typedef PKCS1v15DecryptOptionsPointerPointer = stdgo._internal.crypto.rsa.Rsa_pkcs1v15decryptoptionspointerpointer.PKCS1v15DecryptOptionsPointerPointer;
typedef PSSOptionsPointerPointer = stdgo._internal.crypto.rsa.Rsa_pssoptionspointerpointer.PSSOptionsPointerPointer;
typedef PublicKeyPointerPointer = stdgo._internal.crypto.rsa.Rsa_publickeypointerpointer.PublicKeyPointerPointer;
typedef OAEPOptionsPointerPointer = stdgo._internal.crypto.rsa.Rsa_oaepoptionspointerpointer.OAEPOptionsPointerPointer;
typedef PrivateKeyPointerPointer = stdgo._internal.crypto.rsa.Rsa_privatekeypointerpointer.PrivateKeyPointerPointer;
typedef PrecomputedValuesPointerPointer = stdgo._internal.crypto.rsa.Rsa_precomputedvaluespointerpointer.PrecomputedValuesPointerPointer;
typedef CRTValuePointerPointer = stdgo._internal.crypto.rsa.Rsa_crtvaluepointerpointer.CRTValuePointerPointer;
/**
