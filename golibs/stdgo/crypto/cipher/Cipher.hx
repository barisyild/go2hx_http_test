...
typedef StreamReaderPointerPointer = stdgo._internal.crypto.cipher.Cipher_streamreaderpointerpointer.StreamReaderPointerPointer;
typedef StreamWriterPointerPointer = stdgo._internal.crypto.cipher.Cipher_streamwriterpointerpointer.StreamWriterPointerPointer;
/**
