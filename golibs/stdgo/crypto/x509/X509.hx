...
typedef CertPoolPointerPointer = stdgo._internal.crypto.x509.X509_certpoolpointerpointer.CertPoolPointerPointer;
typedef CertificateInvalidErrorPointerPointer = stdgo._internal.crypto.x509.X509_certificateinvaliderrorpointerpointer.CertificateInvalidErrorPointerPointer;
typedef HostnameErrorPointerPointer = stdgo._internal.crypto.x509.X509_hostnameerrorpointerpointer.HostnameErrorPointerPointer;
typedef UnknownAuthorityErrorPointerPointer = stdgo._internal.crypto.x509.X509_unknownauthorityerrorpointerpointer.UnknownAuthorityErrorPointerPointer;
typedef SystemRootsErrorPointerPointer = stdgo._internal.crypto.x509.X509_systemrootserrorpointerpointer.SystemRootsErrorPointerPointer;
typedef VerifyOptionsPointerPointer = stdgo._internal.crypto.x509.X509_verifyoptionspointerpointer.VerifyOptionsPointerPointer;
typedef CertificatePointerPointer = stdgo._internal.crypto.x509.X509_certificatepointerpointer.CertificatePointerPointer;
typedef ConstraintViolationErrorPointerPointer = stdgo._internal.crypto.x509.X509_constraintviolationerrorpointerpointer.ConstraintViolationErrorPointerPointer;
typedef UnhandledCriticalExtensionPointerPointer = stdgo._internal.crypto.x509.X509_unhandledcriticalextensionpointerpointer.UnhandledCriticalExtensionPointerPointer;
typedef CertificateRequestPointerPointer = stdgo._internal.crypto.x509.X509_certificaterequestpointerpointer.CertificateRequestPointerPointer;
typedef RevocationListEntryPointerPointer = stdgo._internal.crypto.x509.X509_revocationlistentrypointerpointer.RevocationListEntryPointerPointer;
typedef RevocationListPointerPointer = stdgo._internal.crypto.x509.X509_revocationlistpointerpointer.RevocationListPointerPointer;
typedef PEMCipherPointerPointer = stdgo._internal.crypto.x509.X509_pemcipherpointerpointer.PEMCipherPointerPointer;
typedef InvalidReasonPointerPointer = stdgo._internal.crypto.x509.X509_invalidreasonpointerpointer.InvalidReasonPointerPointer;
typedef SignatureAlgorithmPointerPointer = stdgo._internal.crypto.x509.X509_signaturealgorithmpointerpointer.SignatureAlgorithmPointerPointer;
typedef PublicKeyAlgorithmPointerPointer = stdgo._internal.crypto.x509.X509_publickeyalgorithmpointerpointer.PublicKeyAlgorithmPointerPointer;
typedef KeyUsagePointerPointer = stdgo._internal.crypto.x509.X509_keyusagepointerpointer.KeyUsagePointerPointer;
typedef ExtKeyUsagePointerPointer = stdgo._internal.crypto.x509.X509_extkeyusagepointerpointer.ExtKeyUsagePointerPointer;
typedef InsecureAlgorithmErrorPointerPointer = stdgo._internal.crypto.x509.X509_insecurealgorithmerrorpointerpointer.InsecureAlgorithmErrorPointerPointer;
/**
