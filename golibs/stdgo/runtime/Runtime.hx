...
typedef TypeAssertionErrorPointerPointer = stdgo._internal.runtime.Runtime_typeassertionerrorpointerpointer.TypeAssertionErrorPointerPointer;
typedef StackRecordPointerPointer = stdgo._internal.runtime.Runtime_stackrecordpointerpointer.StackRecordPointerPointer;
typedef MemProfileRecordPointerPointer = stdgo._internal.runtime.Runtime_memprofilerecordpointerpointer.MemProfileRecordPointerPointer;
typedef BlockProfileRecordPointerPointer = stdgo._internal.runtime.Runtime_blockprofilerecordpointerpointer.BlockProfileRecordPointerPointer;
typedef MemStatsPointerPointer = stdgo._internal.runtime.Runtime_memstatspointerpointer.MemStatsPointerPointer;
typedef PanicNilErrorPointerPointer = stdgo._internal.runtime.Runtime_panicnilerrorpointerpointer.PanicNilErrorPointerPointer;
typedef PinnerPointerPointer = stdgo._internal.runtime.Runtime_pinnerpointerpointer.PinnerPointerPointer;
typedef FramesPointerPointer = stdgo._internal.runtime.Runtime_framespointerpointer.FramesPointerPointer;
typedef FramePointerPointer = stdgo._internal.runtime.Runtime_framepointerpointer.FramePointerPointer;
typedef FuncPointerPointer = stdgo._internal.runtime.Runtime_funcpointerpointer.FuncPointerPointer;
/**
    * 
