...
typedef StructuralErrorPointerPointer = stdgo._internal.encoding.asn1.Asn1_structuralerrorpointerpointer.StructuralErrorPointerPointer;
typedef SyntaxErrorPointerPointer = stdgo._internal.encoding.asn1.Asn1_syntaxerrorpointerpointer.SyntaxErrorPointerPointer;
typedef BitStringPointerPointer = stdgo._internal.encoding.asn1.Asn1_bitstringpointerpointer.BitStringPointerPointer;
typedef RawValuePointerPointer = stdgo._internal.encoding.asn1.Asn1_rawvaluepointerpointer.RawValuePointerPointer;
typedef ObjectIdentifierPointerPointer = stdgo._internal.encoding.asn1.Asn1_objectidentifierpointerpointer.ObjectIdentifierPointerPointer;
typedef EnumeratedPointerPointer = stdgo._internal.encoding.asn1.Asn1_enumeratedpointerpointer.EnumeratedPointerPointer;
typedef FlagPointerPointer = stdgo._internal.encoding.asn1.Asn1_flagpointerpointer.FlagPointerPointer;
typedef RawContentPointerPointer = stdgo._internal.encoding.asn1.Asn1_rawcontentpointerpointer.RawContentPointerPointer;
/**
