...
typedef SyscallErrorPointerPointer = stdgo._internal.os.Os_syscallerrorpointerpointer.SyscallErrorPointerPointer;
typedef ProcessPointerPointer = stdgo._internal.os.Os_processpointerpointer.ProcessPointerPointer;
typedef ProcAttrPointerPointer = stdgo._internal.os.Os_procattrpointerpointer.ProcAttrPointerPointer;
typedef ProcessStatePointerPointer = stdgo._internal.os.Os_processstatepointerpointer.ProcessStatePointerPointer;
typedef LinkErrorPointerPointer = stdgo._internal.os.Os_linkerrorpointerpointer.LinkErrorPointerPointer;
typedef FilePointerPointer = stdgo._internal.os.Os_filepointerpointer.FilePointerPointer;
typedef DirEntryPointerPointer = stdgo._internal.os.Os_direntrypointerpointer.DirEntryPointerPointer;
typedef PathErrorPointerPointer = stdgo._internal.os.Os_patherrorpointerpointer.PathErrorPointerPointer;
typedef FileInfoPointerPointer = stdgo._internal.os.Os_fileinfopointerpointer.FileInfoPointerPointer;
typedef FileModePointerPointer = stdgo._internal.os.Os_filemodepointerpointer.FileModePointerPointer;
typedef JsOutputPointerPointer = stdgo._internal.os.Os_jsoutputpointerpointer.JsOutputPointerPointer;
/**
