...
typedef ErrorPointerPointer = stdgo._internal.os.exec.Exec_errorpointerpointer.ErrorPointerPointer;
typedef CmdPointerPointer = stdgo._internal.os.exec.Exec_cmdpointerpointer.CmdPointerPointer;
typedef ExitErrorPointerPointer = stdgo._internal.os.exec.Exec_exiterrorpointerpointer.ExitErrorPointerPointer;
/**
