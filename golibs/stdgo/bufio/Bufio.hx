...
typedef ReaderPointerPointer = stdgo._internal.bufio.Bufio_readerpointerpointer.ReaderPointerPointer;
typedef WriterPointerPointer = stdgo._internal.bufio.Bufio_writerpointerpointer.WriterPointerPointer;
typedef ReadWriterPointerPointer = stdgo._internal.bufio.Bufio_readwriterpointerpointer.ReadWriterPointerPointer;
typedef ScannerPointerPointer = stdgo._internal.bufio.Bufio_scannerpointerpointer.ScannerPointerPointer;
typedef SplitFuncPointerPointer = stdgo._internal.bufio.Bufio_splitfuncpointerpointer.SplitFuncPointerPointer;
/**
