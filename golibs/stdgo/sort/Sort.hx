...
typedef IntSlicePointerPointer = stdgo._internal.sort.Sort_intslicepointerpointer.IntSlicePointerPointer;
typedef Float64SlicePointerPointer = stdgo._internal.sort.Sort_float64slicepointerpointer.Float64SlicePointerPointer;
typedef StringSlicePointerPointer = stdgo._internal.sort.Sort_stringslicepointerpointer.StringSlicePointerPointer;
/**
