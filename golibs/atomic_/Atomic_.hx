...
typedef Pointer_<T_> = _internal.runtime.internal.atomic_.Atomic__pointer_.Pointer_<T_>;
...
typedef Pointer_Pointer<T_> = _internal.runtime.internal.atomic_.Atomic__pointer_pointer.Pointer_Pointer<T_>;
typedef Int32PointerPointer = _internal.runtime.internal.atomic_.Atomic__int32pointerpointer.Int32PointerPointer;
typedef Int64_PointerPointer = _internal.runtime.internal.atomic_.Atomic__int64_pointerpointer.Int64_PointerPointer;
typedef Uint8PointerPointer = _internal.runtime.internal.atomic_.Atomic__uint8pointerpointer.Uint8PointerPointer;
typedef Bool_PointerPointer = _internal.runtime.internal.atomic_.Atomic__bool_pointerpointer.Bool_PointerPointer;
typedef Uint32PointerPointer = _internal.runtime.internal.atomic_.Atomic__uint32pointerpointer.Uint32PointerPointer;
typedef Uint64PointerPointer = _internal.runtime.internal.atomic_.Atomic__uint64pointerpointer.Uint64PointerPointer;
typedef UintptrPointerPointer = _internal.runtime.internal.atomic_.Atomic__uintptrpointerpointer.UintptrPointerPointer;
typedef Float64PointerPointer = _internal.runtime.internal.atomic_.Atomic__float64pointerpointer.Float64PointerPointer;
typedef UnsafePointerPointerPointer = _internal.runtime.internal.atomic_.Atomic__unsafepointerpointerpointer.UnsafePointerPointerPointer;
typedef Pointer_PointerPointer<T_> = _internal.runtime.internal.atomic_.Atomic__pointer_pointerpointer.Pointer_PointerPointer<T_>;
/**
    * 
